...
cps()
{
  ...
  //following information is needed: pid, name, uid, gid, ppid, etime, cput, state, size
  //these modifications depend on previous steps to be finished before they can be implemented easily--Ken Lin
