...
00000120 <iputtest>:
{
  ...
  printf(stdout, "iput test\n");
     ...
     12b:	ff 35 80 5e 00 00    	pushl  0x5e80
  ...
  printf(stdout, "iput test ok\n");
     ...
     191:	ff 35 80 5e 00 00    	pushl  0x5e80
    ...
    printf(stdout, "mkdir failed\n");
     ...
     1a8:	ff 35 80 5e 00 00    	pushl  0x5e80
    ...
    printf(stdout, "chdir / failed\n");
     ...
     1bf:	ff 35 80 5e 00 00    	pushl  0x5e80
    ...
    printf(stdout, "unlink ../iputdir failed\n");
     ...
     1d6:	ff 35 80 5e 00 00    	pushl  0x5e80
    ...
    printf(stdout, "chdir iputdir failed\n");
     ...
     1ed:	ff 35 80 5e 00 00    	pushl  0x5e80
...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     20b:	ff 35 80 5e 00 00    	pushl  0x5e80
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     285:	ff 35 80 5e 00 00    	pushl  0x5e80
     ...
     2a0:	ff 35 80 5e 00 00    	pushl  0x5e80
    ...
    printf(stdout, "fork failed\n");
     ...
     2b7:	ff 35 80 5e 00 00    	pushl  0x5e80
    ...
    exit();
     ...
     2ce:	ff 35 80 5e 00 00    	pushl  0x5e80
     ...
     2e5:	ff 35 80 5e 00 00    	pushl  0x5e80
...
00000300 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     ...
     30b:	ff 35 80 5e 00 00    	pushl  0x5e80
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     356:	ff 35 80 5e 00 00    	pushl  0x5e80
  ...
  printf(stdout, "openiput test ok\n");
     ...
     39a:	ff 35 80 5e 00 00    	pushl  0x5e80
    ...
    printf(stdout, "fork failed\n");
     ...
     3bc:	ff 35 80 5e 00 00    	pushl  0x5e80
    ...
    printf(stdout, "mkdir oidir failed\n");
     ...
     3d3:	ff 35 80 5e 00 00    	pushl  0x5e80
    ...
    printf(stdout, "unlink failed\n");
     ...
     3ea:	ff 35 80 5e 00 00    	pushl  0x5e80
...
00000400 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     40b:	ff 35 80 5e 00 00    	pushl  0x5e80
  ...
  printf(stdout, "open test ok\n");
     ...
     451:	ff 35 80 5e 00 00    	pushl  0x5e80
    ...
    printf(stdout, "open echo failed!\n");
     ...
     468:	ff 35 80 5e 00 00    	pushl  0x5e80
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     ...
     47f:	ff 35 80 5e 00 00    	pushl  0x5e80
...
00000490 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     49d:	ff 35 80 5e 00 00    	pushl  0x5e80
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4d0:	ff 35 80 5e 00 00    	pushl  0x5e80
  ...
  printf(stdout, "writes ok\n");
     ...
     528:	ff 35 80 5e 00 00    	pushl  0x5e80
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     55e:	ff 35 80 5e 00 00    	pushl  0x5e80
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     592:	ff 35 80 5e 00 00    	pushl  0x5e80
  ...
  printf(stdout, "small file test ok\n");
     ...
     5c0:	ff 35 80 5e 00 00    	pushl  0x5e80
     ...
     5de:	ff 35 80 5e 00 00    	pushl  0x5e80
     ...
     5f7:	ff 35 80 5e 00 00    	pushl  0x5e80
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     60e:	ff 35 80 5e 00 00    	pushl  0x5e80
    ...
    printf(stdout, "read failed\n");
     ...
     625:	ff 35 80 5e 00 00    	pushl  0x5e80
    ...
    printf(stdout, "unlink small failed\n");
     ...
     63c:	ff 35 80 5e 00 00    	pushl  0x5e80
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     653:	ff 35 80 5e 00 00    	pushl  0x5e80
...
00000670 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     67d:	ff 35 80 5e 00 00    	pushl  0x5e80
  ...
  printf(stdout, "big files ok\n");
     ...
     775:	ff 35 80 5e 00 00    	pushl  0x5e80
     ...
     793:	ff 35 80 5e 00 00    	pushl  0x5e80
     ...
     7aa:	ff 35 80 5e 00 00    	pushl  0x5e80
     ...
     7c3:	ff 35 80 5e 00 00    	pushl  0x5e80
     ...
     7de:	ff 35 80 5e 00 00    	pushl  0x5e80
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     7f5:	ff 35 80 5e 00 00    	pushl  0x5e80
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     80c:	ff 35 80 5e 00 00    	pushl  0x5e80
    ...
    printf(stdout, "unlink big failed\n");
     ...
     823:	ff 35 80 5e 00 00    	pushl  0x5e80
     ...
     844:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     851:	ff 35 80 5e 00 00    	pushl  0x5e80
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8d6:	ff 35 80 5e 00 00    	pushl  0x5e80
...
000008f0 <dirtest>:
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     8fb:	ff 35 80 5e 00 00    	pushl  0x5e80
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     961:	ff 35 80 5e 00 00    	pushl  0x5e80
    ...
    printf(stdout, "mkdir failed\n");
     ...
     978:	ff 35 80 5e 00 00    	pushl  0x5e80
    ...
    printf(stdout, "unlink dir0 failed\n");
     ...
     98f:	ff 35 80 5e 00 00    	pushl  0x5e80
    ...
    printf(stdout, "chdir .. failed\n");
     ...
     9a6:	ff 35 80 5e 00 00    	pushl  0x5e80
    ...
    printf(stdout, "chdir dir0 failed\n");
     ...
     9bd:	ff 35 80 5e 00 00    	pushl  0x5e80
...
000009d0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     ...
     9db:	ff 35 80 5e 00 00    	pushl  0x5e80
     9e1:	e8 9a 30 00 00       	call   3a80 <printf>
  if(exec("echo", echoargv) < 0){
     9e6:	5a                   	pop    %edx
     9e7:	59                   	pop    %ecx
     9e8:	68 84 5e 00 00       	push   $0x5e84
    ...
    printf(stdout, "exec echo failed\n");
     ...
     a07:	ff 35 80 5e 00 00    	pushl  0x5e80
     ...
     a25:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  seq = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     abc:	68 3e 41 00 00       	push   $0x413e
     ac1:	6a 01                	push   $0x1
     ac3:	e8 b8 2f 00 00       	call   3a80 <printf>
          return;
...
00000bb0 <preempt>:
{
  ...
  printf(1, "preempt ok\n");
     ...
     cda:	68 86 41 00 00       	push   $0x4186
     cdf:	6a 01                	push   $0x1
    ...
    printf(1, "preempt read error");
     ...
     cf1:	68 9a 41 00 00       	push   $0x419a
     cf6:	6a 01                	push   $0x1
     cf8:	e8 83 2d 00 00       	call   3a80 <printf>
    return;
...
00000d90 <mem>:
{
  ...
  printf(1, "mem test\n");
     d9b:	68 e8 41 00 00       	push   $0x41e8
     da0:	6a 01                	push   $0x1
     da2:	e8 d9 2c 00 00       	call   3a80 <printf>
  ppid = getpid();
    ...
    102b:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i = 0; i < 2; i++){
    ...
    109e:	c7 45 d0 4e 42 00 00 	movl   $0x424e,-0x30(%ebp)
    fd = open(fname, 0);
  ...
  printf(1, "fourfiles ok\n");
    ...
    1158:	68 75 42 00 00       	push   $0x4275
    115d:	6a 01                	push   $0x1
    115f:	e8 1c 29 00 00       	call   3a80 <printf>
          exit();
    ...
    11c5:	51                   	push   %ecx
    11c6:	51                   	push   %ecx
    11c7:	68 ef 44 00 00       	push   $0x44ef
    11cc:	6a 01                	push   $0x1
    11ce:	e8 ad 28 00 00       	call   3a80 <printf>
        exit();
    ...
    11e3:	68 29 4d 00 00       	push   $0x4d29
    11e8:	6a 01                	push   $0x1
    11ea:	e8 91 28 00 00       	call   3a80 <printf>
      exit();
    11ef:	e8 dd 26 00 00       	call   38d1 <exit>
      printf(1, "wrong length %d\n", total);
    11f4:	50                   	push   %eax
    11f5:	53                   	push   %ebx
    11f6:	68 81 42 00 00       	push   $0x4281
    11fb:	6a 01                	push   $0x1
    11fd:	e8 7e 28 00 00       	call   3a80 <printf>
      exit();
    1202:	e8 ca 26 00 00       	call   38d1 <exit>
          printf(1, "write failed %d\n", n);
    1207:	52                   	push   %edx
    1208:	50                   	push   %eax
    1209:	68 64 42 00 00       	push   $0x4264
    120e:	6a 01                	push   $0x1
    1210:	e8 6b 28 00 00       	call   3a80 <printf>
          exit();
    ...
    1226:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete ok\n");
    ...
    13c2:	52                   	push   %edx
    13c3:	52                   	push   %edx
    13c4:	68 a1 3e 00 00       	push   $0x3ea1
    13c9:	6a 01                	push   $0x1
    13cb:	e8 b0 26 00 00       	call   3a80 <printf>
            exit();
    ...
    13e0:	57                   	push   %edi
    13e1:	68 60 4f 00 00       	push   $0x4f60
    13e6:	6a 01                	push   $0x1
    13e8:	e8 93 26 00 00       	call   3a80 <printf>
        exit();
    13ed:	e8 df 24 00 00       	call   38d1 <exit>
          printf(1, "create failed\n");
    13f2:	83 ec 08             	sub    $0x8,%esp
    13f5:	68 ef 44 00 00       	push   $0x44ef
    13fa:	6a 01                	push   $0x1
    13fc:	e8 7f 26 00 00       	call   3a80 <printf>
          exit();
    1401:	e8 cb 24 00 00       	call   38d1 <exit>
      printf(1, "fork failed\n");
    1406:	83 ec 08             	sub    $0x8,%esp
    1409:	68 29 4d 00 00       	push   $0x4d29
    140e:	6a 01                	push   $0x1
    1410:	e8 6b 26 00 00       	call   3a80 <printf>
      exit();
    ...
    1422:	50                   	push   %eax
    1423:	57                   	push   %edi
    1424:	68 84 4f 00 00       	push   $0x4f84
    1429:	6a 01                	push   $0x1
    ...
    17ea:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "concreate test\n");
    17f3:	68 41 44 00 00       	push   $0x4441
    17f8:	6a 01                	push   $0x1
    17fa:	e8 81 22 00 00       	call   3a80 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    18a5:	53                   	push   %ebx
    18a6:	68 54 44 00 00       	push   $0x4454
    18ab:	6a 01                	push   $0x1
    18ad:	e8 ce 21 00 00       	call   3a80 <printf>
        exit();
    ...
    18c3:	53                   	push   %ebx
    18c4:	68 51 44 00 00       	push   $0x4451
  ...
  for(i = 0; i < 40; i++){
    18e3:	83 c6 01             	add    $0x1,%esi
      link("C0", file);
    18e6:	53                   	push   %ebx
    18e7:	68 51 44 00 00       	push   $0x4451
  ...
  fd = open(".", 0);
    ...
    1913:	5f                   	pop    %edi
    1914:	6a 00                	push   $0x0
    1916:	68 5e 46 00 00       	push   $0x465e
...
00001ae0 <linkunlink>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b6d:	68 41 47 00 00       	push   $0x4741
  ...
  printf(1, "linkunlink ok\n");
    ...
    1b96:	68 c9 44 00 00       	push   $0x44c9
    1b9b:	6a 01                	push   $0x1
    1b9d:	e8 de 1e 00 00       	call   3a80 <printf>
}
    ...
    2d44:	31 ff                	xor    %edi,%edi
{
  ...
  printf(stdout, "sbrk test\n");
    ...
    2d50:	ff 35 80 5e 00 00    	pushl  0x5e80
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2fa4:	68 80 4c 00 00       	push   $0x4c80
    2fa9:	ff 35 80 5e 00 00    	pushl  0x5e80
    2faf:	e8 cc 0a 00 00       	call   3a80 <printf>
}
    ...
    2fdb:	6a 01                	push   $0x1
    2fdd:	68 41 47 00 00       	push   $0x4741
    ...
    301f:	56                   	push   %esi
    3020:	57                   	push   %edi
    3021:	68 e3 4b 00 00       	push   $0x4be3
    3026:	ff 35 80 5e 00 00    	pushl  0x5e80
    302c:	e8 4f 0a 00 00       	call   3a80 <printf>
      exit();
    ...
    3039:	50                   	push   %eax
    303a:	50                   	push   %eax
    303b:	68 65 4c 00 00       	push   $0x4c65
    3040:	ff 35 80 5e 00 00    	pushl  0x5e80
    3046:	e8 35 0a 00 00       	call   3a80 <printf>
    exit();
    304b:	e8 81 08 00 00       	call   38d1 <exit>
    printf(1, "pipe() failed\n");
    3050:	52                   	push   %edx
    3051:	52                   	push   %edx
    3052:	68 21 41 00 00       	push   $0x4121
    3057:	6a 01                	push   $0x1
    3059:	e8 22 0a 00 00       	call   3a80 <printf>
    exit();
    ...
    306b:	50                   	push   %eax
    306c:	56                   	push   %esi
    306d:	68 4c 4c 00 00       	push   $0x4c4c
    3072:	ff 35 80 5e 00 00    	pushl  0x5e80
    3078:	e8 03 0a 00 00       	call   3a80 <printf>
      kill(ppid);
    ...
    308d:	68 29 4d 00 00       	push   $0x4d29
    3092:	ff 35 80 5e 00 00    	pushl  0x5e80
    ...
    30a9:	ff 35 80 5e 00 00    	pushl  0x5e80
    ...
    30b9:	51                   	push   %ecx
    30ba:	51                   	push   %ecx
    30bb:	68 fc 53 00 00       	push   $0x53fc
    30c0:	ff 35 80 5e 00 00    	pushl  0x5e80
    ...
    30d7:	ff 35 80 5e 00 00    	pushl  0x5e80
    ...
    30e7:	50                   	push   %eax
    30e8:	56                   	push   %esi
    30e9:	68 9c 53 00 00       	push   $0x539c
    30ee:	ff 35 80 5e 00 00    	pushl  0x5e80
    ...
    30fe:	53                   	push   %ebx
    30ff:	53                   	push   %ebx
    3100:	68 31 4c 00 00       	push   $0x4c31
    3105:	ff 35 80 5e 00 00    	pushl  0x5e80
    310b:	e8 70 09 00 00       	call   3a80 <printf>
    exit();
    3110:	e8 bc 07 00 00       	call   38d1 <exit>
    printf(stdout, "sbrk test failed to grow big address space; enough phys mem?\n");
    3115:	56                   	push   %esi
    3116:	56                   	push   %esi
    3117:	68 5c 53 00 00       	push   $0x535c
    311c:	ff 35 80 5e 00 00    	pushl  0x5e80
    3122:	e8 59 09 00 00       	call   3a80 <printf>
    exit();
    ...
    3131:	57                   	push   %edi
    3132:	57                   	push   %edi
    3133:	68 15 4c 00 00       	push   $0x4c15
    3138:	ff 35 80 5e 00 00    	pushl  0x5e80
    313e:	e8 3d 09 00 00       	call   3a80 <printf>
    exit();
    3143:	e8 89 07 00 00       	call   38d1 <exit>
    printf(stdout, "sbrk test fork failed\n");
    3148:	50                   	push   %eax
    3149:	50                   	push   %eax
    314a:	68 fe 4b 00 00       	push   $0x4bfe
    314f:	ff 35 80 5e 00 00    	pushl  0x5e80
    3155:	e8 26 09 00 00       	call   3a80 <printf>
    exit();
...
00003170 <validatetest>:
{
  ...
  printf(stdout, "validate test\n");
    ...
    317a:	68 8e 4c 00 00       	push   $0x4c8e
    317f:	ff 35 80 5e 00 00    	pushl  0x5e80
    3185:	e8 f6 08 00 00       	call   3a80 <printf>
    ...
    31bf:	5a                   	pop    %edx
    31c0:	53                   	push   %ebx
    31c1:	68 9d 4c 00 00       	push   $0x4c9d
  ...
  printf(stdout, "validate ok\n");
    ...
    31e4:	68 c1 4c 00 00       	push   $0x4cc1
    31e9:	ff 35 80 5e 00 00    	pushl  0x5e80
    31ef:	e8 8c 08 00 00       	call   3a80 <printf>
}
    ...
    3206:	68 a8 4c 00 00       	push   $0x4ca8
    320b:	ff 35 80 5e 00 00    	pushl  0x5e80
    3211:	e8 6a 08 00 00       	call   3a80 <printf>
      exit();
...
00003220 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    3226:	68 ce 4c 00 00       	push   $0x4cce
    322b:	ff 35 80 5e 00 00    	pushl  0x5e80
  ...
  printf(stdout, "bss test ok\n");
    ...
    3266:	68 e9 4c 00 00       	push   $0x4ce9
    326b:	ff 35 80 5e 00 00    	pushl  0x5e80
    ...
    327e:	68 d8 4c 00 00       	push   $0x4cd8
    3283:	ff 35 80 5e 00 00    	pushl  0x5e80
...
000032a0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    32a6:	68 f6 4c 00 00       	push   $0x4cf6
  ...
  fd = open("bigarg-ok", 0);
    ...
    32ca:	6a 00                	push   $0x0
    32cc:	68 f6 4c 00 00       	push   $0x4cf6
  ...
  unlink("bigarg-ok");
    32ea:	c7 04 24 f6 4c 00 00 	movl   $0x4cf6,(%esp)
    ...
    3300:	c7 04 85 a0 5e 00 00 	movl   $0x5450,0x5ea0(,%eax,4)
    3307:	50 54 00 00 
    ...
    3313:	51                   	push   %ecx
    3314:	51                   	push   %ecx
    3315:	68 00 4d 00 00       	push   $0x4d00
    331a:	ff 35 80 5e 00 00    	pushl  0x5e80
    args[MAXARG-1] = 0;
    3320:	c7 05 1c 5f 00 00 00 	movl   $0x0,0x5f1c
    3327:	00 00 00 
    printf(stdout, "bigarg test\n");
    332a:	e8 51 07 00 00       	call   3a80 <printf>
    exec("echo", args);
    332f:	58                   	pop    %eax
    3330:	5a                   	pop    %edx
    3331:	68 a0 5e 00 00       	push   $0x5ea0
    3336:	68 cd 3e 00 00       	push   $0x3ecd
    333b:	e8 c9 05 00 00       	call   3909 <exec>
    printf(stdout, "bigarg test ok\n");
    3340:	59                   	pop    %ecx
    3341:	58                   	pop    %eax
    3342:	68 0d 4d 00 00       	push   $0x4d0d
    3347:	ff 35 80 5e 00 00    	pushl  0x5e80
    334d:	e8 2e 07 00 00       	call   3a80 <printf>
    fd = open("bigarg-ok", O_CREATE);
    3352:	58                   	pop    %eax
    3353:	5a                   	pop    %edx
    3354:	68 00 02 00 00       	push   $0x200
    3359:	68 f6 4c 00 00       	push   $0x4cf6
    ...
    3370:	50                   	push   %eax
    3371:	50                   	push   %eax
    3372:	68 36 4d 00 00       	push   $0x4d36
    3377:	ff 35 80 5e 00 00    	pushl  0x5e80
    337d:	e8 fe 06 00 00       	call   3a80 <printf>
    exit();
    3382:	e8 4a 05 00 00       	call   38d1 <exit>
    printf(stdout, "bigargtest: fork failed\n");
    3387:	52                   	push   %edx
    3388:	52                   	push   %edx
    3389:	68 1d 4d 00 00       	push   $0x4d1d
    338e:	ff 35 80 5e 00 00    	pushl  0x5e80
    3394:	e8 e7 06 00 00       	call   3a80 <printf>
    exit();
    ...
    33a5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    33ab:	68 4b 4d 00 00       	push   $0x4d4b
    33b0:	6a 01                	push   $0x1
    33b2:	e8 c9 06 00 00       	call   3a80 <printf>
    ...
    3433:	50                   	push   %eax
    3434:	68 58 4d 00 00       	push   $0x4d58
    3439:	6a 01                	push   $0x1
    343b:	e8 40 06 00 00       	call   3a80 <printf>
    ...
    3482:	53                   	push   %ebx
    3483:	68 74 4d 00 00       	push   $0x4d74
    3488:	6a 01                	push   $0x1
    348a:	e8 f1 05 00 00       	call   3a80 <printf>
    close(fd);
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    34ac:	50                   	push   %eax
    34ad:	68 64 4d 00 00       	push   $0x4d64
    34b2:	6a 01                	push   $0x1
    34b4:	e8 c7 05 00 00       	call   3a80 <printf>
      break;
  ...
  printf(1, "fsfull test finished\n");
    ...
    355e:	68 84 4d 00 00       	push   $0x4d84
    3563:	6a 01                	push   $0x1
    3565:	e8 16 05 00 00       	call   3a80 <printf>
}
...
00003660 <rand>:
  randstate = randstate * 1664525 + 1013904223;
    3660:	69 05 7c 5e 00 00 0d 	imul   $0x19660d,0x5e7c,%eax
    3667:	66 19 00 
    366a:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    366f:	a3 7c 5e 00 00       	mov    %eax,0x5e7c
}
    3674:	c3                   	ret    
...
000039a1 <getppid>:
SYSCALL(getppid)
    39a1:	b8 1c 00 00 00       	mov    $0x1c,%eax
    39a6:	cd 40                	int    $0x40
    39a8:	c3                   	ret    

000039a9 <setuid>:
SYSCALL(setuid)
    39a9:	b8 1d 00 00 00       	mov    $0x1d,%eax
    39ae:	cd 40                	int    $0x40
    39b0:	c3                   	ret    

000039b1 <setgid>:
SYSCALL(setgid)
    39b1:	b8 1e 00 00 00       	mov    $0x1e,%eax
    39b6:	cd 40                	int    $0x40
    39b8:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
    neg = 1;
    x = -xx;
    39c6:	89 d3                	mov    %edx,%ebx
{
    39c8:	83 ec 3c             	sub    $0x3c,%esp
    39cb:	89 45 bc             	mov    %eax,-0x44(%ebp)
  if(sgn && xx < 0){
    39ce:	85 d2                	test   %edx,%edx
    39d0:	0f 89 92 00 00 00    	jns    3a68 <printint+0xa8>
    39d6:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
    39da:	0f 84 88 00 00 00    	je     3a68 <printint+0xa8>
    neg = 1;
    39e0:	c7 45 c0 01 00 00 00 	movl   $0x1,-0x40(%ebp)
    x = -xx;
    39e7:	f7 db                	neg    %ebx
  } else {
    x = xx;
  ...
  i = 0;
    39e9:	c7 45 c4 00 00 00 00 	movl   $0x0,-0x3c(%ebp)
    39f0:	8d 75 d7             	lea    -0x29(%ebp),%esi
    39f3:	eb 08                	jmp    39fd <printint+0x3d>
    39f5:	8d 76 00             	lea    0x0(%esi),%esi
  do{
    buf[i++] = digits[x % base];
    39f8:	89 7d c4             	mov    %edi,-0x3c(%ebp)
  }while((x /= base) != 0);
    39fb:	89 c3                	mov    %eax,%ebx
    buf[i++] = digits[x % base];
    39fd:	89 d8                	mov    %ebx,%eax
    39ff:	31 d2                	xor    %edx,%edx
    3a01:	8b 7d c4             	mov    -0x3c(%ebp),%edi
    3a04:	f7 f1                	div    %ecx
    3a06:	83 c7 01             	add    $0x1,%edi
    3a09:	0f b6 92 88 55 00 00 	movzbl 0x5588(%edx),%edx
    3a10:	88 14 3e             	mov    %dl,(%esi,%edi,1)
  }while((x /= base) != 0);
    3a13:	39 d9                	cmp    %ebx,%ecx
    3a15:	76 e1                	jbe    39f8 <printint+0x38>
  if(neg)
    3a17:	8b 45 c0             	mov    -0x40(%ebp),%eax
    3a1a:	85 c0                	test   %eax,%eax
    3a1c:	74 0d                	je     3a2b <printint+0x6b>
    buf[i++] = '-';
    3a1e:	c6 44 3d d8 2d       	movb   $0x2d,-0x28(%ebp,%edi,1)
    3a23:	ba 2d 00 00 00       	mov    $0x2d,%edx
    buf[i++] = digits[x % base];
    3a28:	89 7d c4             	mov    %edi,-0x3c(%ebp)
    3a2b:	8b 45 c4             	mov    -0x3c(%ebp),%eax
    3a2e:	8b 7d bc             	mov    -0x44(%ebp),%edi
    3a31:	8d 5c 05 d7          	lea    -0x29(%ebp,%eax,1),%ebx
    3a35:	eb 0f                	jmp    3a46 <printint+0x86>
    3a37:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  write(fd, &c, 1);
    ...
    3a4e:	56                   	push   %esi
    3a4f:	57                   	push   %edi
    3a50:	e8 9c fe ff ff       	call   38f1 <write>

  while(--i >= 0)
    3a55:	83 c4 10             	add    $0x10,%esp
    3a58:	39 de                	cmp    %ebx,%esi
    3a5a:	75 e4                	jne    3a40 <printint+0x80>
    putc(fd, buf[i]);
}
  ...
  neg = 0;
    3a68:	c7 45 c0 00 00 00 00 	movl   $0x0,-0x40(%ebp)
    3a6f:	e9 75 ff ff ff       	jmp    39e9 <printint+0x29>
    3a74:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3a91:	0f 84 b9 00 00 00    	je     3b50 <printf+0xd0>
  ap = (uint*)(void*)&fmt + 1;
    3a97:	8d 45 10             	lea    0x10(%ebp),%eax
    3a9a:	83 c6 01             	add    $0x1,%esi
  write(fd, &c, 1);
    3a9d:	8d 7d e7             	lea    -0x19(%ebp),%edi
  state = 0;
    3aa0:	31 d2                	xor    %edx,%edx
  ap = (uint*)(void*)&fmt + 1;
    3aa2:	89 45 d0             	mov    %eax,-0x30(%ebp)
    3aa5:	eb 38                	jmp    3adf <printf+0x5f>
    3aa7:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  write(fd, &c, 1);
    ...
    3ac9:	e8 23 fe ff ff       	call   38f1 <write>
    3ace:	8b 55 d4             	mov    -0x2c(%ebp),%edx
      } else {
        putc(fd, c);
    3ad1:	83 c4 10             	add    $0x10,%esp
    3ad4:	83 c6 01             	add    $0x1,%esi
  for(i = 0; fmt[i]; i++){
    3ad7:	0f b6 5e ff          	movzbl -0x1(%esi),%ebx
    3adb:	84 db                	test   %bl,%bl
    3add:	74 71                	je     3b50 <printf+0xd0>
    c = fmt[i] & 0xff;
    3adf:	0f be cb             	movsbl %bl,%ecx
    3ae2:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
    3ae5:	85 d2                	test   %edx,%edx
    3ae7:	74 c7                	je     3ab0 <printf+0x30>
      }
    } else if(state == '%'){
    3ae9:	83 fa 25             	cmp    $0x25,%edx
    3aec:	75 e6                	jne    3ad4 <printf+0x54>
      if(c == 'd'){
    3aee:	83 f8 64             	cmp    $0x64,%eax
    3af1:	0f 84 99 00 00 00    	je     3b90 <printf+0x110>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
    3af7:	81 e1 f7 00 00 00    	and    $0xf7,%ecx
    3afd:	83 f9 70             	cmp    $0x70,%ecx
    3b00:	74 5e                	je     3b60 <printf+0xe0>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
    3b02:	83 f8 73             	cmp    $0x73,%eax
    3b05:	0f 84 d5 00 00 00    	je     3be0 <printf+0x160>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    3b0b:	83 f8 63             	cmp    $0x63,%eax
    3b0e:	0f 84 8c 00 00 00    	je     3ba0 <printf+0x120>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
    3b14:	83 f8 25             	cmp    $0x25,%eax
    3b17:	0f 84 b3 00 00 00    	je     3bd0 <printf+0x150>
  write(fd, &c, 1);
    3b1d:	83 ec 04             	sub    $0x4,%esp
    3b20:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    3b24:	6a 01                	push   $0x1
    3b26:	57                   	push   %edi
    3b27:	ff 75 08             	pushl  0x8(%ebp)
    3b2a:	e8 c2 fd ff ff       	call   38f1 <write>
        putc(fd, c);
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
        putc(fd, c);
    3b2f:	88 5d e7             	mov    %bl,-0x19(%ebp)
  write(fd, &c, 1);
    3b32:	83 c4 0c             	add    $0xc,%esp
    3b35:	6a 01                	push   $0x1
    3b37:	83 c6 01             	add    $0x1,%esi
    3b3a:	57                   	push   %edi
    3b3b:	ff 75 08             	pushl  0x8(%ebp)
    3b3e:	e8 ae fd ff ff       	call   38f1 <write>
  for(i = 0; fmt[i]; i++){
    3b43:	0f b6 5e ff          	movzbl -0x1(%esi),%ebx
        putc(fd, c);
    3b47:	83 c4 10             	add    $0x10,%esp
      }
      state = 0;
    3b4a:	31 d2                	xor    %edx,%edx
  for(i = 0; fmt[i]; i++){
    3b4c:	84 db                	test   %bl,%bl
    3b4e:	75 8f                	jne    3adf <printf+0x5f>
    }
  }
}
    ...
    3b72:	e8 49 fe ff ff       	call   39c0 <printint>
        ap++;
  ...
  write(fd, &c, 1);
    3bb4:	e8 38 fd ff ff       	call   38f1 <write>
        ap++;
  ...
  write(fd, &c, 1);
    ...
    3bd6:	e9 5a ff ff ff       	jmp    3b35 <printf+0xb5>
    ...
    3c04:	eb 1a                	jmp    3c20 <printf+0x1a0>
          s = "(null)";
    3c06:	bb 80 55 00 00       	mov    $0x5580,%ebx
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    3c2b:	57                   	push   %edi
    3c2c:	53                   	push   %ebx
    3c2d:	e8 bf fc ff ff       	call   38f1 <write>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3c51:	a1 20 5f 00 00       	mov    0x5f20,%eax
{
    ...
    3c76:	73 10                	jae    3c88 <free+0x38>
{
  ...
  freep = p;
    ...
    3ca1:	5b                   	pop    %ebx
  freep = p;
    3ca2:	a3 20 5f 00 00       	mov    %eax,0x5f20
}
    3ca7:	5e                   	pop    %esi
    3ca8:	5f                   	pop    %edi
    3ca9:	5d                   	pop    %ebp
  ...
  freep = p;
    3cca:	a3 20 5f 00 00       	mov    %eax,0x5f20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3cec:	8b 3d 20 5f 00 00    	mov    0x5f20,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  if((prevp = freep) == 0){
    ...
    3cfd:	0f 84 ad 00 00 00    	je     3db0 <malloc+0xd0>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    3d0a:	73 72                	jae    3d7e <malloc+0x9e>
    3d0c:	81 fe 00 10 00 00    	cmp    $0x1000,%esi
    3d12:	bb 00 10 00 00       	mov    $0x1000,%ebx
    3d17:	0f 43 de             	cmovae %esi,%ebx
  p = sbrk(nu * sizeof(Header));
    3d1a:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
    3d21:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    3d24:	eb 1b                	jmp    3d41 <malloc+0x61>
    3d26:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    3d2d:	8d 76 00             	lea    0x0(%esi),%esi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3d30:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    3d32:	8b 48 04             	mov    0x4(%eax),%ecx
    3d35:	39 f1                	cmp    %esi,%ecx
    3d37:	73 4f                	jae    3d88 <malloc+0xa8>
    3d39:	8b 3d 20 5f 00 00    	mov    0x5f20,%edi
    3d3f:	89 c2                	mov    %eax,%edx
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
  ...
  return freep;
    3d67:	8b 15 20 5f 00 00    	mov    0x5f20,%edx
      if((p = morecore(nunits)) == 0)
    3d6d:	83 c4 10             	add    $0x10,%esp
    3d70:	85 d2                	test   %edx,%edx
    3d72:	75 bc                	jne    3d30 <malloc+0x50>
        return 0;
  }
}
    3d74:	8d 65 f4             	lea    -0xc(%ebp),%esp
        return 0;
    ...
    3d7d:	c3                   	ret    
    if(p->s.size >= nunits){
    3d7e:	89 d0                	mov    %edx,%eax
    3d80:	89 fa                	mov    %edi,%edx
    ...
    3d8e:	89 48 04             	mov    %ecx,0x4(%eax)
        p += p->s.size;
    3d91:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
    3d94:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    3d97:	89 15 20 5f 00 00    	mov    %edx,0x5f20
}
    ...
    3da6:	5d                   	pop    %ebp
    3da7:	c3                   	ret    
    3da8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    3daf:	90                   	nop
    base.s.ptr = freep = prevp = &base;
    3db0:	c7 05 20 5f 00 00 24 	movl   $0x5f24,0x5f20
    3db7:	5f 00 00 
    base.s.size = 0;
    3dba:	bf 24 5f 00 00       	mov    $0x5f24,%edi
    base.s.ptr = freep = prevp = &base;
    3dbf:	c7 05 24 5f 00 00 24 	movl   $0x5f24,0x5f24
    3dc6:	5f 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3dc9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    3dcb:	c7 05 28 5f 00 00 00 	movl   $0x0,0x5f28
    3dd2:	00 00 00 
    if(p->s.size >= nunits){
    3dd5:	e9 32 ff ff ff       	jmp    3d0c <malloc+0x2c>
