   ...
   e:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  if (date(&r)) {
  14:	50                   	push   %eax
  15:	e8 4f 03 00 00       	call   369 <date>
...
00000391 <setgid>:
SYSCALL(setgid)
 391:	b8 1e 00 00 00       	mov    $0x1e,%eax
 396:	cd 40                	int    $0x40
 398:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
 ...
 5e4:	eb 1a                	jmp    600 <printf+0x1a0>
          s = "(null)";
 5e6:	bb e8 07 00 00       	mov    $0x7e8,%ebx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 3d 98 0a 00 00    	mov    0xa98,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 742:	e8 e9 fe ff ff       	call   630 <free>
  return freep;
 747:	8b 15 98 0a 00 00    	mov    0xa98,%edx
