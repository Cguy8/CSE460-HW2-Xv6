...
801003b0:	e8 eb 02 00 00       	call   801006a0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 03 7b 10 80 	movl   $0x80107b03,(%esp)
...
80100af2:	75 d2                	jne    80100ac6 <exec+0x56>
  if((pgdir = setupkvm()) == 0)
80100af4:	e8 57 63 00 00       	call   80106e50 <setupkvm>
...
80100b63:	e8 08 61 00 00       	call   80106c70 <allocuvm>
...
80100b99:	e8 12 60 00 00       	call   80106bb0 <loaduvm>
...
80100bdb:	e8 f0 61 00 00       	call   80106dd0 <freevm>
  if(ip){
...
80100c22:	e8 49 60 00 00       	call   80106c70 <allocuvm>
...
80100c41:	31 ff                	xor    %edi,%edi
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
80100c43:	e8 a8 62 00 00       	call   80106ef0 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100cb7:	e8 84 63 00 00       	call   80107040 <copyout>
...
80100cd1:	e8 fa 60 00 00       	call   80106dd0 <freevm>
...
80100d1d:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100d23:	e8 18 63 00 00       	call   80107040 <copyout>
...
80100d94:	e8 87 5c 00 00       	call   80106a20 <switchuvm>
  freevm(oldpgdir);
80100d99:	89 3c 24             	mov    %edi,(%esp)
80100d9c:	e8 2f 60 00 00       	call   80106dd0 <freevm>
  return 0;
...
80100db3:	68 61 71 10 80       	push   $0x80107161
...
80100de6:	68 6d 71 10 80       	push   $0x8010716d
...
80100eab:	68 74 71 10 80       	push   $0x80107174
...
80101072:	68 86 71 10 80       	push   $0x80107186
...
8010114b:	68 8f 71 10 80       	push   $0x8010718f
...
80101181:	68 95 71 10 80       	push   $0x80107195
...
80101234:	68 9f 71 10 80       	push   $0x8010719f
...
80101382:	68 b5 71 10 80       	push   $0x801071b5
...
8010144b:	68 c5 71 10 80       	push   $0x801071c5
...
80101514:	68 d8 71 10 80       	push   $0x801071d8
...
8010152c:	68 eb 71 10 80       	push   $0x801071eb
...
80101543:	68 f2 71 10 80       	push   $0x801071f2
...
80101599:	68 58 72 10 80       	push   $0x80107258
...
80101663:	68 f8 71 10 80       	push   $0x801071f8
...
801017dd:	68 10 72 10 80       	push   $0x80107210
801017e2:	e8 99 eb ff ff       	call   80100380 <panic>
    panic("ilock");
801017e7:	83 ec 0c             	sub    $0xc,%esp
801017ea:	68 0a 72 10 80       	push   $0x8010720a
...
80101837:	68 1f 72 10 80       	push   $0x8010721f
...
80101ce2:	68 39 72 10 80       	push   $0x80107239
80101ce7:	e8 94 e6 ff ff       	call   80100380 <panic>
    panic("dirlookup not DIR");
80101cec:	83 ec 0c             	sub    $0xc,%esp
80101cef:	68 27 72 10 80       	push   $0x80107227
...
80101f9b:	68 48 72 10 80       	push   $0x80107248
...
801020bb:	68 b4 72 10 80       	push   $0x801072b4
801020c0:	e8 bb e2 ff ff       	call   80100380 <panic>
    panic("idestart");
801020c5:	83 ec 0c             	sub    $0xc,%esp
801020c8:	68 ab 72 10 80       	push   $0x801072ab
...
801020e6:	68 c6 72 10 80       	push   $0x801072c6
...
8010233a:	68 14 73 10 80       	push   $0x80107314
...
8010246b:	68 46 73 10 80       	push   $0x80107346
...
801024db:	68 4c 73 10 80       	push   $0x8010734c
...
8010264b:	0f b6 8a 80 74 10 80 	movzbl -0x7fef8b80(%edx),%ecx
  shift ^= togglecode[data];
80102652:	0f b6 82 80 73 10 80 	movzbl -0x7fef8c80(%edx),%eax
  shift |= shiftcode[data];
...
80102668:	83 e1 08             	and    $0x8,%ecx
  c = charcode[shift & (CTL | SHIFT)][data];
8010266b:	8b 04 85 60 73 10 80 	mov    -0x7fef8ca0(,%eax,4),%eax
...
801026a8:	31 c0                	xor    %eax,%eax
    shift &= ~(shiftcode[data] | E0ESC);
801026aa:	0f b6 8a 80 74 10 80 	movzbl -0x7fef8b80(%edx),%ecx
...
80102bea:	68 80 75 10 80       	push   $0x80107580
...
80102e47:	68 84 75 10 80       	push   $0x80107584
...
80102f01:	68 93 75 10 80       	push   $0x80107593
80102f06:	e8 75 d4 ff ff       	call   80100380 <panic>
    panic("log_write outside of trans");
80102f0b:	83 ec 0c             	sub    $0xc,%esp
80102f0e:	68 a9 75 10 80       	push   $0x801075a9
...
80102f38:	68 c4 75 10 80       	push   $0x801075c4
80102f3d:	e8 5e d7 ff ff       	call   801006a0 <cprintf>
  idtinit();       // load idt register
80102f42:	e8 f9 29 00 00       	call   80105940 <idtinit>
...
80102f63:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102f66:	e8 a5 3a 00 00       	call   80106a10 <switchkvm>
  seginit();
80102f6b:	e8 10 3a 00 00       	call   80106980 <seginit>
  lapicinit();
...
80102fc4:	e8 77 2c 00 00       	call   80105c40 <uartinit>
  pinit();         // process table
80102fc9:	e8 02 08 00 00       	call   801037d0 <pinit>
  tvinit();        // trap vectors
80102fce:	e8 ed 28 00 00       	call   801058c0 <tvinit>
  binit();         // buffer cache
...
801030de:	68 d8 75 10 80       	push   $0x801075d8
...
80103196:	68 dd 75 10 80       	push   $0x801075dd
...
801032e3:	68 e2 75 10 80       	push   $0x801075e2
801032e8:	e8 93 d0 ff ff       	call   80100380 <panic>
    panic("Didn't find a suitable machine");
801032ed:	83 ec 0c             	sub    $0xc,%esp
801032f0:	68 fc 75 10 80       	push   $0x801075fc
...
80103390:	00 00 00 
  initlock(&p->lock, "pipe");
80103393:	68 1b 76 10 80       	push   $0x8010761b
...
8010371f:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103722:	c7 40 14 af 58 10 80 	movl   $0x801058af,0x14(%eax)
  p->context = (struct context*)sp;
...
801037d6:	68 20 76 10 80       	push   $0x80107620
...
801038c3:	e8 88 35 00 00       	call   80106e50 <setupkvm>
...
801038e1:	e8 4a 32 00 00       	call   80106b30 <inituvm>
...
8010394f:	68 50 76 10 80       	push   $0x80107650
80103954:	50                   	push   %eax
80103955:	e8 16 0f 00 00       	call   80104870 <safestrcpy>
  p->cwd = namei("/");
8010395a:	c7 04 24 59 76 10 80 	movl   $0x80107659,(%esp)
...
80103993:	68 37 76 10 80       	push   $0x80107637
...
801039cb:	e8 50 30 00 00       	call   80106a20 <switchuvm>
  return 0;
...
801039ea:	e8 81 32 00 00       	call   80106c70 <allocuvm>
...
80103a0a:	e8 91 33 00 00       	call   80106da0 <deallocuvm>
...
80103a58:	e8 c3 34 00 00       	call   80106f20 <copyuvm>
...
80103bc3:	e8 58 2e 00 00       	call   80106a20 <switchuvm>
      p->state = RUNNING;
...
80103bd5:	e8 f1 0c 00 00       	call   801048cb <swtch>
      switchkvm();
80103bda:	e8 31 2e 00 00       	call   80106a10 <switchkvm>
      c->proc = 0;
...
80103dcd:	68 a8 76 10 80       	push   $0x801076a8
80103dd2:	e8 a9 c5 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103dd7:	83 ec 0c             	sub    $0xc,%esp
80103dda:	68 9b 76 10 80       	push   $0x8010769b
...
80103ee9:	68 ba 76 10 80       	push   $0x801076ba
80103eee:	e8 8d c4 ff ff       	call   80100380 <panic>
    panic("sleep");
80103ef3:	83 ec 0c             	sub    $0xc,%esp
80103ef6:	68 b4 76 10 80       	push   $0x801076b4
...
801040eb:	68 03 7b 10 80       	push   $0x80107b03
...
8010410c:	74 ea                	je     801040f8 <procdump+0x28>
      state = "???";
8010410e:	ba cb 76 10 80       	mov    $0x801076cb,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104113:	83 f8 05             	cmp    $0x5,%eax
80104116:	77 11                	ja     80104129 <procdump+0x59>
80104118:	8b 14 85 d8 77 10 80 	mov    -0x7fef8828(,%eax,4),%edx
      state = "???";
8010411f:	b8 cb 76 10 80       	mov    $0x801076cb,%eax
...
8010412e:	68 cf 76 10 80       	push   $0x801076cf
...
8010416d:	68 21 71 10 80       	push   $0x80107121
...
801041a2:	e8 99 03 00 00       	call   80104540 <acquire>
  cprintf("name \t pid \t state \t \t priority \n");
801041a7:	c7 04 24 b4 77 10 80 	movl   $0x801077b4,(%esp)
...
8010422a:	68 f3 76 10 80       	push   $0x801076f3
...
8010424a:	68 0c 77 10 80       	push   $0x8010770c
...
8010433a:	68 f0 77 10 80       	push   $0x801077f0
...
801045eb:	68 fb 77 10 80       	push   $0x801077fb
...
80104645:	68 03 78 10 80       	push   $0x80107803
8010464a:	e8 31 bd ff ff       	call   80100380 <panic>
    panic("popcli");
8010464f:	83 ec 0c             	sub    $0xc,%esp
80104652:	68 1a 78 10 80       	push   $0x8010781a
...
80104671:	68 21 78 10 80       	push   $0x80107821
...
80104aa8:	68 29 78 10 80       	push   $0x80107829
...
80104c31:	68 d3 78 10 80       	push   $0x801078d3
...
80104c4f:	68 e2 78 10 80       	push   $0x801078e2
80104c54:	e8 27 b7 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104c59:	83 ec 0c             	sub    $0xc,%esp
80104c5c:	68 c4 78 10 80       	push   $0x801078c4
...
8010590e:	00 00 ef 
  initlock(&tickslock, "time");
80105911:	68 25 79 10 80       	push   $0x80107925
...
8010594b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010594f:	b8 a0 4d 11 80       	mov    $0x80114da0,%eax
...
80105982:	0f 84 c0 01 00 00    	je     80105b48 <trap+0x1d8>
    if(myproc()->killed)
      exit();
    return;
  }
...
8010598e:	77 07                	ja     80105997 <trap+0x27>
...
80105997:	e8 e4 de ff ff       	call   80103880 <myproc>
8010599c:	8b 7b 38             	mov    0x38(%ebx),%edi
8010599f:	85 c0                	test   %eax,%eax
801059a1:	0f 84 f0 01 00 00    	je     80105b97 <trap+0x227>
801059a7:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
801059ab:	0f 84 e6 01 00 00    	je     80105b97 <trap+0x227>
...
801059b1:	0f 20 d1             	mov    %cr2,%ecx
801059b4:	89 4d d8             	mov    %ecx,-0x28(%ebp)
...
801059b7:	e8 a4 de ff ff       	call   80103860 <cpuid>
801059bc:	8b 73 30             	mov    0x30(%ebx),%esi
801059bf:	89 45 dc             	mov    %eax,-0x24(%ebp)
801059c2:	8b 43 34             	mov    0x34(%ebx),%eax
801059c5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
801059c8:	e8 b3 de ff ff       	call   80103880 <myproc>
801059cd:	89 45 e0             	mov    %eax,-0x20(%ebp)
801059d0:	e8 ab de ff ff       	call   80103880 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801059d5:	8b 4d d8             	mov    -0x28(%ebp),%ecx
801059d8:	8b 55 dc             	mov    -0x24(%ebp),%edx
801059db:	51                   	push   %ecx
801059dc:	57                   	push   %edi
801059dd:	52                   	push   %edx
801059de:	ff 75 e4             	pushl  -0x1c(%ebp)
801059e1:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
801059e2:	8b 75 e0             	mov    -0x20(%ebp),%esi
801059e5:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801059e8:	56                   	push   %esi
801059e9:	ff 70 10             	pushl  0x10(%eax)
801059ec:	68 88 79 10 80       	push   $0x80107988
801059f1:	e8 aa ac ff ff       	call   801006a0 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
801059f6:	83 c4 20             	add    $0x20,%esp
801059f9:	e8 82 de ff ff       	call   80103880 <myproc>
801059fe:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  }
...
80105a05:	e8 76 de ff ff       	call   80103880 <myproc>
80105a0a:	85 c0                	test   %eax,%eax
80105a0c:	74 1d                	je     80105a2b <trap+0xbb>
80105a0e:	e8 6d de ff ff       	call   80103880 <myproc>
80105a13:	8b 50 24             	mov    0x24(%eax),%edx
80105a16:	85 d2                	test   %edx,%edx
80105a18:	74 11                	je     80105a2b <trap+0xbb>
80105a1a:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105a1e:	83 e0 03             	and    $0x3,%eax
80105a21:	66 83 f8 03          	cmp    $0x3,%ax
80105a25:	0f 84 55 01 00 00    	je     80105b80 <trap+0x210>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80105a2b:	e8 50 de ff ff       	call   80103880 <myproc>
80105a30:	85 c0                	test   %eax,%eax
80105a32:	74 0f                	je     80105a43 <trap+0xd3>
80105a34:	e8 47 de ff ff       	call   80103880 <myproc>
80105a39:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105a3d:	0f 84 ed 00 00 00    	je     80105b30 <trap+0x1c0>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a43:	e8 38 de ff ff       	call   80103880 <myproc>
80105a48:	85 c0                	test   %eax,%eax
80105a4a:	74 1d                	je     80105a69 <trap+0xf9>
80105a4c:	e8 2f de ff ff       	call   80103880 <myproc>
80105a51:	8b 40 24             	mov    0x24(%eax),%eax
80105a54:	85 c0                	test   %eax,%eax
80105a56:	74 11                	je     80105a69 <trap+0xf9>
80105a58:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105a5c:	83 e0 03             	and    $0x3,%eax
80105a5f:	66 83 f8 03          	cmp    $0x3,%ax
80105a63:	0f 84 08 01 00 00    	je     80105b71 <trap+0x201>
    exit();
}
...
80105a70:	c3                   	ret    
    ideintr();
80105a71:	e8 ea c6 ff ff       	call   80102160 <ideintr>
    lapiceoi();
80105a76:	e8 b5 cd ff ff       	call   80102830 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a7b:	e8 00 de ff ff       	call   80103880 <myproc>
80105a80:	85 c0                	test   %eax,%eax
80105a82:	75 8a                	jne    80105a0e <trap+0x9e>
80105a84:	eb a5                	jmp    80105a2b <trap+0xbb>
    if(cpuid() == 0){
80105a86:	e8 d5 dd ff ff       	call   80103860 <cpuid>
80105a8b:	85 c0                	test   %eax,%eax
80105a8d:	75 e7                	jne    80105a76 <trap+0x106>
      acquire(&tickslock);
80105a8f:	83 ec 0c             	sub    $0xc,%esp
80105a92:	68 60 4d 11 80       	push   $0x80114d60
80105a97:	e8 a4 ea ff ff       	call   80104540 <acquire>
      wakeup(&ticks);
80105a9c:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
      ticks++;
80105aa3:	83 05 a0 55 11 80 01 	addl   $0x1,0x801155a0
      wakeup(&ticks);
80105aaa:	e8 41 e5 ff ff       	call   80103ff0 <wakeup>
      release(&tickslock);
80105aaf:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105ab6:	e8 a5 eb ff ff       	call   80104660 <release>
80105abb:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105abe:	eb b6                	jmp    80105a76 <trap+0x106>
    kbdintr();
80105ac0:	e8 2b cc ff ff       	call   801026f0 <kbdintr>
    lapiceoi();
80105ac5:	e8 66 cd ff ff       	call   80102830 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105aca:	e8 b1 dd ff ff       	call   80103880 <myproc>
80105acf:	85 c0                	test   %eax,%eax
80105ad1:	0f 85 37 ff ff ff    	jne    80105a0e <trap+0x9e>
80105ad7:	e9 4f ff ff ff       	jmp    80105a2b <trap+0xbb>
    uartintr();
80105adc:	e8 4f 02 00 00       	call   80105d30 <uartintr>
    lapiceoi();
80105ae1:	e8 4a cd ff ff       	call   80102830 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105ae6:	e8 95 dd ff ff       	call   80103880 <myproc>
80105aeb:	85 c0                	test   %eax,%eax
80105aed:	0f 85 1b ff ff ff    	jne    80105a0e <trap+0x9e>
80105af3:	e9 33 ff ff ff       	jmp    80105a2b <trap+0xbb>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105af8:	8b 7b 38             	mov    0x38(%ebx),%edi
80105afb:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105aff:	e8 5c dd ff ff       	call   80103860 <cpuid>
80105b04:	57                   	push   %edi
80105b05:	56                   	push   %esi
80105b06:	50                   	push   %eax
80105b07:	68 30 79 10 80       	push   $0x80107930
80105b0c:	e8 8f ab ff ff       	call   801006a0 <cprintf>
    lapiceoi();
80105b11:	e8 1a cd ff ff       	call   80102830 <lapiceoi>
    break;
80105b16:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b19:	e8 62 dd ff ff       	call   80103880 <myproc>
80105b1e:	85 c0                	test   %eax,%eax
80105b20:	0f 85 e8 fe ff ff    	jne    80105a0e <trap+0x9e>
80105b26:	e9 00 ff ff ff       	jmp    80105a2b <trap+0xbb>
80105b2b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105b2f:	90                   	nop
  if(myproc() && myproc()->state == RUNNING &&
80105b30:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105b34:	0f 85 09 ff ff ff    	jne    80105a43 <trap+0xd3>
    yield();
80105b3a:	e8 b1 e2 ff ff       	call   80103df0 <yield>
80105b3f:	e9 ff fe ff ff       	jmp    80105a43 <trap+0xd3>
80105b44:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80105b48:	e8 33 dd ff ff       	call   80103880 <myproc>
80105b4d:	8b 70 24             	mov    0x24(%eax),%esi
80105b50:	85 f6                	test   %esi,%esi
80105b52:	75 3c                	jne    80105b90 <trap+0x220>
    myproc()->tf = tf;
80105b54:	e8 27 dd ff ff       	call   80103880 <myproc>
...
80105b6b:	0f 84 f8 fe ff ff    	je     80105a69 <trap+0xf9>
}
...
80105b77:	5d                   	pop    %ebp
      exit();
80105b78:	e9 43 e1 ff ff       	jmp    80103cc0 <exit>
80105b7d:	8d 76 00             	lea    0x0(%esi),%esi
    exit();
80105b80:	e8 3b e1 ff ff       	call   80103cc0 <exit>
80105b85:	e9 a1 fe ff ff       	jmp    80105a2b <trap+0xbb>
80105b8a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105b90:	e8 2b e1 ff ff       	call   80103cc0 <exit>
80105b95:	eb bd                	jmp    80105b54 <trap+0x1e4>
80105b97:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105b9a:	e8 c1 dc ff ff       	call   80103860 <cpuid>
...
80105ba8:	68 54 79 10 80       	push   $0x80107954
80105bad:	e8 ee aa ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105bb2:	83 c4 14             	add    $0x14,%esp
80105bb5:	68 2a 79 10 80       	push   $0x8010792a
...
80105c15:	e8 36 cc ff ff       	call   80102850 <microdelay>
...
80105c97:	74 56                	je     80105cef <uartinit+0xaf>
  uart = 1;
...
80105caf:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80105cb4:	bb 4c 7a 10 80       	mov    $0x80107a4c,%ebx
  ioapicenable(IRQ_COM1, 0);
80105cb9:	6a 00                	push   $0x0
80105cbb:	6a 04                	push   $0x4
80105cbd:	e8 de c6 ff ff       	call   801023a0 <ioapicenable>
80105cc2:	83 c4 10             	add    $0x10,%esp
  for(p="xv6...\n"; *p; p++)
80105cc5:	b8 78 00 00 00       	mov    $0x78,%eax
80105cca:	eb 08                	jmp    80105cd4 <uartinit+0x94>
...
80105d00:	55                   	push   %ebp
  if(!uart)
80105d01:	8b 15 bc a5 10 80    	mov    0x8010a5bc,%edx
{
80105d07:	89 e5                	mov    %esp,%ebp
80105d09:	8b 45 08             	mov    0x8(%ebp),%eax
  if(!uart)
80105d0c:	85 d2                	test   %edx,%edx
...
80105d3b:	e8 10 ab ff ff       	call   80100850 <consoleintr>
}
...
80105d49:	e9 49 fb ff ff       	jmp    80105897 <alltraps>

80105d4e <vector1>:
80105d4e:	6a 00                	push   $0x0
80105d50:	6a 01                	push   $0x1
80105d52:	e9 40 fb ff ff       	jmp    80105897 <alltraps>

80105d57 <vector2>:
80105d57:	6a 00                	push   $0x0
80105d59:	6a 02                	push   $0x2
80105d5b:	e9 37 fb ff ff       	jmp    80105897 <alltraps>

80105d60 <vector3>:
80105d60:	6a 00                	push   $0x0
80105d62:	6a 03                	push   $0x3
80105d64:	e9 2e fb ff ff       	jmp    80105897 <alltraps>

80105d69 <vector4>:
80105d69:	6a 00                	push   $0x0
80105d6b:	6a 04                	push   $0x4
80105d6d:	e9 25 fb ff ff       	jmp    80105897 <alltraps>

80105d72 <vector5>:
80105d72:	6a 00                	push   $0x0
80105d74:	6a 05                	push   $0x5
80105d76:	e9 1c fb ff ff       	jmp    80105897 <alltraps>

80105d7b <vector6>:
80105d7b:	6a 00                	push   $0x0
80105d7d:	6a 06                	push   $0x6
80105d7f:	e9 13 fb ff ff       	jmp    80105897 <alltraps>

80105d84 <vector7>:
80105d84:	6a 00                	push   $0x0
80105d86:	6a 07                	push   $0x7
80105d88:	e9 0a fb ff ff       	jmp    80105897 <alltraps>

80105d8d <vector8>:
80105d8d:	6a 08                	push   $0x8
80105d8f:	e9 03 fb ff ff       	jmp    80105897 <alltraps>

80105d94 <vector9>:
80105d94:	6a 00                	push   $0x0
80105d96:	6a 09                	push   $0x9
80105d98:	e9 fa fa ff ff       	jmp    80105897 <alltraps>

80105d9d <vector10>:
80105d9d:	6a 0a                	push   $0xa
80105d9f:	e9 f3 fa ff ff       	jmp    80105897 <alltraps>

80105da4 <vector11>:
80105da4:	6a 0b                	push   $0xb
80105da6:	e9 ec fa ff ff       	jmp    80105897 <alltraps>

80105dab <vector12>:
80105dab:	6a 0c                	push   $0xc
80105dad:	e9 e5 fa ff ff       	jmp    80105897 <alltraps>

80105db2 <vector13>:
80105db2:	6a 0d                	push   $0xd
80105db4:	e9 de fa ff ff       	jmp    80105897 <alltraps>

80105db9 <vector14>:
80105db9:	6a 0e                	push   $0xe
80105dbb:	e9 d7 fa ff ff       	jmp    80105897 <alltraps>

80105dc0 <vector15>:
80105dc0:	6a 00                	push   $0x0
80105dc2:	6a 0f                	push   $0xf
80105dc4:	e9 ce fa ff ff       	jmp    80105897 <alltraps>

80105dc9 <vector16>:
80105dc9:	6a 00                	push   $0x0
80105dcb:	6a 10                	push   $0x10
80105dcd:	e9 c5 fa ff ff       	jmp    80105897 <alltraps>

80105dd2 <vector17>:
80105dd2:	6a 11                	push   $0x11
80105dd4:	e9 be fa ff ff       	jmp    80105897 <alltraps>

80105dd9 <vector18>:
80105dd9:	6a 00                	push   $0x0
80105ddb:	6a 12                	push   $0x12
80105ddd:	e9 b5 fa ff ff       	jmp    80105897 <alltraps>

80105de2 <vector19>:
80105de2:	6a 00                	push   $0x0
80105de4:	6a 13                	push   $0x13
80105de6:	e9 ac fa ff ff       	jmp    80105897 <alltraps>

80105deb <vector20>:
80105deb:	6a 00                	push   $0x0
80105ded:	6a 14                	push   $0x14
80105def:	e9 a3 fa ff ff       	jmp    80105897 <alltraps>

80105df4 <vector21>:
80105df4:	6a 00                	push   $0x0
80105df6:	6a 15                	push   $0x15
80105df8:	e9 9a fa ff ff       	jmp    80105897 <alltraps>

80105dfd <vector22>:
80105dfd:	6a 00                	push   $0x0
80105dff:	6a 16                	push   $0x16
80105e01:	e9 91 fa ff ff       	jmp    80105897 <alltraps>

80105e06 <vector23>:
80105e06:	6a 00                	push   $0x0
80105e08:	6a 17                	push   $0x17
80105e0a:	e9 88 fa ff ff       	jmp    80105897 <alltraps>

80105e0f <vector24>:
80105e0f:	6a 00                	push   $0x0
80105e11:	6a 18                	push   $0x18
80105e13:	e9 7f fa ff ff       	jmp    80105897 <alltraps>

80105e18 <vector25>:
80105e18:	6a 00                	push   $0x0
80105e1a:	6a 19                	push   $0x19
80105e1c:	e9 76 fa ff ff       	jmp    80105897 <alltraps>

80105e21 <vector26>:
80105e21:	6a 00                	push   $0x0
80105e23:	6a 1a                	push   $0x1a
80105e25:	e9 6d fa ff ff       	jmp    80105897 <alltraps>

80105e2a <vector27>:
80105e2a:	6a 00                	push   $0x0
80105e2c:	6a 1b                	push   $0x1b
80105e2e:	e9 64 fa ff ff       	jmp    80105897 <alltraps>

80105e33 <vector28>:
80105e33:	6a 00                	push   $0x0
80105e35:	6a 1c                	push   $0x1c
80105e37:	e9 5b fa ff ff       	jmp    80105897 <alltraps>

80105e3c <vector29>:
80105e3c:	6a 00                	push   $0x0
80105e3e:	6a 1d                	push   $0x1d
80105e40:	e9 52 fa ff ff       	jmp    80105897 <alltraps>

80105e45 <vector30>:
80105e45:	6a 00                	push   $0x0
80105e47:	6a 1e                	push   $0x1e
80105e49:	e9 49 fa ff ff       	jmp    80105897 <alltraps>

80105e4e <vector31>:
80105e4e:	6a 00                	push   $0x0
80105e50:	6a 1f                	push   $0x1f
80105e52:	e9 40 fa ff ff       	jmp    80105897 <alltraps>

80105e57 <vector32>:
80105e57:	6a 00                	push   $0x0
80105e59:	6a 20                	push   $0x20
80105e5b:	e9 37 fa ff ff       	jmp    80105897 <alltraps>

80105e60 <vector33>:
80105e60:	6a 00                	push   $0x0
80105e62:	6a 21                	push   $0x21
80105e64:	e9 2e fa ff ff       	jmp    80105897 <alltraps>
...
80105e76:	e9 1c fa ff ff       	jmp    80105897 <alltraps>

80105e7b <vector36>:
80105e7b:	6a 00                	push   $0x0
80105e7d:	6a 24                	push   $0x24
80105e7f:	e9 13 fa ff ff       	jmp    80105897 <alltraps>

80105e84 <vector37>:
80105e84:	6a 00                	push   $0x0
80105e86:	6a 25                	push   $0x25
80105e88:	e9 0a fa ff ff       	jmp    80105897 <alltraps>

80105e8d <vector38>:
80105e8d:	6a 00                	push   $0x0
80105e8f:	6a 26                	push   $0x26
80105e91:	e9 01 fa ff ff       	jmp    80105897 <alltraps>

80105e96 <vector39>:
80105e96:	6a 00                	push   $0x0
80105e98:	6a 27                	push   $0x27
80105e9a:	e9 f8 f9 ff ff       	jmp    80105897 <alltraps>

80105e9f <vector40>:
80105e9f:	6a 00                	push   $0x0
80105ea1:	6a 28                	push   $0x28
80105ea3:	e9 ef f9 ff ff       	jmp    80105897 <alltraps>

80105ea8 <vector41>:
80105ea8:	6a 00                	push   $0x0
80105eaa:	6a 29                	push   $0x29
80105eac:	e9 e6 f9 ff ff       	jmp    80105897 <alltraps>

80105eb1 <vector42>:
80105eb1:	6a 00                	push   $0x0
80105eb3:	6a 2a                	push   $0x2a
80105eb5:	e9 dd f9 ff ff       	jmp    80105897 <alltraps>

80105eba <vector43>:
80105eba:	6a 00                	push   $0x0
80105ebc:	6a 2b                	push   $0x2b
80105ebe:	e9 d4 f9 ff ff       	jmp    80105897 <alltraps>

80105ec3 <vector44>:
80105ec3:	6a 00                	push   $0x0
80105ec5:	6a 2c                	push   $0x2c
80105ec7:	e9 cb f9 ff ff       	jmp    80105897 <alltraps>

80105ecc <vector45>:
80105ecc:	6a 00                	push   $0x0
80105ece:	6a 2d                	push   $0x2d
80105ed0:	e9 c2 f9 ff ff       	jmp    80105897 <alltraps>

80105ed5 <vector46>:
80105ed5:	6a 00                	push   $0x0
80105ed7:	6a 2e                	push   $0x2e
80105ed9:	e9 b9 f9 ff ff       	jmp    80105897 <alltraps>

80105ede <vector47>:
80105ede:	6a 00                	push   $0x0
80105ee0:	6a 2f                	push   $0x2f
80105ee2:	e9 b0 f9 ff ff       	jmp    80105897 <alltraps>

80105ee7 <vector48>:
80105ee7:	6a 00                	push   $0x0
80105ee9:	6a 30                	push   $0x30
80105eeb:	e9 a7 f9 ff ff       	jmp    80105897 <alltraps>

80105ef0 <vector49>:
80105ef0:	6a 00                	push   $0x0
80105ef2:	6a 31                	push   $0x31
80105ef4:	e9 9e f9 ff ff       	jmp    80105897 <alltraps>

80105ef9 <vector50>:
80105ef9:	6a 00                	push   $0x0
80105efb:	6a 32                	push   $0x32
80105efd:	e9 95 f9 ff ff       	jmp    80105897 <alltraps>

80105f02 <vector51>:
80105f02:	6a 00                	push   $0x0
80105f04:	6a 33                	push   $0x33
80105f06:	e9 8c f9 ff ff       	jmp    80105897 <alltraps>

80105f0b <vector52>:
80105f0b:	6a 00                	push   $0x0
80105f0d:	6a 34                	push   $0x34
80105f0f:	e9 83 f9 ff ff       	jmp    80105897 <alltraps>

80105f14 <vector53>:
80105f14:	6a 00                	push   $0x0
80105f16:	6a 35                	push   $0x35
80105f18:	e9 7a f9 ff ff       	jmp    80105897 <alltraps>

80105f1d <vector54>:
80105f1d:	6a 00                	push   $0x0
80105f1f:	6a 36                	push   $0x36
80105f21:	e9 71 f9 ff ff       	jmp    80105897 <alltraps>

80105f26 <vector55>:
80105f26:	6a 00                	push   $0x0
80105f28:	6a 37                	push   $0x37
80105f2a:	e9 68 f9 ff ff       	jmp    80105897 <alltraps>

80105f2f <vector56>:
80105f2f:	6a 00                	push   $0x0
80105f31:	6a 38                	push   $0x38
80105f33:	e9 5f f9 ff ff       	jmp    80105897 <alltraps>

80105f38 <vector57>:
80105f38:	6a 00                	push   $0x0
80105f3a:	6a 39                	push   $0x39
80105f3c:	e9 56 f9 ff ff       	jmp    80105897 <alltraps>

80105f41 <vector58>:
80105f41:	6a 00                	push   $0x0
80105f43:	6a 3a                	push   $0x3a
80105f45:	e9 4d f9 ff ff       	jmp    80105897 <alltraps>

80105f4a <vector59>:
80105f4a:	6a 00                	push   $0x0
80105f4c:	6a 3b                	push   $0x3b
80105f4e:	e9 44 f9 ff ff       	jmp    80105897 <alltraps>

80105f53 <vector60>:
80105f53:	6a 00                	push   $0x0
80105f55:	6a 3c                	push   $0x3c
80105f57:	e9 3b f9 ff ff       	jmp    80105897 <alltraps>

80105f5c <vector61>:
80105f5c:	6a 00                	push   $0x0
80105f5e:	6a 3d                	push   $0x3d
80105f60:	e9 32 f9 ff ff       	jmp    80105897 <alltraps>

80105f65 <vector62>:
80105f65:	6a 00                	push   $0x0
80105f67:	6a 3e                	push   $0x3e
80105f69:	e9 29 f9 ff ff       	jmp    80105897 <alltraps>

80105f6e <vector63>:
80105f6e:	6a 00                	push   $0x0
80105f70:	6a 3f                	push   $0x3f
80105f72:	e9 20 f9 ff ff       	jmp    80105897 <alltraps>

80105f77 <vector64>:
80105f77:	6a 00                	push   $0x0
80105f79:	6a 40                	push   $0x40
80105f7b:	e9 17 f9 ff ff       	jmp    80105897 <alltraps>

80105f80 <vector65>:
80105f80:	6a 00                	push   $0x0
80105f82:	6a 41                	push   $0x41
80105f84:	e9 0e f9 ff ff       	jmp    80105897 <alltraps>

80105f89 <vector66>:
80105f89:	6a 00                	push   $0x0
80105f8b:	6a 42                	push   $0x42
80105f8d:	e9 05 f9 ff ff       	jmp    80105897 <alltraps>

80105f92 <vector67>:
80105f92:	6a 00                	push   $0x0
80105f94:	6a 43                	push   $0x43
80105f96:	e9 fc f8 ff ff       	jmp    80105897 <alltraps>

80105f9b <vector68>:
80105f9b:	6a 00                	push   $0x0
80105f9d:	6a 44                	push   $0x44
80105f9f:	e9 f3 f8 ff ff       	jmp    80105897 <alltraps>

80105fa4 <vector69>:
80105fa4:	6a 00                	push   $0x0
80105fa6:	6a 45                	push   $0x45
80105fa8:	e9 ea f8 ff ff       	jmp    80105897 <alltraps>

80105fad <vector70>:
80105fad:	6a 00                	push   $0x0
80105faf:	6a 46                	push   $0x46
80105fb1:	e9 e1 f8 ff ff       	jmp    80105897 <alltraps>

80105fb6 <vector71>:
80105fb6:	6a 00                	push   $0x0
80105fb8:	6a 47                	push   $0x47
80105fba:	e9 d8 f8 ff ff       	jmp    80105897 <alltraps>

80105fbf <vector72>:
80105fbf:	6a 00                	push   $0x0
80105fc1:	6a 48                	push   $0x48
80105fc3:	e9 cf f8 ff ff       	jmp    80105897 <alltraps>

80105fc8 <vector73>:
80105fc8:	6a 00                	push   $0x0
80105fca:	6a 49                	push   $0x49
80105fcc:	e9 c6 f8 ff ff       	jmp    80105897 <alltraps>

80105fd1 <vector74>:
80105fd1:	6a 00                	push   $0x0
80105fd3:	6a 4a                	push   $0x4a
80105fd5:	e9 bd f8 ff ff       	jmp    80105897 <alltraps>

80105fda <vector75>:
80105fda:	6a 00                	push   $0x0
80105fdc:	6a 4b                	push   $0x4b
80105fde:	e9 b4 f8 ff ff       	jmp    80105897 <alltraps>

80105fe3 <vector76>:
80105fe3:	6a 00                	push   $0x0
80105fe5:	6a 4c                	push   $0x4c
80105fe7:	e9 ab f8 ff ff       	jmp    80105897 <alltraps>

80105fec <vector77>:
80105fec:	6a 00                	push   $0x0
80105fee:	6a 4d                	push   $0x4d
80105ff0:	e9 a2 f8 ff ff       	jmp    80105897 <alltraps>

80105ff5 <vector78>:
80105ff5:	6a 00                	push   $0x0
80105ff7:	6a 4e                	push   $0x4e
80105ff9:	e9 99 f8 ff ff       	jmp    80105897 <alltraps>

80105ffe <vector79>:
80105ffe:	6a 00                	push   $0x0
80106000:	6a 4f                	push   $0x4f
80106002:	e9 90 f8 ff ff       	jmp    80105897 <alltraps>

80106007 <vector80>:
80106007:	6a 00                	push   $0x0
80106009:	6a 50                	push   $0x50
8010600b:	e9 87 f8 ff ff       	jmp    80105897 <alltraps>

80106010 <vector81>:
80106010:	6a 00                	push   $0x0
80106012:	6a 51                	push   $0x51
80106014:	e9 7e f8 ff ff       	jmp    80105897 <alltraps>

80106019 <vector82>:
80106019:	6a 00                	push   $0x0
8010601b:	6a 52                	push   $0x52
8010601d:	e9 75 f8 ff ff       	jmp    80105897 <alltraps>

80106022 <vector83>:
80106022:	6a 00                	push   $0x0
80106024:	6a 53                	push   $0x53
80106026:	e9 6c f8 ff ff       	jmp    80105897 <alltraps>

8010602b <vector84>:
8010602b:	6a 00                	push   $0x0
8010602d:	6a 54                	push   $0x54
8010602f:	e9 63 f8 ff ff       	jmp    80105897 <alltraps>

80106034 <vector85>:
80106034:	6a 00                	push   $0x0
80106036:	6a 55                	push   $0x55
80106038:	e9 5a f8 ff ff       	jmp    80105897 <alltraps>

8010603d <vector86>:
8010603d:	6a 00                	push   $0x0
8010603f:	6a 56                	push   $0x56
80106041:	e9 51 f8 ff ff       	jmp    80105897 <alltraps>

80106046 <vector87>:
80106046:	6a 00                	push   $0x0
80106048:	6a 57                	push   $0x57
8010604a:	e9 48 f8 ff ff       	jmp    80105897 <alltraps>

8010604f <vector88>:
8010604f:	6a 00                	push   $0x0
80106051:	6a 58                	push   $0x58
80106053:	e9 3f f8 ff ff       	jmp    80105897 <alltraps>

80106058 <vector89>:
80106058:	6a 00                	push   $0x0
8010605a:	6a 59                	push   $0x59
8010605c:	e9 36 f8 ff ff       	jmp    80105897 <alltraps>

80106061 <vector90>:
80106061:	6a 00                	push   $0x0
80106063:	6a 5a                	push   $0x5a
80106065:	e9 2d f8 ff ff       	jmp    80105897 <alltraps>

8010606a <vector91>:
8010606a:	6a 00                	push   $0x0
8010606c:	6a 5b                	push   $0x5b
8010606e:	e9 24 f8 ff ff       	jmp    80105897 <alltraps>

80106073 <vector92>:
80106073:	6a 00                	push   $0x0
80106075:	6a 5c                	push   $0x5c
80106077:	e9 1b f8 ff ff       	jmp    80105897 <alltraps>

8010607c <vector93>:
8010607c:	6a 00                	push   $0x0
8010607e:	6a 5d                	push   $0x5d
80106080:	e9 12 f8 ff ff       	jmp    80105897 <alltraps>

80106085 <vector94>:
80106085:	6a 00                	push   $0x0
80106087:	6a 5e                	push   $0x5e
80106089:	e9 09 f8 ff ff       	jmp    80105897 <alltraps>

8010608e <vector95>:
8010608e:	6a 00                	push   $0x0
80106090:	6a 5f                	push   $0x5f
80106092:	e9 00 f8 ff ff       	jmp    80105897 <alltraps>

80106097 <vector96>:
80106097:	6a 00                	push   $0x0
80106099:	6a 60                	push   $0x60
8010609b:	e9 f7 f7 ff ff       	jmp    80105897 <alltraps>

801060a0 <vector97>:
801060a0:	6a 00                	push   $0x0
801060a2:	6a 61                	push   $0x61
801060a4:	e9 ee f7 ff ff       	jmp    80105897 <alltraps>

801060a9 <vector98>:
801060a9:	6a 00                	push   $0x0
801060ab:	6a 62                	push   $0x62
801060ad:	e9 e5 f7 ff ff       	jmp    80105897 <alltraps>

801060b2 <vector99>:
801060b2:	6a 00                	push   $0x0
801060b4:	6a 63                	push   $0x63
801060b6:	e9 dc f7 ff ff       	jmp    80105897 <alltraps>

801060bb <vector100>:
801060bb:	6a 00                	push   $0x0
801060bd:	6a 64                	push   $0x64
801060bf:	e9 d3 f7 ff ff       	jmp    80105897 <alltraps>

801060c4 <vector101>:
801060c4:	6a 00                	push   $0x0
801060c6:	6a 65                	push   $0x65
801060c8:	e9 ca f7 ff ff       	jmp    80105897 <alltraps>

801060cd <vector102>:
801060cd:	6a 00                	push   $0x0
801060cf:	6a 66                	push   $0x66
801060d1:	e9 c1 f7 ff ff       	jmp    80105897 <alltraps>

801060d6 <vector103>:
801060d6:	6a 00                	push   $0x0
801060d8:	6a 67                	push   $0x67
801060da:	e9 b8 f7 ff ff       	jmp    80105897 <alltraps>

801060df <vector104>:
801060df:	6a 00                	push   $0x0
801060e1:	6a 68                	push   $0x68
801060e3:	e9 af f7 ff ff       	jmp    80105897 <alltraps>

801060e8 <vector105>:
801060e8:	6a 00                	push   $0x0
801060ea:	6a 69                	push   $0x69
801060ec:	e9 a6 f7 ff ff       	jmp    80105897 <alltraps>

801060f1 <vector106>:
801060f1:	6a 00                	push   $0x0
801060f3:	6a 6a                	push   $0x6a
801060f5:	e9 9d f7 ff ff       	jmp    80105897 <alltraps>

801060fa <vector107>:
801060fa:	6a 00                	push   $0x0
801060fc:	6a 6b                	push   $0x6b
801060fe:	e9 94 f7 ff ff       	jmp    80105897 <alltraps>

80106103 <vector108>:
80106103:	6a 00                	push   $0x0
80106105:	6a 6c                	push   $0x6c
80106107:	e9 8b f7 ff ff       	jmp    80105897 <alltraps>

8010610c <vector109>:
8010610c:	6a 00                	push   $0x0
8010610e:	6a 6d                	push   $0x6d
80106110:	e9 82 f7 ff ff       	jmp    80105897 <alltraps>

80106115 <vector110>:
80106115:	6a 00                	push   $0x0
80106117:	6a 6e                	push   $0x6e
80106119:	e9 79 f7 ff ff       	jmp    80105897 <alltraps>

8010611e <vector111>:
8010611e:	6a 00                	push   $0x0
80106120:	6a 6f                	push   $0x6f
80106122:	e9 70 f7 ff ff       	jmp    80105897 <alltraps>

80106127 <vector112>:
80106127:	6a 00                	push   $0x0
80106129:	6a 70                	push   $0x70
8010612b:	e9 67 f7 ff ff       	jmp    80105897 <alltraps>

80106130 <vector113>:
80106130:	6a 00                	push   $0x0
80106132:	6a 71                	push   $0x71
80106134:	e9 5e f7 ff ff       	jmp    80105897 <alltraps>

80106139 <vector114>:
80106139:	6a 00                	push   $0x0
8010613b:	6a 72                	push   $0x72
8010613d:	e9 55 f7 ff ff       	jmp    80105897 <alltraps>

80106142 <vector115>:
80106142:	6a 00                	push   $0x0
80106144:	6a 73                	push   $0x73
80106146:	e9 4c f7 ff ff       	jmp    80105897 <alltraps>

8010614b <vector116>:
8010614b:	6a 00                	push   $0x0
8010614d:	6a 74                	push   $0x74
8010614f:	e9 43 f7 ff ff       	jmp    80105897 <alltraps>

80106154 <vector117>:
80106154:	6a 00                	push   $0x0
80106156:	6a 75                	push   $0x75
80106158:	e9 3a f7 ff ff       	jmp    80105897 <alltraps>

8010615d <vector118>:
8010615d:	6a 00                	push   $0x0
8010615f:	6a 76                	push   $0x76
80106161:	e9 31 f7 ff ff       	jmp    80105897 <alltraps>

80106166 <vector119>:
80106166:	6a 00                	push   $0x0
80106168:	6a 77                	push   $0x77
8010616a:	e9 28 f7 ff ff       	jmp    80105897 <alltraps>

8010616f <vector120>:
8010616f:	6a 00                	push   $0x0
80106171:	6a 78                	push   $0x78
80106173:	e9 1f f7 ff ff       	jmp    80105897 <alltraps>

80106178 <vector121>:
80106178:	6a 00                	push   $0x0
8010617a:	6a 79                	push   $0x79
8010617c:	e9 16 f7 ff ff       	jmp    80105897 <alltraps>

80106181 <vector122>:
80106181:	6a 00                	push   $0x0
80106183:	6a 7a                	push   $0x7a
80106185:	e9 0d f7 ff ff       	jmp    80105897 <alltraps>

8010618a <vector123>:
8010618a:	6a 00                	push   $0x0
8010618c:	6a 7b                	push   $0x7b
8010618e:	e9 04 f7 ff ff       	jmp    80105897 <alltraps>

80106193 <vector124>:
80106193:	6a 00                	push   $0x0
80106195:	6a 7c                	push   $0x7c
80106197:	e9 fb f6 ff ff       	jmp    80105897 <alltraps>

8010619c <vector125>:
8010619c:	6a 00                	push   $0x0
8010619e:	6a 7d                	push   $0x7d
801061a0:	e9 f2 f6 ff ff       	jmp    80105897 <alltraps>

801061a5 <vector126>:
801061a5:	6a 00                	push   $0x0
801061a7:	6a 7e                	push   $0x7e
801061a9:	e9 e9 f6 ff ff       	jmp    80105897 <alltraps>

801061ae <vector127>:
801061ae:	6a 00                	push   $0x0
801061b0:	6a 7f                	push   $0x7f
801061b2:	e9 e0 f6 ff ff       	jmp    80105897 <alltraps>
...
801061ca:	e9 c8 f6 ff ff       	jmp    80105897 <alltraps>

801061cf <vector130>:
801061cf:	6a 00                	push   $0x0
801061d1:	68 82 00 00 00       	push   $0x82
801061d6:	e9 bc f6 ff ff       	jmp    80105897 <alltraps>
...
801061ee:	e9 a4 f6 ff ff       	jmp    80105897 <alltraps>

801061f3 <vector133>:
801061f3:	6a 00                	push   $0x0
801061f5:	68 85 00 00 00       	push   $0x85
801061fa:	e9 98 f6 ff ff       	jmp    80105897 <alltraps>
...
80106212:	e9 80 f6 ff ff       	jmp    80105897 <alltraps>

80106217 <vector136>:
80106217:	6a 00                	push   $0x0
80106219:	68 88 00 00 00       	push   $0x88
8010621e:	e9 74 f6 ff ff       	jmp    80105897 <alltraps>
...
80106236:	e9 5c f6 ff ff       	jmp    80105897 <alltraps>

8010623b <vector139>:
8010623b:	6a 00                	push   $0x0
8010623d:	68 8b 00 00 00       	push   $0x8b
80106242:	e9 50 f6 ff ff       	jmp    80105897 <alltraps>
...
8010625a:	e9 38 f6 ff ff       	jmp    80105897 <alltraps>

8010625f <vector142>:
8010625f:	6a 00                	push   $0x0
80106261:	68 8e 00 00 00       	push   $0x8e
80106266:	e9 2c f6 ff ff       	jmp    80105897 <alltraps>
...
80106804:	e8 97 bd ff ff       	call   801025a0 <kalloc>
...
8010681a:	e8 91 de ff ff       	call   801046b0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801068bd:	68 54 7a 10 80       	push   $0x80107a54
801068c2:	e8 b9 9a ff ff       	call   80100380 <panic>
...
80106938:	e8 a3 ba ff ff       	call   801023e0 <kfree>
      *pte = 0;
...
80106973:	68 46 73 10 80       	push   $0x80107346
80106978:	e8 03 9a ff ff       	call   80100380 <panic>
...
80106983:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106986:	e8 d5 ce ff ff       	call   80103860 <cpuid>
  pd[0] = size-1;
...
80106a10:	a1 a4 55 11 80       	mov    0x801155a4,%eax
...
80106a44:	0f 84 c2 00 00 00    	je     80106b0c <switchuvm+0xec>
  pushcli();
80106a4a:	e8 a1 da ff ff       	call   801044f0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106a4f:	e8 9c cd ff ff       	call   801037f0 <mycpu>
80106a54:	89 c3                	mov    %eax,%ebx
80106a56:	e8 95 cd ff ff       	call   801037f0 <mycpu>
80106a5b:	89 c7                	mov    %eax,%edi
80106a5d:	e8 8e cd ff ff       	call   801037f0 <mycpu>
80106a62:	83 c7 08             	add    $0x8,%edi
80106a65:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106a68:	e8 83 cd ff ff       	call   801037f0 <mycpu>
...
80106b4b:	77 4b                	ja     80106b98 <inituvm+0x68>
  mem = kalloc();
80106b4d:	e8 4e ba ff ff       	call   801025a0 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106b5f:	e8 4c db ff ff       	call   801046b0 <memset>
...
80106b78:	e8 c3 fc ff ff       	call   80106840 <mappages>
  memmove(mem, init, sz);
...
80106b92:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106b93:	e9 b8 db ff ff       	jmp    80104750 <memmove>
    panic("inituvm: more than a page");
80106b98:	83 ec 0c             	sub    $0xc,%esp
80106b9b:	68 99 7a 10 80       	push   $0x80107a99
...
80106bc4:	0f 85 8d 00 00 00    	jne    80106c57 <loaduvm+0xa7>
...
80106bdb:	75 11                	jne    80106bee <loaduvm+0x3e>
80106bdd:	eb 61                	jmp    80106c40 <loaduvm+0x90>
80106bdf:	90                   	nop
80106be0:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
80106be6:	89 f0                	mov    %esi,%eax
80106be8:	29 d8                	sub    %ebx,%eax
80106bea:	39 c6                	cmp    %eax,%esi
80106bec:	76 52                	jbe    80106c40 <loaduvm+0x90>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80106bee:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106bf1:	8b 45 08             	mov    0x8(%ebp),%eax
80106bf4:	31 c9                	xor    %ecx,%ecx
80106bf6:	29 da                	sub    %ebx,%edx
80106bf8:	e8 c3 fb ff ff       	call   801067c0 <walkpgdir>
80106bfd:	85 c0                	test   %eax,%eax
80106bff:	74 49                	je     80106c4a <loaduvm+0x9a>
    pa = PTE_ADDR(*pte);
80106c01:	8b 00                	mov    (%eax),%eax
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106c03:	8b 4d e0             	mov    -0x20(%ebp),%ecx
    if(sz - i < PGSIZE)
80106c06:	bf 00 10 00 00       	mov    $0x1000,%edi
    pa = PTE_ADDR(*pte);
80106c0b:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(sz - i < PGSIZE)
80106c10:	81 fb ff 0f 00 00    	cmp    $0xfff,%ebx
80106c16:	0f 46 fb             	cmovbe %ebx,%edi
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106c19:	29 d9                	sub    %ebx,%ecx
80106c1b:	05 00 00 00 80       	add    $0x80000000,%eax
80106c20:	57                   	push   %edi
80106c21:	51                   	push   %ecx
80106c22:	50                   	push   %eax
80106c23:	ff 75 10             	pushl  0x10(%ebp)
80106c26:	e8 d5 ad ff ff       	call   80101a00 <readi>
80106c2b:	83 c4 10             	add    $0x10,%esp
80106c2e:	39 f8                	cmp    %edi,%eax
80106c30:	74 ae                	je     80106be0 <loaduvm+0x30>
}
...
80106c4d:	68 b3 7a 10 80       	push   $0x80107ab3
80106c52:	e8 29 97 ff ff       	call   80100380 <panic>
    panic("loaduvm: addr must be page aligned");
80106c57:	83 ec 0c             	sub    $0xc,%esp
80106c5a:	68 54 7b 10 80       	push   $0x80107b54
80106c5f:	e8 1c 97 ff ff       	call   80100380 <panic>
...
80106cbb:	e8 f0 d9 ff ff       	call   801046b0 <memset>
...
80106ce9:	76 48                	jbe    80106d33 <allocuvm+0xc3>
    mem = kalloc();
80106ceb:	e8 b0 b8 ff ff       	call   801025a0 <kalloc>
...
80106cf9:	68 d1 7a 10 80       	push   $0x80107ad1
...
80106d15:	e8 b6 fb ff ff       	call   801068d0 <deallocuvm.part.0>
      return 0;
...
80106d5b:	68 e9 7a 10 80       	push   $0x80107ae9
...
80106d77:	e8 54 fb ff ff       	call   801068d0 <deallocuvm.part.0>
      kfree(mem);
80106d7c:	83 ec 0c             	sub    $0xc,%esp
80106d7f:	53                   	push   %ebx
80106d80:	e8 5b b6 ff ff       	call   801023e0 <kfree>
      return 0;
...
80106e1e:	e8 bd b5 ff ff       	call   801023e0 <kfree>
...
80106e33:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106e34:	e9 a7 b5 ff ff       	jmp    801023e0 <kfree>
    panic("freevm: no pgdir");
80106e39:	83 ec 0c             	sub    $0xc,%esp
80106e3c:	68 05 7b 10 80       	push   $0x80107b05
...
80106e55:	e8 46 b7 ff ff       	call   801025a0 <kalloc>
...
80106e70:	e8 3b d8 ff ff       	call   801046b0 <memset>
...
80106e81:	ff 73 0c             	pushl  0xc(%ebx)
...
80106edb:	a3 a4 55 11 80       	mov    %eax,0x801155a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106f0f:	68 16 7b 10 80       	push   $0x80107b16
...
80106f33:	0f 84 a0 00 00 00    	je     80106fd9 <copyuvm+0xb9>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106f39:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106f3c:	85 c9                	test   %ecx,%ecx
80106f3e:	0f 84 95 00 00 00    	je     80106fd9 <copyuvm+0xb9>
80106f44:	31 f6                	xor    %esi,%esi
80106f46:	eb 4e                	jmp    80106f96 <copyuvm+0x76>
...
80106f59:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106f5c:	68 00 10 00 00       	push   $0x1000
80106f61:	57                   	push   %edi
80106f62:	50                   	push   %eax
80106f63:	e8 e8 d7 ff ff       	call   80104750 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
80106f68:	58                   	pop    %eax
80106f69:	5a                   	pop    %edx
80106f6a:	53                   	push   %ebx
80106f6b:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106f6e:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106f71:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106f76:	81 c2 00 00 00 80    	add    $0x80000000,%edx
80106f7c:	52                   	push   %edx
80106f7d:	89 f2                	mov    %esi,%edx
80106f7f:	e8 bc f8 ff ff       	call   80106840 <mappages>
80106f84:	83 c4 10             	add    $0x10,%esp
80106f87:	85 c0                	test   %eax,%eax
80106f89:	78 39                	js     80106fc4 <copyuvm+0xa4>
  for(i = 0; i < sz; i += PGSIZE){
80106f8b:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106f91:	39 75 0c             	cmp    %esi,0xc(%ebp)
80106f94:	76 43                	jbe    80106fd9 <copyuvm+0xb9>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106f96:	8b 45 08             	mov    0x8(%ebp),%eax
80106f99:	31 c9                	xor    %ecx,%ecx
80106f9b:	89 f2                	mov    %esi,%edx
80106f9d:	e8 1e f8 ff ff       	call   801067c0 <walkpgdir>
80106fa2:	85 c0                	test   %eax,%eax
80106fa4:	74 3e                	je     80106fe4 <copyuvm+0xc4>
    if(!(*pte & PTE_P))
80106fa6:	8b 18                	mov    (%eax),%ebx
80106fa8:	f6 c3 01             	test   $0x1,%bl
80106fab:	74 44                	je     80106ff1 <copyuvm+0xd1>
    pa = PTE_ADDR(*pte);
80106fad:	89 df                	mov    %ebx,%edi
    flags = PTE_FLAGS(*pte);
80106faf:	81 e3 ff 0f 00 00    	and    $0xfff,%ebx
    pa = PTE_ADDR(*pte);
80106fb5:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80106fbb:	e8 e0 b5 ff ff       	call   801025a0 <kalloc>
80106fc0:	85 c0                	test   %eax,%eax
80106fc2:	75 8c                	jne    80106f50 <copyuvm+0x30>
      goto bad;
  }
  return d;
...
80106fc7:	ff 75 e0             	pushl  -0x20(%ebp)
80106fca:	e8 01 fe ff ff       	call   80106dd0 <freevm>
  return 0;
80106fcf:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
80106fd6:	83 c4 10             	add    $0x10,%esp
}
80106fd9:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
80106fe7:	68 20 7b 10 80       	push   $0x80107b20
80106fec:	e8 8f 93 ff ff       	call   80100380 <panic>
      panic("copyuvm: page not present");
80106ff1:	83 ec 0c             	sub    $0xc,%esp
80106ff4:	68 3a 7b 10 80       	push   $0x80107b3a
80106ff9:	e8 82 93 ff ff       	call   80100380 <panic>
...
8010700e:	e8 ad f7 ff ff       	call   801067c0 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80107049:	8b 75 14             	mov    0x14(%ebp),%esi
...
80107051:	75 38                	jne    8010708b <copyout+0x4b>
80107053:	eb 6b                	jmp    801070c0 <copyout+0x80>
...
8010705b:	89 fb                	mov    %edi,%ebx
8010705d:	29 d3                	sub    %edx,%ebx
8010705f:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if(n > len)
80107065:	39 f3                	cmp    %esi,%ebx
80107067:	0f 47 de             	cmova  %esi,%ebx
      n = len;
    memmove(pa0 + (va - va0), buf, n);
8010706a:	29 fa                	sub    %edi,%edx
8010706c:	83 ec 04             	sub    $0x4,%esp
8010706f:	01 c2                	add    %eax,%edx
80107071:	53                   	push   %ebx
80107072:	ff 75 10             	pushl  0x10(%ebp)
80107075:	52                   	push   %edx
80107076:	e8 d5 d6 ff ff       	call   80104750 <memmove>
    len -= n;
    buf += n;
8010707b:	01 5d 10             	add    %ebx,0x10(%ebp)
    va = va0 + PGSIZE;
8010707e:	8d 97 00 10 00 00    	lea    0x1000(%edi),%edx
  while(len > 0){
80107084:	83 c4 10             	add    $0x10,%esp
80107087:	29 de                	sub    %ebx,%esi
80107089:	74 35                	je     801070c0 <copyout+0x80>
    va0 = (uint)PGROUNDDOWN(va);
8010708b:	89 d7                	mov    %edx,%edi
    pa0 = uva2ka(pgdir, (char*)va0);
8010708d:	83 ec 08             	sub    $0x8,%esp
    va0 = (uint)PGROUNDDOWN(va);
80107090:	89 55 0c             	mov    %edx,0xc(%ebp)
80107093:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    pa0 = uva2ka(pgdir, (char*)va0);
80107099:	57                   	push   %edi
8010709a:	ff 75 08             	pushl  0x8(%ebp)
8010709d:	e8 5e ff ff ff       	call   80107000 <uva2ka>
    if(pa0 == 0)
801070a2:	83 c4 10             	add    $0x10,%esp
801070a5:	85 c0                	test   %eax,%eax
801070a7:	75 af                	jne    80107058 <copyout+0x18>
  }
  return 0;
}
