...
8010029d:	e8 6e 43 00 00       	call   80104610 <acquire>
...
801002fe:	e8 2d 44 00 00       	call   80104730 <release>
        ilock(ip);
80100303:	5a                   	pop    %edx
...
801005b9:	0f b6 92 50 73 10 80 	movzbl -0x7fef8cb0(%edx),%edx
...
8010064b:	e8 c0 3f 00 00       	call   80104610 <acquire>
  for(i = 0; i < n; i++)
...
80100763:	75 55                	jne    801007ba <cprintf+0x11a>
        s = "(null)";
80100765:	bb 38 73 10 80       	mov    $0x80107338,%ebx
      for(; *s; s++)
...
801007a5:	e8 66 3e 00 00       	call   80104610 <acquire>
...
80100828:	68 3f 73 10 80       	push   $0x8010733f
...
80100863:	e8 a8 3d 00 00       	call   80104610 <acquire>
  while((c = getc()) >= 0){
...
80100a26:	68 48 73 10 80       	push   $0x80107348
80100a2b:	68 20 a5 10 80       	push   $0x8010a520
80100a30:	e8 db 3a 00 00       	call   80104510 <initlock>
...
80100af2:	75 d2                	jne    80100ac6 <exec+0x56>
  if((pgdir = setupkvm()) == 0)
80100af4:	e8 57 65 00 00       	call   80107050 <setupkvm>
...
80100b63:	e8 08 63 00 00       	call   80106e70 <allocuvm>
...
80100b99:	e8 12 62 00 00       	call   80106db0 <loaduvm>
...
80100bdb:	e8 f0 63 00 00       	call   80106fd0 <freevm>
  if(ip){
...
80100c22:	e8 49 62 00 00       	call   80106e70 <allocuvm>
...
80100c41:	31 ff                	xor    %edi,%edi
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
80100c43:	e8 a8 64 00 00       	call   801070f0 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100cb7:	e8 84 65 00 00       	call   80107240 <copyout>
...
80100cd1:	e8 fa 62 00 00       	call   80106fd0 <freevm>
...
80100d1d:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100d23:	e8 18 65 00 00       	call   80107240 <copyout>
...
80100d61:	e8 da 3b 00 00       	call   80104940 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100d94:	e8 87 5e 00 00       	call   80106c20 <switchuvm>
  freevm(oldpgdir);
80100d99:	89 3c 24             	mov    %edi,(%esp)
80100d9c:	e8 2f 62 00 00       	call   80106fd0 <freevm>
  return 0;
...
80100db3:	68 61 73 10 80       	push   $0x80107361
...
80100de6:	68 6d 73 10 80       	push   $0x8010736d
80100deb:	68 c0 ff 10 80       	push   $0x8010ffc0
80100df0:	e8 1b 37 00 00       	call   80104510 <initlock>
}
...
80100e41:	e8 ea 38 00 00       	call   80104730 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100e5a:	e8 d1 38 00 00       	call   80104730 <release>
}
...
80100e9c:	e8 8f 38 00 00       	call   80104730 <release>
  return f;
}
...
80100eab:	68 74 73 10 80       	push   $0x80107374
...
80100f09:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100f0c:	e8 1f 38 00 00       	call   80104730 <release>
...
80100f3d:	5d                   	pop    %ebp
    release(&ftable.lock);
80100f3e:	e9 ed 37 00 00       	jmp    80104730 <release>
...
80101072:	68 86 73 10 80       	push   $0x80107386
...
8010114b:	68 8f 73 10 80       	push   $0x8010738f
...
80101181:	68 95 73 10 80       	push   $0x80107395
...
80101234:	68 9f 73 10 80       	push   $0x8010739f
...
80101275:	e8 06 35 00 00       	call   80104780 <memset>
  log_write(bp);
...
80101327:	e8 04 34 00 00       	call   80104730 <release>
...
80101352:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
80101355:	e8 d6 33 00 00       	call   80104730 <release>
      return ip;
...
80101382:	68 b5 73 10 80       	push   $0x801073b5
...
8010144b:	68 c5 73 10 80       	push   $0x801073c5
...
80101481:	e8 9a 33 00 00       	call   80104820 <memmove>
  brelse(bp);
...
80101514:	68 d8 73 10 80       	push   $0x801073d8
...
80101599:	68 58 74 10 80       	push   $0x80107458
...
8010162e:	e8 4d 31 00 00       	call   80104780 <memset>
      dip->type = type;
...
801016d1:	e8 4a 31 00 00       	call   80104820 <memmove>
  log_write(bp);
...
8010170f:	e8 1c 30 00 00       	call   80104730 <release>
}
...
80101742:	e8 f9 2c 00 00       	call   80104440 <acquiresleep>
  if(ip->valid == 0){
...
801017b8:	e8 63 30 00 00       	call   80104820 <memmove>
    brelse(bp);
...
801017dd:	68 10 74 10 80       	push   $0x80107410
801017e2:	e8 99 eb ff ff       	call   80100380 <panic>
    panic("ilock");
801017e7:	83 ec 0c             	sub    $0xc,%esp
801017ea:	68 0a 74 10 80       	push   $0x8010740a
...
80101813:	e8 c8 2c 00 00       	call   801044e0 <holdingsleep>
...
8010182e:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
8010182f:	e9 6c 2c 00 00       	jmp    801044a0 <releasesleep>
    panic("iunlock");
80101834:	83 ec 0c             	sub    $0xc,%esp
80101837:	68 1f 74 10 80       	push   $0x8010741f
...
80101860:	e8 db 2b 00 00       	call   80104440 <acquiresleep>
...
8010187a:	e8 21 2c 00 00       	call   801044a0 <releasesleep>
  acquire(&icache.lock);
...
8010189f:	5d                   	pop    %ebp
  release(&icache.lock);
801018a0:	e9 8b 2e 00 00       	jmp    80104730 <release>
...
801018bf:	e8 6c 2e 00 00       	call   80104730 <release>
    if(r == 1){
...
80101aa7:	e8 74 2d 00 00       	call   80104820 <memmove>
    brelse(bp);
...
80101ba3:	e8 78 2c 00 00       	call   80104820 <memmove>
    log_write(bp);
...
80101c3e:	e8 4d 2c 00 00       	call   80104890 <strncmp>
}
80101c43:	c9                   	leave  
80101c44:	c3                   	ret    
...
80101c9d:	e8 ee 2b 00 00       	call   80104890 <strncmp>
      continue;
...
80101ce2:	68 39 74 10 80       	push   $0x80107439
80101ce7:	e8 94 e6 ff ff       	call   80100380 <panic>
    panic("dirlookup not DIR");
80101cec:	83 ec 0c             	sub    $0xc,%esp
80101cef:	68 27 74 10 80       	push   $0x80107427
...
80101d3c:	e8 ef 29 00 00       	call   80104730 <release>
...
80101da7:	e8 74 2a 00 00       	call   80104820 <memmove>
...
80101e33:	e8 e8 29 00 00       	call   80104820 <memmove>
    name[len] = 0;
...
80101f5d:	e8 7e 29 00 00       	call   801048e0 <strncpy>
...
80101f9b:	68 48 74 10 80       	push   $0x80107448
80101fa0:	e8 db e3 ff ff       	call   80100380 <panic>
    panic("dirlink");
80101fa5:	83 ec 0c             	sub    $0xc,%esp
80101fa8:	68 02 7b 10 80       	push   $0x80107b02
...
801020bb:	68 b4 74 10 80       	push   $0x801074b4
801020c0:	e8 bb e2 ff ff       	call   80100380 <panic>
    panic("idestart");
801020c5:	83 ec 0c             	sub    $0xc,%esp
801020c8:	68 ab 74 10 80       	push   $0x801074ab
...
801020e6:	68 c6 74 10 80       	push   $0x801074c6
801020eb:	68 80 a5 10 80       	push   $0x8010a580
801020f0:	e8 1b 24 00 00       	call   80104510 <initlock>
...
801021eb:	e8 40 25 00 00       	call   80104730 <release>
...
8010220e:	e8 cd 22 00 00       	call   801044e0 <holdingsleep>
...
801022a5:	c9                   	leave  
  release(&idelock);
801022a6:	e9 85 24 00 00       	jmp    80104730 <release>
...
8010233a:	68 14 75 10 80       	push   $0x80107514
...
80102412:	e8 69 23 00 00       	call   80104780 <memset>
...
80102448:	e8 c3 21 00 00       	call   80104610 <acquire>
...
80102462:	c9                   	leave  
    release(&kmem.lock);
80102463:	e9 c8 22 00 00       	jmp    80104730 <release>
    panic("kfree");
80102468:	83 ec 0c             	sub    $0xc,%esp
8010246b:	68 46 75 10 80       	push   $0x80107546
...
801024db:	68 4c 75 10 80       	push   $0x8010754c
801024e0:	68 40 26 11 80       	push   $0x80112640
801024e5:	e8 26 20 00 00       	call   80104510 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801025d3:	e8 38 20 00 00       	call   80104610 <acquire>
  r = kmem.freelist;
...
80102601:	e8 2a 21 00 00       	call   80104730 <release>
  return (char*)r;
...
8010264b:	0f b6 8a 80 76 10 80 	movzbl -0x7fef8980(%edx),%ecx
  shift ^= togglecode[data];
80102652:	0f b6 82 80 75 10 80 	movzbl -0x7fef8a80(%edx),%eax
  shift |= shiftcode[data];
...
80102668:	83 e1 08             	and    $0x8,%ecx
  c = charcode[shift & (CTL | SHIFT)][data];
8010266b:	8b 04 85 60 75 10 80 	mov    -0x7fef8aa0(,%eax,4),%eax
...
801026a8:	31 c0                	xor    %eax,%eax
    shift &= ~(shiftcode[data] | E0ESC);
801026aa:	0f b6 8a 80 76 10 80 	movzbl -0x7fef8980(%edx),%ecx
...
80102a17:	e8 b4 1d 00 00       	call   801047d0 <memcmp>
...
80102b44:	e8 d7 1c 00 00       	call   80104820 <memmove>
...
80102bea:	68 80 77 10 80       	push   $0x80107780
80102bef:	68 80 26 11 80       	push   $0x80112680
80102bf4:	e8 17 19 00 00       	call   80104510 <initlock>
  readsb(dev, &sb);
80102bf9:	58                   	pop    %eax
...
80102c8b:	e8 80 19 00 00       	call   80104610 <acquire>
...
80102cdc:	e8 4f 1a 00 00       	call   80104730 <release>
      break;
    }
  }
}
...
80102cfe:	e8 0d 19 00 00       	call   80104610 <acquire>
  log.outstanding -= 1;
...
80102d3c:	e8 ef 19 00 00       	call   80104730 <release>
}
...
80102d56:	e8 b5 18 00 00       	call   80104610 <acquire>
    wakeup(&log);
...
80102d78:	e8 b3 19 00 00       	call   80104730 <release>
...
80102dd4:	e8 47 1a 00 00       	call   80104820 <memmove>
...
80102e34:	e8 f7 18 00 00       	call   80104730 <release>
...
80102e47:	68 84 77 10 80       	push   $0x80107784
...
80102e96:	e8 75 17 00 00       	call   80104610 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102ed4:	c9                   	leave  
  release(&log.lock);
80102ed5:	e9 56 18 00 00       	jmp    80104730 <release>
...
80102f01:	68 93 77 10 80       	push   $0x80107793
80102f06:	e8 75 d4 ff ff       	call   80100380 <panic>
    panic("log_write outside of trans");
80102f0b:	83 ec 0c             	sub    $0xc,%esp
80102f0e:	68 a9 77 10 80       	push   $0x801077a9
...
80102f38:	68 c4 77 10 80       	push   $0x801077c4
80102f3d:	e8 5e d7 ff ff       	call   801006a0 <cprintf>
  idtinit();       // load idt register
80102f42:	e8 f9 2b 00 00       	call   80105b40 <idtinit>
...
80102f63:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102f66:	e8 a5 3c 00 00       	call   80106c10 <switchkvm>
  seginit();
80102f6b:	e8 10 3c 00 00       	call   80106b80 <seginit>
  lapicinit();
...
80102fc4:	e8 77 2e 00 00       	call   80105e40 <uartinit>
  pinit();         // process table
80102fc9:	e8 02 08 00 00       	call   801037d0 <pinit>
  tvinit();        // trap vectors
80102fce:	e8 ed 2a 00 00       	call   80105ac0 <tvinit>
  binit();         // buffer cache
...
80102ff4:	e8 27 18 00 00       	call   80104820 <memmove>
...
801030de:	68 d8 77 10 80       	push   $0x801077d8
801030e3:	56                   	push   %esi
801030e4:	e8 e7 16 00 00       	call   801047d0 <memcmp>
...
80103196:	68 dd 77 10 80       	push   $0x801077dd
8010319b:	50                   	push   %eax
  conf = (struct mpconf*) P2V((uint) mp->physaddr);
8010319c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
8010319f:	e8 2c 16 00 00       	call   801047d0 <memcmp>
...
801032e3:	68 e2 77 10 80       	push   $0x801077e2
801032e8:	e8 93 d0 ff ff       	call   80100380 <panic>
    panic("Didn't find a suitable machine");
801032ed:	83 ec 0c             	sub    $0xc,%esp
801032f0:	68 fc 77 10 80       	push   $0x801077fc
...
80103390:	00 00 00 
  initlock(&p->lock, "pipe");
80103393:	68 1b 78 10 80       	push   $0x8010781b
80103398:	50                   	push   %eax
80103399:	e8 72 11 00 00       	call   80104510 <initlock>
  (*f0)->type = FD_PIPE;
...
8010342f:	e8 dc 11 00 00       	call   80104610 <acquire>
  if(writable){
...
80103473:	5d                   	pop    %ebp
    release(&p->lock);
80103474:	e9 b7 12 00 00       	jmp    80104730 <release>
...
801034cd:	e8 3e 11 00 00       	call   80104610 <acquire>
  for(i = 0; i < n; i++){
...
8010355c:	e8 cf 11 00 00       	call   80104730 <release>
        return -1;
...
801035b2:	e8 79 11 00 00       	call   80104730 <release>
  return n;
...
801035d6:	e8 35 10 00 00       	call   80104610 <acquire>
...
8010366e:	e8 bd 10 00 00       	call   80104730 <release>
  return i;
...
80103689:	e8 a2 10 00 00       	call   80104730 <release>
      return -1;
...
801036b1:	e8 5a 0f 00 00       	call   80104610 <acquire>
801036b6:	83 c4 10             	add    $0x10,%esp
801036b9:	eb 17                	jmp    801036d2 <allocproc+0x32>
801036bb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801036bf:	90                   	nop
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801036c0:	81 c3 88 00 00 00    	add    $0x88,%ebx
801036c6:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
...
801036fa:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103700:	e8 2b 10 00 00       	call   80104730 <release>
...
80103722:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103725:	c7 40 14 af 5a 10 80 	movl   $0x80105aaf,0x14(%eax)
  p->context = (struct context*)sp;
...
80103734:	e8 47 10 00 00       	call   80104780 <memset>
...
8010375a:	e8 d1 0f 00 00       	call   80104730 <release>
}
...
8010378b:	e8 a0 0f 00 00       	call   80104730 <release>
...
801037d6:	68 20 78 10 80       	push   $0x80107820
801037db:	68 20 2d 11 80       	push   $0x80112d20
801037e0:	e8 2b 0d 00 00       	call   80104510 <initlock>
}
...
80103884:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103887:	e8 34 0d 00 00       	call   801045c0 <pushcli>
  c = mycpu();
8010388c:	e8 5f ff ff ff       	call   801037f0 <mycpu>
  p = c->proc;
80103891:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103897:	e8 34 0e 00 00       	call   801046d0 <popcli>
}
...
801038c3:	e8 88 37 00 00       	call   80107050 <setupkvm>
...
801038e1:	e8 4a 34 00 00       	call   80106d30 <inituvm>
...
801038f6:	e8 85 0e 00 00       	call   80104780 <memset>
...
8010394f:	68 50 78 10 80       	push   $0x80107850
80103954:	50                   	push   %eax
80103955:	e8 e6 0f 00 00       	call   80104940 <safestrcpy>
  p->cwd = namei("/");
8010395a:	c7 04 24 59 78 10 80 	movl   $0x80107859,(%esp)
...
80103993:	68 37 78 10 80       	push   $0x80107837
...
801039a5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
801039a8:	e8 13 0c 00 00       	call   801045c0 <pushcli>
  c = mycpu();
801039ad:	e8 3e fe ff ff       	call   801037f0 <mycpu>
  p = c->proc;
801039b2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039b8:	e8 13 0d 00 00       	call   801046d0 <popcli>
  sz = curproc->sz;
...
801039cb:	e8 50 32 00 00       	call   80106c20 <switchuvm>
  return 0;
...
801039ea:	e8 81 34 00 00       	call   80106e70 <allocuvm>
...
80103a0a:	e8 91 35 00 00       	call   80106fa0 <deallocuvm>
...
80103a26:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103a29:	e8 92 0b 00 00       	call   801045c0 <pushcli>
  c = mycpu();
80103a2e:	e8 bd fd ff ff       	call   801037f0 <mycpu>
  p = c->proc;
80103a33:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103a39:	e8 92 0c 00 00       	call   801046d0 <popcli>
  if((np = allocproc()) == 0){
...
80103a58:	e8 c3 36 00 00       	call   80107120 <copyuvm>
...
80103b7f:	90                   	nop
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b80:	81 c7 88 00 00 00    	add    $0x88,%edi
80103b86:	81 ff 54 4f 11 80    	cmp    $0x80114f54,%edi
80103b8c:	72 26                	jb     80103bb4 <scheduler+0x54>
    release(&ptable.lock);
80103b8e:	83 ec 0c             	sub    $0xc,%esp
80103b91:	68 20 2d 11 80       	push   $0x80112d20
80103b96:	e8 95 0b 00 00       	call   80104730 <release>
  for(;;){
...
80103bac:	e8 5f 0a 00 00       	call   80104610 <acquire>
...
80103bcc:	0f 4f f8             	cmovg  %eax,%edi
      for(p1 = ptable.proc; p1 < &ptable.proc[NPROC]; p1++){
80103bcf:	05 88 00 00 00       	add    $0x88,%eax
80103bd4:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
...
80103be5:	e8 36 30 00 00       	call   80106c20 <switchuvm>
      p->state = RUNNING;
...
80103bf7:	e8 9f 0d 00 00       	call   8010499b <swtch>
      switchkvm();
80103bfc:	e8 0f 30 00 00       	call   80106c10 <switchkvm>
      c->proc = 0;
...
80103c83:	e8 13 0d 00 00       	call   8010499b <swtch>
  mycpu()->intena = intena;
...
80103ce6:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103ce9:	e8 d2 08 00 00       	call   801045c0 <pushcli>
  c = mycpu();
80103cee:	e8 fd fa ff ff       	call   801037f0 <mycpu>
  p = c->proc;
80103cf3:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103cf9:	e8 d2 09 00 00       	call   801046d0 <popcli>
  if(curproc == initproc)
...
80103d52:	e8 b9 08 00 00       	call   80104610 <acquire>
...
80103d6d:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
...
80103d7f:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103d86:	05 88 00 00 00       	add    $0x88,%eax
80103d8b:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
...
80103da6:	81 fa 54 4f 11 80    	cmp    $0x80114f54,%edx
...
80103dcd:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
...
80103df7:	68 a8 78 10 80       	push   $0x801078a8
80103dfc:	e8 7f c5 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103e01:	83 ec 0c             	sub    $0xc,%esp
80103e04:	68 9b 78 10 80       	push   $0x8010789b
...
80103e1c:	e8 ef 07 00 00       	call   80104610 <acquire>
  pushcli();
80103e21:	e8 9a 07 00 00       	call   801045c0 <pushcli>
  c = mycpu();
80103e26:	e8 c5 f9 ff ff       	call   801037f0 <mycpu>
  p = c->proc;
80103e2b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103e31:	e8 9a 08 00 00       	call   801046d0 <popcli>
...
80103e49:	e8 e2 08 00 00       	call   80104730 <release>
}
...
80103e6c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103e6f:	e8 4c 07 00 00       	call   801045c0 <pushcli>
  c = mycpu();
80103e74:	e8 77 f9 ff ff       	call   801037f0 <mycpu>
  p = c->proc;
80103e79:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103e7f:	e8 4c 08 00 00       	call   801046d0 <popcli>
  if(p == 0)
...
80103ea0:	e8 6b 07 00 00       	call   80104610 <acquire>
    release(lk);
80103ea5:	89 34 24             	mov    %esi,(%esp)
80103ea8:	e8 83 08 00 00       	call   80104730 <release>
  p->chan = chan;
...
80103eca:	e8 61 08 00 00       	call   80104730 <release>
    acquire(lk);
...
80103edb:	5d                   	pop    %ebp
    acquire(lk);
80103edc:	e9 2f 07 00 00       	jmp    80104610 <acquire>
...
80103f09:	68 ba 78 10 80       	push   $0x801078ba
80103f0e:	e8 6d c4 ff ff       	call   80100380 <panic>
    panic("sleep");
80103f13:	83 ec 0c             	sub    $0xc,%esp
80103f16:	68 b4 78 10 80       	push   $0x801078b4
...
80103f57:	90                   	nop
80103f58:	81 c3 88 00 00 00    	add    $0x88,%ebx
80103f5e:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
...
80103f6f:	74 37                	je     80103fa8 <wait+0x88>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f71:	81 c3 88 00 00 00    	add    $0x88,%ebx
      havekids = 1;
80103f77:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f7c:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
...
80103fba:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103fc1:	e8 0a 30 00 00       	call   80106fd0 <freevm>
        release(&ptable.lock);
...
8010400b:	e8 20 07 00 00       	call   80104730 <release>
      return -1;
...
8010402f:	e8 dc 05 00 00       	call   80104610 <acquire>
...
80104045:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
...
80104057:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010405e:	05 88 00 00 00       	add    $0x88,%eax
80104063:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
...
80104074:	c9                   	leave  
  release(&ptable.lock);
80104075:	e9 b6 06 00 00       	jmp    80104730 <release>
...
8010408f:	e8 7c 05 00 00       	call   80104610 <acquire>
...
801040a5:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
...
801040cd:	e8 5e 06 00 00       	call   80104730 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801040e8:	e8 43 06 00 00       	call   80104730 <release>
}
...
8010411b:	68 1b 7d 10 80       	push   $0x80107d1b
80104120:	e8 7b c5 ff ff       	call   801006a0 <cprintf>
80104125:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104128:	81 c3 88 00 00 00    	add    $0x88,%ebx
8010412e:	81 fb c0 4f 11 80    	cmp    $0x80114fc0,%ebx
...
8010413f:	74 e7                	je     80104128 <procdump+0x28>
      state = "???";
80104141:	ba cb 78 10 80       	mov    $0x801078cb,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104146:	83 f8 05             	cmp    $0x5,%eax
80104149:	77 11                	ja     8010415c <procdump+0x5c>
8010414b:	8b 14 85 d8 79 10 80 	mov    -0x7fef8628(,%eax,4),%edx
      state = "???";
80104152:	b8 cb 78 10 80       	mov    $0x801078cb,%eax
...
80104161:	68 cf 78 10 80       	push   $0x801078cf
...
80104188:	e8 a3 03 00 00       	call   80104530 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
8010419d:	68 21 73 10 80       	push   $0x80107321
...
801041cd:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
  acquire(&ptable.lock);
801041d2:	e8 39 04 00 00       	call   80104610 <acquire>
  cprintf("name \t pid \t state \t \t priority \n");
801041d7:	c7 04 24 b4 79 10 80 	movl   $0x801079b4,(%esp)
...
801041f8:	74 76                	je     80104270 <cps+0xb0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801041fa:	81 c3 88 00 00 00    	add    $0x88,%ebx
80104200:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
...
80104213:	ff 73 7c             	pushl  0x7c(%ebx)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104216:	81 c3 88 00 00 00    	add    $0x88,%ebx
        cprintf("%s \t %d  \t SLEEPING \t %d\n ", p->name, p->pid, p->priority );
8010421c:	ff 73 88             	pushl  -0x78(%ebx)
8010421f:	50                   	push   %eax
80104220:	68 d8 78 10 80       	push   $0x801078d8
80104225:	e8 76 c4 ff ff       	call   801006a0 <cprintf>
8010422a:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010422d:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
...
8010423d:	e8 ee 04 00 00       	call   80104730 <release>
...
8010425a:	68 f3 78 10 80       	push   $0x801078f3
...
8010427a:	68 0c 79 10 80       	push   $0x8010790c
...
8010429d:	31 db                	xor    %ebx,%ebx
  acquire(&ptable.lock);
8010429f:	e8 6c 03 00 00       	call   80104610 <acquire>
...
801042b3:	0f 94 c2             	sete   %dl
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801042b6:	05 88 00 00 00       	add    $0x88,%eax
	runTotal += 1;
801042bb:	0f b6 d2             	movzbl %dl,%edx
801042be:	01 d3                	add    %edx,%ebx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801042c0:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
...
801042cd:	75 e1                	jne    801042b0 <nps+0x20>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801042cf:	05 88 00 00 00       	add    $0x88,%eax
	sleepTotal += 1;
801042d4:	83 c1 01             	add    $0x1,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801042d7:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
...
8010431f:	e8 ec 02 00 00       	call   80104610 <acquire>
...
8010434f:	e8 dc 03 00 00       	call   80104730 <release>
...
80104370:	e8 9b 02 00 00       	call   80104610 <acquire>
  pushcli();
80104375:	e8 46 02 00 00       	call   801045c0 <pushcli>
  c = mycpu();
8010437a:	e8 71 f4 ff ff       	call   801037f0 <mycpu>
  p = c->proc;
8010437f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104385:	e8 46 03 00 00       	call   801046d0 <popcli>

  myproc()->uid = uid;
8010438a:	89 9e 80 00 00 00    	mov    %ebx,0x80(%esi)

  release(&ptable.lock);	
80104390:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104397:	e8 94 03 00 00       	call   80104730 <release>

	return uid;
}
8010439c:	8d 65 f8             	lea    -0x8(%ebp),%esp
8010439f:	89 d8                	mov    %ebx,%eax
801043a1:	5b                   	pop    %ebx
801043a2:	5e                   	pop    %esi
801043a3:	5d                   	pop    %ebp
801043a4:	c3                   	ret    
801043a5:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
801043bb:	68 20 2d 11 80       	push   $0x80112d20
801043c0:	e8 4b 02 00 00       	call   80104610 <acquire>
  pushcli();
801043c5:	e8 f6 01 00 00       	call   801045c0 <pushcli>
  c = mycpu();
801043ca:	e8 21 f4 ff ff       	call   801037f0 <mycpu>
  p = c->proc;
801043cf:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
801043d5:	e8 f6 02 00 00       	call   801046d0 <popcli>

  myproc()->gid = gid;
801043da:	89 9e 84 00 00 00    	mov    %ebx,0x84(%esi)

  release(&ptable.lock);	
801043e0:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801043e7:	e8 44 03 00 00       	call   80104730 <release>

	return gid;
}
801043ec:	8d 65 f8             	lea    -0x8(%ebp),%esp
801043ef:	89 d8                	mov    %ebx,%eax
801043f1:	5b                   	pop    %ebx
801043f2:	5e                   	pop    %esi
801043f3:	5d                   	pop    %ebp
801043f4:	c3                   	ret    
...
8010440a:	68 f0 79 10 80       	push   $0x801079f0
8010440f:	8d 43 04             	lea    0x4(%ebx),%eax
80104412:	50                   	push   %eax
80104413:	e8 f8 00 00 00       	call   80104510 <initlock>
  lk->name = name;
...
80104465:	e8 f6 f9 ff ff       	call   80103e60 <sleep>
  while (lk->locked) {
...
80104473:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104479:	e8 02 f4 ff ff       	call   80103880 <myproc>
...
801044af:	e8 5c 01 00 00       	call   80104610 <acquire>
  lk->locked = 0;
...
801044c4:	e8 57 fb ff ff       	call   80104020 <wakeup>
  release(&lk->lk);
...
801044e5:	8b 75 08             	mov    0x8(%ebp),%esi
  ...
  acquire(&lk->lk);
801044e8:	8d 5e 04             	lea    0x4(%esi),%ebx
801044eb:	83 ec 0c             	sub    $0xc,%esp
801044ee:	53                   	push   %ebx
801044ef:	e8 1c 01 00 00       	call   80104610 <acquire>
  r = lk->locked;
801044f4:	8b 36                	mov    (%esi),%esi
  release(&lk->lk);
801044f6:	89 1c 24             	mov    %ebx,(%esp)
801044f9:	e8 32 02 00 00       	call   80104730 <release>
  return r;
}
801044fe:	8d 65 f8             	lea    -0x8(%ebp),%esp
...
801045a3:	e8 48 f2 ff ff       	call   801037f0 <mycpu>
...
801045ef:	90                   	nop
    mycpu()->intena = eflags & FL_IF;
801045f0:	e8 fb f1 ff ff       	call   801037f0 <mycpu>
...
80104615:	e8 a6 ff ff ff       	call   801045c0 <pushcli>
  if(holding(lk))
8010461a:	8b 5d 08             	mov    0x8(%ebp),%ebx
  return lock->locked && lock->cpu == mycpu();
8010461d:	8b 03                	mov    (%ebx),%eax
8010461f:	85 c0                	test   %eax,%eax
80104621:	0f 85 81 00 00 00    	jne    801046a8 <acquire+0x98>
  asm volatile("lock; xchgl %0, %1" :
80104627:	ba 01 00 00 00       	mov    $0x1,%edx
8010462c:	eb 05                	jmp    80104633 <acquire+0x23>
...
80104644:	e8 a7 f1 ff ff       	call   801037f0 <mycpu>
  ebp = (uint*)v - 2;
80104649:	89 ea                	mov    %ebp,%edx
  lk->cpu = mycpu();
8010464b:	89 43 08             	mov    %eax,0x8(%ebx)
  for(i = 0; i < 10; i++){
8010464e:	31 c0                	xor    %eax,%eax
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104650:	8d 8a 00 00 00 80    	lea    -0x80000000(%edx),%ecx
80104656:	81 f9 fe ff ff 7f    	cmp    $0x7ffffffe,%ecx
8010465c:	77 22                	ja     80104680 <acquire+0x70>
    pcs[i] = ebp[1];     // saved %eip
8010465e:	8b 4a 04             	mov    0x4(%edx),%ecx
80104661:	89 4c 83 0c          	mov    %ecx,0xc(%ebx,%eax,4)
  for(i = 0; i < 10; i++){
...
8010466d:	75 e1                	jne    80104650 <acquire+0x40>
}
...
8010467d:	8d 76 00             	lea    0x0(%esi),%esi
  for(; i < 10; i++)
80104680:	8d 44 83 0c          	lea    0xc(%ebx,%eax,4),%eax
...
801046b2:	0f 85 6f ff ff ff    	jne    80104627 <acquire+0x17>
    panic("acquire");
801046b8:	83 ec 0c             	sub    $0xc,%esp
801046bb:	68 fb 79 10 80       	push   $0x801079fb
...
801046fc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104700:	e8 eb f0 ff ff       	call   801037f0 <mycpu>
...
80104715:	68 03 7a 10 80       	push   $0x80107a03
8010471a:	e8 61 bc ff ff       	call   80100380 <panic>
    panic("popcli");
8010471f:	83 ec 0c             	sub    $0xc,%esp
80104722:	68 1a 7a 10 80       	push   $0x80107a1a
...
8010484a:	83 f8 ff             	cmp    $0xffffffff,%eax
...
8010485f:	74 ee                	je     8010484f <memmove+0x2f>
...
801049f7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
801049fa:	e8 81 ee ff ff       	call   80103880 <myproc>
...
80104a45:	e8 36 ee ff ff       	call   80103880 <myproc>
...
80104a53:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104a56:	e8 25 ee ff ff       	call   80103880 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104a98:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104a9b:	e8 e0 ed ff ff       	call   80103880 <myproc>
...
80104b12:	e8 d9 fe ff ff       	call   801049f0 <fetchstr>
...
80104b34:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104b37:	e8 44 ed ff ff       	call   80103880 <myproc>
...
80104b47:	83 fa 1d             	cmp    $0x1d,%edx
80104b4a:	77 24                	ja     80104b70 <syscall+0x40>
80104b4c:	8b 14 85 60 7a 10 80 	mov    -0x7fef85a0(,%eax,4),%edx
...
80104b75:	ff 73 10             	pushl  0x10(%ebx)
80104b78:	68 29 7a 10 80       	push   $0x80107a29
...
80104bb7:	89 4d bc             	mov    %ecx,-0x44(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104bba:	e8 21 d4 ff ff       	call   80101fe0 <nameiparent>
...
80104bd0:	e8 4b cb ff ff       	call   80101720 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
80104bd5:	83 c4 0c             	add    $0xc,%esp
80104bd8:	8d 45 d4             	lea    -0x2c(%ebp),%eax
80104bdb:	50                   	push   %eax
80104bdc:	57                   	push   %edi
80104bdd:	53                   	push   %ebx
80104bde:	e8 6d d0 ff ff       	call   80101c50 <dirlookup>
...
80104bf0:	e8 bb cd ff ff       	call   801019b0 <iunlockput>
    ilock(ip);
80104bf5:	89 34 24             	mov    %esi,(%esp)
80104bf8:	e8 23 cb ff ff       	call   80101720 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80104bfd:	83 c4 10             	add    $0x10,%esp
80104c00:	66 83 7d c4 02       	cmpw   $0x2,-0x3c(%ebp)
80104c05:	75 19                	jne    80104c20 <create+0x80>
80104c07:	66 83 7e 50 02       	cmpw   $0x2,0x50(%esi)
80104c0c:	75 12                	jne    80104c20 <create+0x80>
...
80104c24:	31 f6                	xor    %esi,%esi
    iunlockput(ip);
80104c26:	e8 85 cd ff ff       	call   801019b0 <iunlockput>
    return 0;
...
80104c4a:	e8 61 c9 ff ff       	call   801015b0 <ialloc>
...
80104c60:	e8 bb ca ff ff       	call   80101720 <ilock>
  ip->major = major;
...
80104c81:	e8 ea c9 ff ff       	call   80101670 <iupdate>
...
80104c93:	ff 76 04             	pushl  0x4(%esi)
80104c96:	57                   	push   %edi
80104c97:	53                   	push   %ebx
80104c98:	e8 63 d2 ff ff       	call   80101f00 <dirlink>
...
80104ca8:	e8 03 cd ff ff       	call   801019b0 <iunlockput>
  return ip;
...
80104cc9:	e8 a2 c9 ff ff       	call   80101670 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104cce:	83 c4 0c             	add    $0xc,%esp
80104cd1:	ff 76 04             	pushl  0x4(%esi)
80104cd4:	68 f8 7a 10 80       	push   $0x80107af8
80104cd9:	56                   	push   %esi
80104cda:	e8 21 d2 ff ff       	call   80101f00 <dirlink>
...
80104cec:	68 f7 7a 10 80       	push   $0x80107af7
80104cf1:	56                   	push   %esi
80104cf2:	e8 09 d2 ff ff       	call   80101f00 <dirlink>
...
80104d01:	68 eb 7a 10 80       	push   $0x80107aeb
...
80104d1f:	68 fa 7a 10 80       	push   $0x80107afa
80104d24:	e8 57 b6 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104d29:	83 ec 0c             	sub    $0xc,%esp
80104d2c:	68 dc 7a 10 80       	push   $0x80107adc
...
80104d64:	e8 17 eb ff ff       	call   80103880 <myproc>
...
80104da4:	78 1a                	js     80104dc0 <sys_dup+0x30>
  if((fd=fdalloc(f)) < 0)
80104da6:	8b 75 f4             	mov    -0xc(%ebp),%esi
  for(fd = 0; fd < NOFILE; fd++){
80104da9:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104dab:	e8 d0 ea ff ff       	call   80103880 <myproc>
...
80104e3d:	e8 ae c1 ff ff       	call   80100ff0 <fileread>
...
80104e77:	8d 45 f0             	lea    -0x10(%ebp),%eax
...
80104ead:	e8 ce c1 ff ff       	call   80101080 <filewrite>
...
80104ee3:	78 2b                	js     80104f10 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104ee5:	e8 96 e9 ff ff       	call   80103880 <myproc>
...
80104efb:	e8 c0 bf ff ff       	call   80100ec0 <fileclose>
  return 0;
...
80104f2b:	e8 10 fe ff ff       	call   80104d40 <argfd.constprop.0>
...
80104f54:	e8 47 c0 ff ff       	call   80100fa0 <filestat>
...
80104fa2:	0f 88 e2 00 00 00    	js     8010508a <sys_link+0x11a>
  begin_op();
80104fa8:	e8 d3 dc ff ff       	call   80102c80 <begin_op>
  if((ip = namei(old)) == 0){
80104fad:	83 ec 0c             	sub    $0xc,%esp
80104fb0:	ff 75 d4             	pushl  -0x2c(%ebp)
80104fb3:	e8 08 d0 ff ff       	call   80101fc0 <namei>
...
80104fc9:	e8 52 c7 ff ff       	call   80101720 <ilock>
  if(ip->type == T_DIR){
...
80104fe8:	e8 83 c6 ff ff       	call   80101670 <iupdate>
  iunlock(ip);
80104fed:	89 1c 24             	mov    %ebx,(%esp)
80104ff0:	e8 0b c8 ff ff       	call   80101800 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104ff5:	58                   	pop    %eax
80104ff6:	5a                   	pop    %edx
80104ff7:	57                   	push   %edi
80104ff8:	ff 75 d0             	pushl  -0x30(%ebp)
80104ffb:	e8 e0 cf ff ff       	call   80101fe0 <nameiparent>
...
8010500d:	e8 0e c7 ff ff       	call   80101720 <ilock>
...
80105023:	e8 d8 ce ff ff       	call   80101f00 <dirlink>
...
80105033:	e8 78 c9 ff ff       	call   801019b0 <iunlockput>
  iput(ip);
80105038:	89 1c 24             	mov    %ebx,(%esp)
8010503b:	e8 10 c8 ff ff       	call   80101850 <iput>
  end_op();
80105040:	e8 ab dc ff ff       	call   80102cf0 <end_op>
  return 0;
...
8010505c:	e8 4f c9 ff ff       	call   801019b0 <iunlockput>
    goto bad;
80105061:	83 c4 10             	add    $0x10,%esp
  ilock(ip);
80105064:	83 ec 0c             	sub    $0xc,%esp
80105067:	53                   	push   %ebx
80105068:	e8 b3 c6 ff ff       	call   80101720 <ilock>
  ip->nlink--;
8010506d:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80105072:	89 1c 24             	mov    %ebx,(%esp)
80105075:	e8 f6 c5 ff ff       	call   80101670 <iupdate>
  iunlockput(ip);
8010507a:	89 1c 24             	mov    %ebx,(%esp)
8010507d:	e8 2e c9 ff ff       	call   801019b0 <iunlockput>
  end_op();
80105082:	e8 69 dc ff ff       	call   80102cf0 <end_op>
  return -1;
...
80105095:	e8 16 c9 ff ff       	call   801019b0 <iunlockput>
    end_op();
8010509a:	e8 51 dc ff ff       	call   80102cf0 <end_op>
    return -1;
8010509f:	83 c4 10             	add    $0x10,%esp
801050a2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801050a7:	eb a1                	jmp    8010504a <sys_link+0xda>
    end_op();
801050a9:	e8 42 dc ff ff       	call   80102cf0 <end_op>
    return -1;
...
801050d9:	0f 88 91 01 00 00    	js     80105270 <sys_unlink+0x1b0>
  begin_op();
801050df:	e8 9c db ff ff       	call   80102c80 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
801050e4:	8d 5d ca             	lea    -0x36(%ebp),%ebx
801050e7:	83 ec 08             	sub    $0x8,%esp
801050ea:	53                   	push   %ebx
801050eb:	ff 75 c0             	pushl  -0x40(%ebp)
801050ee:	e8 ed ce ff ff       	call   80101fe0 <nameiparent>
801050f3:	83 c4 10             	add    $0x10,%esp
801050f6:	89 c6                	mov    %eax,%esi
801050f8:	85 c0                	test   %eax,%eax
801050fa:	0f 84 7a 01 00 00    	je     8010527a <sys_unlink+0x1ba>
  ilock(dp);
80105100:	83 ec 0c             	sub    $0xc,%esp
80105103:	50                   	push   %eax
80105104:	e8 17 c6 ff ff       	call   80101720 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105109:	58                   	pop    %eax
8010510a:	5a                   	pop    %edx
8010510b:	68 f8 7a 10 80       	push   $0x80107af8
80105110:	53                   	push   %ebx
80105111:	e8 1a cb ff ff       	call   80101c30 <namecmp>
80105116:	83 c4 10             	add    $0x10,%esp
80105119:	85 c0                	test   %eax,%eax
8010511b:	0f 84 0f 01 00 00    	je     80105230 <sys_unlink+0x170>
80105121:	83 ec 08             	sub    $0x8,%esp
80105124:	68 f7 7a 10 80       	push   $0x80107af7
80105129:	53                   	push   %ebx
8010512a:	e8 01 cb ff ff       	call   80101c30 <namecmp>
8010512f:	83 c4 10             	add    $0x10,%esp
80105132:	85 c0                	test   %eax,%eax
80105134:	0f 84 f6 00 00 00    	je     80105230 <sys_unlink+0x170>
  if((ip = dirlookup(dp, name, &off)) == 0)
8010513a:	83 ec 04             	sub    $0x4,%esp
8010513d:	8d 45 c4             	lea    -0x3c(%ebp),%eax
80105140:	50                   	push   %eax
80105141:	53                   	push   %ebx
80105142:	56                   	push   %esi
80105143:	e8 08 cb ff ff       	call   80101c50 <dirlookup>
80105148:	83 c4 10             	add    $0x10,%esp
8010514b:	89 c3                	mov    %eax,%ebx
8010514d:	85 c0                	test   %eax,%eax
8010514f:	0f 84 db 00 00 00    	je     80105230 <sys_unlink+0x170>
  ilock(ip);
80105155:	83 ec 0c             	sub    $0xc,%esp
80105158:	50                   	push   %eax
80105159:	e8 c2 c5 ff ff       	call   80101720 <ilock>
  if(ip->nlink < 1)
8010515e:	83 c4 10             	add    $0x10,%esp
80105161:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
80105166:	0f 8e 37 01 00 00    	jle    801052a3 <sys_unlink+0x1e3>
  if(ip->type == T_DIR && !isdirempty(ip)){
8010516c:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105171:	8d 7d d8             	lea    -0x28(%ebp),%edi
80105174:	74 6a                	je     801051e0 <sys_unlink+0x120>
  memset(&de, 0, sizeof(de));
80105176:	83 ec 04             	sub    $0x4,%esp
80105179:	6a 10                	push   $0x10
8010517b:	6a 00                	push   $0x0
8010517d:	57                   	push   %edi
8010517e:	e8 fd f5 ff ff       	call   80104780 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105183:	6a 10                	push   $0x10
80105185:	ff 75 c4             	pushl  -0x3c(%ebp)
80105188:	57                   	push   %edi
80105189:	56                   	push   %esi
8010518a:	e8 71 c9 ff ff       	call   80101b00 <writei>
8010518f:	83 c4 20             	add    $0x20,%esp
80105192:	83 f8 10             	cmp    $0x10,%eax
80105195:	0f 85 fb 00 00 00    	jne    80105296 <sys_unlink+0x1d6>
  if(ip->type == T_DIR){
8010519b:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801051a0:	0f 84 aa 00 00 00    	je     80105250 <sys_unlink+0x190>
  iunlockput(dp);
801051a6:	83 ec 0c             	sub    $0xc,%esp
801051a9:	56                   	push   %esi
801051aa:	e8 01 c8 ff ff       	call   801019b0 <iunlockput>
  ip->nlink--;
801051af:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
801051b4:	89 1c 24             	mov    %ebx,(%esp)
801051b7:	e8 b4 c4 ff ff       	call   80101670 <iupdate>
  iunlockput(ip);
801051bc:	89 1c 24             	mov    %ebx,(%esp)
801051bf:	e8 ec c7 ff ff       	call   801019b0 <iunlockput>
  end_op();
801051c4:	e8 27 db ff ff       	call   80102cf0 <end_op>
  return 0;
...
801051e4:	76 90                	jbe    80105176 <sys_unlink+0xb6>
801051e6:	ba 20 00 00 00       	mov    $0x20,%edx
801051eb:	eb 0f                	jmp    801051fc <sys_unlink+0x13c>
801051ed:	8d 76 00             	lea    0x0(%esi),%esi
801051f0:	83 c2 10             	add    $0x10,%edx
801051f3:	39 53 58             	cmp    %edx,0x58(%ebx)
801051f6:	0f 86 7a ff ff ff    	jbe    80105176 <sys_unlink+0xb6>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801051fc:	6a 10                	push   $0x10
801051fe:	52                   	push   %edx
801051ff:	57                   	push   %edi
80105200:	53                   	push   %ebx
80105201:	89 55 b4             	mov    %edx,-0x4c(%ebp)
80105204:	e8 f7 c7 ff ff       	call   80101a00 <readi>
80105209:	83 c4 10             	add    $0x10,%esp
8010520c:	8b 55 b4             	mov    -0x4c(%ebp),%edx
8010520f:	83 f8 10             	cmp    $0x10,%eax
80105212:	75 75                	jne    80105289 <sys_unlink+0x1c9>
    if(de.inum != 0)
80105214:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
80105219:	74 d5                	je     801051f0 <sys_unlink+0x130>
    iunlockput(ip);
...
80105234:	e8 77 c7 ff ff       	call   801019b0 <iunlockput>
  end_op();
80105239:	e8 b2 da ff ff       	call   80102cf0 <end_op>
  return -1;
8010523e:	83 c4 10             	add    $0x10,%esp
80105241:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105246:	eb 86                	jmp    801051ce <sys_unlink+0x10e>
80105248:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010524f:	90                   	nop
    iupdate(dp);
80105250:	83 ec 0c             	sub    $0xc,%esp
    dp->nlink--;
80105253:	66 83 6e 56 01       	subw   $0x1,0x56(%esi)
    iupdate(dp);
80105258:	56                   	push   %esi
80105259:	e8 12 c4 ff ff       	call   80101670 <iupdate>
8010525e:	83 c4 10             	add    $0x10,%esp
80105261:	e9 40 ff ff ff       	jmp    801051a6 <sys_unlink+0xe6>
...
80105275:	e9 54 ff ff ff       	jmp    801051ce <sys_unlink+0x10e>
    end_op();
8010527a:	e8 71 da ff ff       	call   80102cf0 <end_op>
    return -1;
8010527f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105284:	e9 45 ff ff ff       	jmp    801051ce <sys_unlink+0x10e>
      panic("isdirempty: readi");
80105289:	83 ec 0c             	sub    $0xc,%esp
8010528c:	68 1c 7b 10 80       	push   $0x80107b1c
80105291:	e8 ea b0 ff ff       	call   80100380 <panic>
    panic("unlink: writei");
80105296:	83 ec 0c             	sub    $0xc,%esp
80105299:	68 2e 7b 10 80       	push   $0x80107b2e
8010529e:	e8 dd b0 ff ff       	call   80100380 <panic>
    panic("unlink: nlink < 1");
801052a3:	83 ec 0c             	sub    $0xc,%esp
801052a6:	68 0a 7b 10 80       	push   $0x80107b0a
801052ab:	e8 d0 b0 ff ff       	call   80100380 <panic>
...
801052bf:	e8 2c f8 ff ff       	call   80104af0 <argstr>
...
801052d8:	e8 63 f7 ff ff       	call   80104a40 <argint>
...
801052e2:	78 79                	js     8010535d <sys_open+0xad>
  ...
  begin_op();
801052e4:	e8 97 d9 ff ff       	call   80102c80 <begin_op>
...
801052f2:	ff 75 e0             	pushl  -0x20(%ebp)
801052f5:	e8 c6 cc ff ff       	call   80101fc0 <namei>
...
8010530b:	e8 10 c4 ff ff       	call   80101720 <ilock>
...
80105344:	e8 77 bb ff ff       	call   80100ec0 <fileclose>
80105349:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
8010534c:	83 ec 0c             	sub    $0xc,%esp
8010534f:	56                   	push   %esi
80105350:	e8 5b c6 ff ff       	call   801019b0 <iunlockput>
    end_op();
80105355:	e8 96 d9 ff ff       	call   80102cf0 <end_op>
    return -1;
...
80105377:	e8 24 f8 ff ff       	call   80104ba0 <create>
    if(ip == 0){
...
80105383:	75 99                	jne    8010531e <sys_open+0x6e>
      end_op();
80105385:	e8 66 d9 ff ff       	call   80102cf0 <end_op>
      return -1;
...
801053a0:	e8 5b c4 ff ff       	call   80101800 <iunlock>
  end_op();
801053a5:	e8 46 d9 ff ff       	call   80102cf0 <end_op>
...
8010541f:	e8 7c f7 ff ff       	call   80104ba0 <create>
...
8010542f:	e8 7c c5 ff ff       	call   801019b0 <iunlockput>
  end_op();
80105434:	e8 b7 d8 ff ff       	call   80102cf0 <end_op>
  return 0;
...
8010543f:	c3                   	ret    
    end_op();
80105440:	e8 ab d8 ff ff       	call   80102cf0 <end_op>
    return -1;
...
80105479:	e8 c2 f5 ff ff       	call   80104a40 <argint>
  if((argstr(0, &path)) < 0 ||
...
8010548e:	e8 ad f5 ff ff       	call   80104a40 <argint>
     argint(1, &major) < 0 ||
...
801054ae:	e8 ed f6 ff ff       	call   80104ba0 <create>
     argint(2, &minor) < 0 ||
...
801054be:	e8 ed c4 ff ff       	call   801019b0 <iunlockput>
  end_op();
801054c3:	e8 28 d8 ff ff       	call   80102cf0 <end_op>
  return 0;
...
801054cf:	90                   	nop
    end_op();
801054d0:	e8 1b d8 ff ff       	call   80102cf0 <end_op>
    return -1;
...
8010550f:	e8 ac ca ff ff       	call   80101fc0 <namei>
...
80105521:	e8 fa c1 ff ff       	call   80101720 <ilock>
  if(ip->type != T_DIR){
...
80105534:	e8 c7 c2 ff ff       	call   80101800 <iunlock>
  iput(curproc->cwd);
80105539:	58                   	pop    %eax
8010553a:	ff 76 68             	pushl  0x68(%esi)
8010553d:	e8 0e c3 ff ff       	call   80101850 <iput>
  end_op();
80105542:	e8 a9 d7 ff ff       	call   80102cf0 <end_op>
  curproc->cwd = ip;
...
80105564:	e8 47 c4 ff ff       	call   801019b0 <iunlockput>
    end_op();
80105569:	e8 82 d7 ff ff       	call   80102cf0 <end_op>
    return -1;
...
8010557f:	90                   	nop
    end_op();
80105580:	e8 6b d7 ff ff       	call   80102cf0 <end_op>
    return -1;
...
801055a5:	e8 46 f5 ff ff       	call   80104af0 <argstr>
...
801055c1:	e8 7a f4 ff ff       	call   80104a40 <argint>
...
801055dd:	8d bd 64 ff ff ff    	lea    -0x9c(%ebp),%edi
801055e3:	6a 00                	push   $0x0
801055e5:	50                   	push   %eax
801055e6:	e8 95 f1 ff ff       	call   80104780 <memset>
...
80105628:	e8 c3 f3 ff ff       	call   801049f0 <fetchstr>
...
80105653:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
      argv[i] = 0;
...
8010566b:	e8 00 b4 ff ff       	call   80100a70 <exec>
...
80105691:	e8 fa f3 ff ff       	call   80104a90 <argptr>
...
801056a8:	e8 73 dc ff ff       	call   80103320 <pipealloc>
...
801056b7:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801056b9:	e8 c2 e1 ff ff       	call   80103880 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801056d6:	e8 e5 b7 ff ff       	call   80100ec0 <fileclose>
    fileclose(wf);
801056db:	58                   	pop    %eax
801056dc:	ff 75 e4             	pushl  -0x1c(%ebp)
801056df:	e8 dc b7 ff ff       	call   80100ec0 <fileclose>
    return -1;
...
801056f7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
801056fa:	e8 81 e1 ff ff       	call   80103880 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
{
  return fork();
80105750:	e9 cb e2 ff ff       	jmp    80103a20 <fork>
...
80105763:	83 ec 08             	sub    $0x8,%esp
  exit();
80105766:	e8 75 e5 ff ff       	call   80103ce0 <exit>
...
{
  return wait();
80105770:	e9 ab e7 ff ff       	jmp    80103f20 <wait>
...
8010578c:	e8 af f2 ff ff       	call   80104a40 <argint>
...
8010579e:	e8 dd e8 ff ff       	call   80104080 <kill>
...
801057c3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801057c6:	e8 b5 e0 ff ff       	call   80103880 <myproc>
...
801057f6:	e8 a5 e1 ff ff       	call   801039a0 <growproc>
...
80105840:	68 60 4f 11 80       	push   $0x80114f60
80105845:	e8 c6 ed ff ff       	call   80104610 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010584a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010584d:	8b 1d a0 57 11 80    	mov    0x801157a0,%ebx
  while(ticks - ticks0 < n){
...
80105863:	68 60 4f 11 80       	push   $0x80114f60
80105868:	68 a0 57 11 80       	push   $0x801157a0
8010586d:	e8 ee e5 ff ff       	call   80103e60 <sleep>
  while(ticks - ticks0 < n){
80105872:	a1 a0 57 11 80       	mov    0x801157a0,%eax
...
8010587f:	73 2f                	jae    801058b0 <sys_sleep+0x90>
    if(myproc()->killed){
80105881:	e8 fa df ff ff       	call   80103880 <myproc>
...
80105895:	e8 96 ee ff ff       	call   80104730 <release>
  }
  release(&tickslock);
  return 0;
}
...
801058b8:	e8 73 ee ff ff       	call   80104730 <release>
  return 0;
...
801058d4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801058d7:	68 60 4f 11 80       	push   $0x80114f60
801058dc:	e8 2f ed ff ff       	call   80104610 <acquire>
  xticks = ticks;
801058e1:	8b 1d a0 57 11 80    	mov    0x801157a0,%ebx
  release(&tickslock);
801058e7:	c7 04 24 60 4f 11 80 	movl   $0x80114f60,(%esp)
801058ee:	e8 3d ee ff ff       	call   80104730 <release>
  return xticks;
}
...
{
  return cps();
80105900:	e9 bb e8 ff ff       	jmp    801041c0 <cps>
...
{
  return nps();
80105910:	e9 7b e9 ff ff       	jmp    80104290 <nps>
...
8010592c:	e8 0f f1 ff ff       	call   80104a40 <argint>
...
80105941:	e8 fa f0 ff ff       	call   80104a40 <argint>
...
80105956:	e8 b5 e9 ff ff       	call   80104310 <chpr>
...
8010597b:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
}
80105981:	c9                   	leave  
80105982:	c3                   	ret    
...
80105993:	83 ec 08             	sub    $0x8,%esp
	return myproc()->gid;
80105996:	e8 e5 de ff ff       	call   80103880 <myproc>
8010599b:	8b 80 84 00 00 00    	mov    0x84(%eax),%eax
}
801059a1:	c9                   	leave  
801059a2:	c3                   	ret    
...
801059b3:	83 ec 08             	sub    $0x8,%esp
	if (myproc()->parent != 0)
801059b6:	e8 c5 de ff ff       	call   80103880 <myproc>
801059bb:	8b 40 14             	mov    0x14(%eax),%eax
801059be:	85 c0                	test   %eax,%eax
801059c0:	74 0e                	je     801059d0 <sys_getppid+0x20>
		return myproc()->parent->pid;
801059c2:	e8 b9 de ff ff       	call   80103880 <myproc>
801059c7:	8b 40 14             	mov    0x14(%eax),%eax
801059ca:	8b 40 10             	mov    0x10(%eax),%eax
	else return 0;
}
801059cd:	c9                   	leave  
801059ce:	c3                   	ret    
...
801059ec:	e8 4f f0 ff ff       	call   80104a40 <argint>
801059f1:	83 c4 10             	add    $0x10,%esp
801059f4:	85 c0                	test   %eax,%eax
801059f6:	78 18                	js     80105a10 <sys_setuid+0x30>
		return -1;

	setuid((uint)uid);
801059f8:	83 ec 0c             	sub    $0xc,%esp
801059fb:	ff 75 f4             	pushl  -0xc(%ebp)
801059fe:	e8 5d e9 ff ff       	call   80104360 <setuid>
	return 0;
...
80105a2c:	e8 0f f0 ff ff       	call   80104a40 <argint>
80105a31:	83 c4 10             	add    $0x10,%esp
80105a34:	85 c0                	test   %eax,%eax
80105a36:	78 18                	js     80105a50 <sys_setgid+0x30>
		return -1;

	setgid((uint)gid);
80105a38:	83 ec 0c             	sub    $0xc,%esp
80105a3b:	ff 75 f4             	pushl  -0xc(%ebp)
80105a3e:	e8 6d e9 ff ff       	call   801043b0 <setgid>
	return 0;
80105a43:	83 c4 10             	add    $0x10,%esp
80105a46:	31 c0                	xor    %eax,%eax
}
80105a48:	c9                   	leave  
80105a49:	c3                   	ret    
...
80105a6e:	e8 1d f0 ff ff       	call   80104a90 <argptr>
...
80105a80:	e8 6b ce ff ff       	call   801028f0 <cmostime>
  return 0;
...
80105a97:	1e                   	push   %ds
80105a98:	06                   	push   %es
80105a99:	0f a0                	push   %fs
80105a9b:	0f a8                	push   %gs
80105a9d:	60                   	pusha  
80105a9e:	66 b8 10 00          	mov    $0x10,%ax
80105aa2:	8e d8                	mov    %eax,%ds
80105aa4:	8e c0                	mov    %eax,%es
80105aa6:	54                   	push   %esp
80105aa7:	e8 c4 00 00 00       	call   80105b70 <trap>
80105aac:	83 c4 04             	add    $0x4,%esp

80105aaf <trapret>:
80105aaf:	61                   	popa   
80105ab0:	0f a9                	pop    %gs
80105ab2:	0f a1                	pop    %fs
80105ab4:	07                   	pop    %es
80105ab5:	1f                   	pop    %ds
80105ab6:	83 c4 08             	add    $0x8,%esp
80105ab9:	cf                   	iret   
...
80105ad7:	c7 04 c5 a2 4f 11 80 	movl   $0x8e000008,-0x7feeb05e(,%eax,8)
80105ade:	08 00 00 8e 
80105ae2:	66 89 14 c5 a0 4f 11 	mov    %dx,-0x7feeb060(,%eax,8)
80105ae9:	80 
80105aea:	c1 ea 10             	shr    $0x10,%edx
80105aed:	66 89 14 c5 a6 4f 11 	mov    %dx,-0x7feeb05a(,%eax,8)
80105af4:	80 
  for(i = 0; i < 256; i++)
...
80105b07:	c7 05 a2 51 11 80 08 	movl   $0xef000008,0x801151a2
80105b0e:	00 00 ef 
  initlock(&tickslock, "time");
80105b11:	68 3d 7b 10 80       	push   $0x80107b3d
80105b16:	68 60 4f 11 80       	push   $0x80114f60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105b1b:	66 a3 a0 51 11 80    	mov    %ax,0x801151a0
80105b21:	c1 e8 10             	shr    $0x10,%eax
80105b24:	66 a3 a6 51 11 80    	mov    %ax,0x801151a6
  initlock(&tickslock, "time");
80105b2a:	e8 e1 e9 ff ff       	call   80104510 <initlock>
}
...
80105b4b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105b4f:	b8 a0 4f 11 80       	mov    $0x80114fa0,%eax
...
80105b82:	0f 84 c0 01 00 00    	je     80105d48 <trap+0x1d8>
    if(myproc()->killed)
      exit();
    return;
  }
...
80105b8e:	77 07                	ja     80105b97 <trap+0x27>
80105b90:	ff 24 85 e4 7b 10 80 	jmp    *-0x7fef841c(,%eax,4)
    lapiceoi();
    break;
...
80105b97:	e8 e4 dc ff ff       	call   80103880 <myproc>
80105b9c:	8b 7b 38             	mov    0x38(%ebx),%edi
80105b9f:	85 c0                	test   %eax,%eax
80105ba1:	0f 84 f0 01 00 00    	je     80105d97 <trap+0x227>
80105ba7:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105bab:	0f 84 e6 01 00 00    	je     80105d97 <trap+0x227>
...
80105bb1:	0f 20 d1             	mov    %cr2,%ecx
80105bb4:	89 4d d8             	mov    %ecx,-0x28(%ebp)
...
80105bb7:	e8 a4 dc ff ff       	call   80103860 <cpuid>
80105bbc:	8b 73 30             	mov    0x30(%ebx),%esi
80105bbf:	89 45 dc             	mov    %eax,-0x24(%ebp)
80105bc2:	8b 43 34             	mov    0x34(%ebx),%eax
80105bc5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80105bc8:	e8 b3 dc ff ff       	call   80103880 <myproc>
80105bcd:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105bd0:	e8 ab dc ff ff       	call   80103880 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105bd5:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80105bd8:	8b 55 dc             	mov    -0x24(%ebp),%edx
80105bdb:	51                   	push   %ecx
80105bdc:	57                   	push   %edi
80105bdd:	52                   	push   %edx
80105bde:	ff 75 e4             	pushl  -0x1c(%ebp)
80105be1:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
80105be2:	8b 75 e0             	mov    -0x20(%ebp),%esi
80105be5:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105be8:	56                   	push   %esi
80105be9:	ff 70 10             	pushl  0x10(%eax)
80105bec:	68 a0 7b 10 80       	push   $0x80107ba0
80105bf1:	e8 aa aa ff ff       	call   801006a0 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105bf6:	83 c4 20             	add    $0x20,%esp
80105bf9:	e8 82 dc ff ff       	call   80103880 <myproc>
80105bfe:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  }
...
80105c05:	e8 76 dc ff ff       	call   80103880 <myproc>
80105c0a:	85 c0                	test   %eax,%eax
80105c0c:	74 1d                	je     80105c2b <trap+0xbb>
80105c0e:	e8 6d dc ff ff       	call   80103880 <myproc>
80105c13:	8b 50 24             	mov    0x24(%eax),%edx
80105c16:	85 d2                	test   %edx,%edx
80105c18:	74 11                	je     80105c2b <trap+0xbb>
80105c1a:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105c1e:	83 e0 03             	and    $0x3,%eax
80105c21:	66 83 f8 03          	cmp    $0x3,%ax
80105c25:	0f 84 55 01 00 00    	je     80105d80 <trap+0x210>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80105c2b:	e8 50 dc ff ff       	call   80103880 <myproc>
80105c30:	85 c0                	test   %eax,%eax
80105c32:	74 0f                	je     80105c43 <trap+0xd3>
80105c34:	e8 47 dc ff ff       	call   80103880 <myproc>
80105c39:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105c3d:	0f 84 ed 00 00 00    	je     80105d30 <trap+0x1c0>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c43:	e8 38 dc ff ff       	call   80103880 <myproc>
80105c48:	85 c0                	test   %eax,%eax
80105c4a:	74 1d                	je     80105c69 <trap+0xf9>
80105c4c:	e8 2f dc ff ff       	call   80103880 <myproc>
80105c51:	8b 40 24             	mov    0x24(%eax),%eax
80105c54:	85 c0                	test   %eax,%eax
80105c56:	74 11                	je     80105c69 <trap+0xf9>
80105c58:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105c5c:	83 e0 03             	and    $0x3,%eax
80105c5f:	66 83 f8 03          	cmp    $0x3,%ax
80105c63:	0f 84 08 01 00 00    	je     80105d71 <trap+0x201>
    exit();
}
...
80105c70:	c3                   	ret    
    ideintr();
80105c71:	e8 ea c4 ff ff       	call   80102160 <ideintr>
    lapiceoi();
80105c76:	e8 b5 cb ff ff       	call   80102830 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c7b:	e8 00 dc ff ff       	call   80103880 <myproc>
80105c80:	85 c0                	test   %eax,%eax
80105c82:	75 8a                	jne    80105c0e <trap+0x9e>
80105c84:	eb a5                	jmp    80105c2b <trap+0xbb>
    if(cpuid() == 0){
80105c86:	e8 d5 db ff ff       	call   80103860 <cpuid>
80105c8b:	85 c0                	test   %eax,%eax
80105c8d:	75 e7                	jne    80105c76 <trap+0x106>
      acquire(&tickslock);
80105c8f:	83 ec 0c             	sub    $0xc,%esp
80105c92:	68 60 4f 11 80       	push   $0x80114f60
80105c97:	e8 74 e9 ff ff       	call   80104610 <acquire>
      wakeup(&ticks);
80105c9c:	c7 04 24 a0 57 11 80 	movl   $0x801157a0,(%esp)
      ticks++;
80105ca3:	83 05 a0 57 11 80 01 	addl   $0x1,0x801157a0
      wakeup(&ticks);
80105caa:	e8 71 e3 ff ff       	call   80104020 <wakeup>
      release(&tickslock);
80105caf:	c7 04 24 60 4f 11 80 	movl   $0x80114f60,(%esp)
80105cb6:	e8 75 ea ff ff       	call   80104730 <release>
80105cbb:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105cbe:	eb b6                	jmp    80105c76 <trap+0x106>
    kbdintr();
80105cc0:	e8 2b ca ff ff       	call   801026f0 <kbdintr>
    lapiceoi();
80105cc5:	e8 66 cb ff ff       	call   80102830 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105cca:	e8 b1 db ff ff       	call   80103880 <myproc>
80105ccf:	85 c0                	test   %eax,%eax
80105cd1:	0f 85 37 ff ff ff    	jne    80105c0e <trap+0x9e>
80105cd7:	e9 4f ff ff ff       	jmp    80105c2b <trap+0xbb>
    uartintr();
80105cdc:	e8 4f 02 00 00       	call   80105f30 <uartintr>
    lapiceoi();
80105ce1:	e8 4a cb ff ff       	call   80102830 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105ce6:	e8 95 db ff ff       	call   80103880 <myproc>
80105ceb:	85 c0                	test   %eax,%eax
80105ced:	0f 85 1b ff ff ff    	jne    80105c0e <trap+0x9e>
80105cf3:	e9 33 ff ff ff       	jmp    80105c2b <trap+0xbb>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105cf8:	8b 7b 38             	mov    0x38(%ebx),%edi
80105cfb:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105cff:	e8 5c db ff ff       	call   80103860 <cpuid>
80105d04:	57                   	push   %edi
80105d05:	56                   	push   %esi
80105d06:	50                   	push   %eax
80105d07:	68 48 7b 10 80       	push   $0x80107b48
80105d0c:	e8 8f a9 ff ff       	call   801006a0 <cprintf>
    lapiceoi();
80105d11:	e8 1a cb ff ff       	call   80102830 <lapiceoi>
    break;
80105d16:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d19:	e8 62 db ff ff       	call   80103880 <myproc>
80105d1e:	85 c0                	test   %eax,%eax
80105d20:	0f 85 e8 fe ff ff    	jne    80105c0e <trap+0x9e>
80105d26:	e9 00 ff ff ff       	jmp    80105c2b <trap+0xbb>
80105d2b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105d2f:	90                   	nop
  if(myproc() && myproc()->state == RUNNING &&
80105d30:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105d34:	0f 85 09 ff ff ff    	jne    80105c43 <trap+0xd3>
    yield();
80105d3a:	e8 d1 e0 ff ff       	call   80103e10 <yield>
80105d3f:	e9 ff fe ff ff       	jmp    80105c43 <trap+0xd3>
80105d44:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80105d48:	e8 33 db ff ff       	call   80103880 <myproc>
80105d4d:	8b 70 24             	mov    0x24(%eax),%esi
80105d50:	85 f6                	test   %esi,%esi
80105d52:	75 3c                	jne    80105d90 <trap+0x220>
    myproc()->tf = tf;
80105d54:	e8 27 db ff ff       	call   80103880 <myproc>
80105d59:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105d5c:	e8 cf ed ff ff       	call   80104b30 <syscall>
    if(myproc()->killed)
80105d61:	e8 1a db ff ff       	call   80103880 <myproc>
80105d66:	8b 48 24             	mov    0x24(%eax),%ecx
80105d69:	85 c9                	test   %ecx,%ecx
80105d6b:	0f 84 f8 fe ff ff    	je     80105c69 <trap+0xf9>
}
...
80105d77:	5d                   	pop    %ebp
      exit();
80105d78:	e9 63 df ff ff       	jmp    80103ce0 <exit>
80105d7d:	8d 76 00             	lea    0x0(%esi),%esi
    exit();
80105d80:	e8 5b df ff ff       	call   80103ce0 <exit>
80105d85:	e9 a1 fe ff ff       	jmp    80105c2b <trap+0xbb>
80105d8a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105d90:	e8 4b df ff ff       	call   80103ce0 <exit>
80105d95:	eb bd                	jmp    80105d54 <trap+0x1e4>
80105d97:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105d9a:	e8 c1 da ff ff       	call   80103860 <cpuid>
...
80105da8:	68 6c 7b 10 80       	push   $0x80107b6c
80105dad:	e8 ee a8 ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105db2:	83 c4 14             	add    $0x14,%esp
80105db5:	68 42 7b 10 80       	push   $0x80107b42
80105dba:	e8 c1 a5 ff ff       	call   80100380 <panic>
80105dbf:	90                   	nop
...
80105e15:	e8 36 ca ff ff       	call   80102850 <microdelay>
...
80105e97:	74 56                	je     80105eef <uartinit+0xaf>
  uart = 1;
...
80105eaf:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80105eb4:	bb 64 7c 10 80       	mov    $0x80107c64,%ebx
  ioapicenable(IRQ_COM1, 0);
80105eb9:	6a 00                	push   $0x0
80105ebb:	6a 04                	push   $0x4
80105ebd:	e8 de c4 ff ff       	call   801023a0 <ioapicenable>
80105ec2:	83 c4 10             	add    $0x10,%esp
  for(p="xv6...\n"; *p; p++)
80105ec5:	b8 78 00 00 00       	mov    $0x78,%eax
80105eca:	eb 08                	jmp    80105ed4 <uartinit+0x94>
80105ecc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105ed0:	0f b6 73 01          	movzbl 0x1(%ebx),%esi
  if(!uart)
80105ed4:	8b 15 bc a5 10 80    	mov    0x8010a5bc,%edx
...
80105f00:	55                   	push   %ebp
  if(!uart)
80105f01:	8b 15 bc a5 10 80    	mov    0x8010a5bc,%edx
{
...
80105f3b:	e8 10 a9 ff ff       	call   80100850 <consoleintr>
}
...
80105f47:	6a 00                	push   $0x0
  jmp alltraps
80105f49:	e9 49 fb ff ff       	jmp    80105a97 <alltraps>
...
80105f50:	6a 01                	push   $0x1
  jmp alltraps
80105f52:	e9 40 fb ff ff       	jmp    80105a97 <alltraps>
...
80105f59:	6a 02                	push   $0x2
  jmp alltraps
80105f5b:	e9 37 fb ff ff       	jmp    80105a97 <alltraps>
...
80105f62:	6a 03                	push   $0x3
  jmp alltraps
80105f64:	e9 2e fb ff ff       	jmp    80105a97 <alltraps>
...
80105f6b:	6a 04                	push   $0x4
  jmp alltraps
80105f6d:	e9 25 fb ff ff       	jmp    80105a97 <alltraps>
...
80105f74:	6a 05                	push   $0x5
  jmp alltraps
80105f76:	e9 1c fb ff ff       	jmp    80105a97 <alltraps>
...
80105f7d:	6a 06                	push   $0x6
  jmp alltraps
80105f7f:	e9 13 fb ff ff       	jmp    80105a97 <alltraps>
...
80105f86:	6a 07                	push   $0x7
  jmp alltraps
80105f88:	e9 0a fb ff ff       	jmp    80105a97 <alltraps>
...
80105f8d:	6a 08                	push   $0x8
  jmp alltraps
80105f8f:	e9 03 fb ff ff       	jmp    80105a97 <alltraps>
...
80105f96:	6a 09                	push   $0x9
  jmp alltraps
80105f98:	e9 fa fa ff ff       	jmp    80105a97 <alltraps>
...
80105f9d:	6a 0a                	push   $0xa
  jmp alltraps
80105f9f:	e9 f3 fa ff ff       	jmp    80105a97 <alltraps>
...
80105fa4:	6a 0b                	push   $0xb
  jmp alltraps
80105fa6:	e9 ec fa ff ff       	jmp    80105a97 <alltraps>
...
80105fab:	6a 0c                	push   $0xc
  jmp alltraps
80105fad:	e9 e5 fa ff ff       	jmp    80105a97 <alltraps>
...
80105fb2:	6a 0d                	push   $0xd
  jmp alltraps
80105fb4:	e9 de fa ff ff       	jmp    80105a97 <alltraps>
...
80105fb9:	6a 0e                	push   $0xe
  jmp alltraps
80105fbb:	e9 d7 fa ff ff       	jmp    80105a97 <alltraps>
...
80105fc2:	6a 0f                	push   $0xf
  jmp alltraps
80105fc4:	e9 ce fa ff ff       	jmp    80105a97 <alltraps>
...
80105fcb:	6a 10                	push   $0x10
  jmp alltraps
80105fcd:	e9 c5 fa ff ff       	jmp    80105a97 <alltraps>
...
80105fd2:	6a 11                	push   $0x11
  jmp alltraps
80105fd4:	e9 be fa ff ff       	jmp    80105a97 <alltraps>
...
80105fdb:	6a 12                	push   $0x12
  jmp alltraps
80105fdd:	e9 b5 fa ff ff       	jmp    80105a97 <alltraps>
...
80105fe4:	6a 13                	push   $0x13
  jmp alltraps
80105fe6:	e9 ac fa ff ff       	jmp    80105a97 <alltraps>
...
80105fed:	6a 14                	push   $0x14
  jmp alltraps
80105fef:	e9 a3 fa ff ff       	jmp    80105a97 <alltraps>
...
80105ff6:	6a 15                	push   $0x15
  jmp alltraps
80105ff8:	e9 9a fa ff ff       	jmp    80105a97 <alltraps>
...
80105fff:	6a 16                	push   $0x16
  jmp alltraps
80106001:	e9 91 fa ff ff       	jmp    80105a97 <alltraps>
...
80106008:	6a 17                	push   $0x17
  jmp alltraps
8010600a:	e9 88 fa ff ff       	jmp    80105a97 <alltraps>
...
80106011:	6a 18                	push   $0x18
  jmp alltraps
80106013:	e9 7f fa ff ff       	jmp    80105a97 <alltraps>
...
8010601a:	6a 19                	push   $0x19
  jmp alltraps
8010601c:	e9 76 fa ff ff       	jmp    80105a97 <alltraps>
...
80106023:	6a 1a                	push   $0x1a
  jmp alltraps
80106025:	e9 6d fa ff ff       	jmp    80105a97 <alltraps>
...
8010602c:	6a 1b                	push   $0x1b
  jmp alltraps
8010602e:	e9 64 fa ff ff       	jmp    80105a97 <alltraps>
...
80106035:	6a 1c                	push   $0x1c
  jmp alltraps
80106037:	e9 5b fa ff ff       	jmp    80105a97 <alltraps>
...
8010603e:	6a 1d                	push   $0x1d
  jmp alltraps
80106040:	e9 52 fa ff ff       	jmp    80105a97 <alltraps>
...
80106047:	6a 1e                	push   $0x1e
  jmp alltraps
80106049:	e9 49 fa ff ff       	jmp    80105a97 <alltraps>
...
80106050:	6a 1f                	push   $0x1f
  jmp alltraps
80106052:	e9 40 fa ff ff       	jmp    80105a97 <alltraps>
...
80106059:	6a 20                	push   $0x20
  jmp alltraps
8010605b:	e9 37 fa ff ff       	jmp    80105a97 <alltraps>
...
80106062:	6a 21                	push   $0x21
  jmp alltraps
80106064:	e9 2e fa ff ff       	jmp    80105a97 <alltraps>
...
8010606b:	6a 22                	push   $0x22
  jmp alltraps
8010606d:	e9 25 fa ff ff       	jmp    80105a97 <alltraps>
...
80106074:	6a 23                	push   $0x23
  jmp alltraps
80106076:	e9 1c fa ff ff       	jmp    80105a97 <alltraps>
...
8010607d:	6a 24                	push   $0x24
  jmp alltraps
8010607f:	e9 13 fa ff ff       	jmp    80105a97 <alltraps>
...
80106086:	6a 25                	push   $0x25
  jmp alltraps
80106088:	e9 0a fa ff ff       	jmp    80105a97 <alltraps>
...
8010608f:	6a 26                	push   $0x26
  jmp alltraps
80106091:	e9 01 fa ff ff       	jmp    80105a97 <alltraps>
...
80106098:	6a 27                	push   $0x27
  jmp alltraps
8010609a:	e9 f8 f9 ff ff       	jmp    80105a97 <alltraps>
...
801060a1:	6a 28                	push   $0x28
  jmp alltraps
801060a3:	e9 ef f9 ff ff       	jmp    80105a97 <alltraps>
...
801060aa:	6a 29                	push   $0x29
  jmp alltraps
801060ac:	e9 e6 f9 ff ff       	jmp    80105a97 <alltraps>
...
801060b3:	6a 2a                	push   $0x2a
  jmp alltraps
801060b5:	e9 dd f9 ff ff       	jmp    80105a97 <alltraps>
...
801060bc:	6a 2b                	push   $0x2b
  jmp alltraps
801060be:	e9 d4 f9 ff ff       	jmp    80105a97 <alltraps>
...
801060c5:	6a 2c                	push   $0x2c
  jmp alltraps
801060c7:	e9 cb f9 ff ff       	jmp    80105a97 <alltraps>
...
801060ce:	6a 2d                	push   $0x2d
  jmp alltraps
801060d0:	e9 c2 f9 ff ff       	jmp    80105a97 <alltraps>
...
801060d7:	6a 2e                	push   $0x2e
  jmp alltraps
801060d9:	e9 b9 f9 ff ff       	jmp    80105a97 <alltraps>
...
801060e0:	6a 2f                	push   $0x2f
  jmp alltraps
801060e2:	e9 b0 f9 ff ff       	jmp    80105a97 <alltraps>
...
801060e9:	6a 30                	push   $0x30
  jmp alltraps
801060eb:	e9 a7 f9 ff ff       	jmp    80105a97 <alltraps>
...
801060f2:	6a 31                	push   $0x31
  jmp alltraps
801060f4:	e9 9e f9 ff ff       	jmp    80105a97 <alltraps>
...
801060fb:	6a 32                	push   $0x32
  jmp alltraps
801060fd:	e9 95 f9 ff ff       	jmp    80105a97 <alltraps>
...
80106104:	6a 33                	push   $0x33
  jmp alltraps
80106106:	e9 8c f9 ff ff       	jmp    80105a97 <alltraps>
...
8010610d:	6a 34                	push   $0x34
  jmp alltraps
8010610f:	e9 83 f9 ff ff       	jmp    80105a97 <alltraps>
...
80106116:	6a 35                	push   $0x35
  jmp alltraps
80106118:	e9 7a f9 ff ff       	jmp    80105a97 <alltraps>
...
8010611f:	6a 36                	push   $0x36
  jmp alltraps
80106121:	e9 71 f9 ff ff       	jmp    80105a97 <alltraps>
...
80106128:	6a 37                	push   $0x37
  jmp alltraps
8010612a:	e9 68 f9 ff ff       	jmp    80105a97 <alltraps>
...
80106131:	6a 38                	push   $0x38
  jmp alltraps
80106133:	e9 5f f9 ff ff       	jmp    80105a97 <alltraps>
...
8010613a:	6a 39                	push   $0x39
  jmp alltraps
8010613c:	e9 56 f9 ff ff       	jmp    80105a97 <alltraps>
...
80106143:	6a 3a                	push   $0x3a
  jmp alltraps
80106145:	e9 4d f9 ff ff       	jmp    80105a97 <alltraps>
...
8010614c:	6a 3b                	push   $0x3b
  jmp alltraps
8010614e:	e9 44 f9 ff ff       	jmp    80105a97 <alltraps>
...
80106155:	6a 3c                	push   $0x3c
  jmp alltraps
80106157:	e9 3b f9 ff ff       	jmp    80105a97 <alltraps>
...
8010615e:	6a 3d                	push   $0x3d
  jmp alltraps
80106160:	e9 32 f9 ff ff       	jmp    80105a97 <alltraps>
...
80106167:	6a 3e                	push   $0x3e
  jmp alltraps
80106169:	e9 29 f9 ff ff       	jmp    80105a97 <alltraps>
...
80106170:	6a 3f                	push   $0x3f
  jmp alltraps
80106172:	e9 20 f9 ff ff       	jmp    80105a97 <alltraps>
...
80106179:	6a 40                	push   $0x40
  jmp alltraps
8010617b:	e9 17 f9 ff ff       	jmp    80105a97 <alltraps>
...
80106182:	6a 41                	push   $0x41
  jmp alltraps
80106184:	e9 0e f9 ff ff       	jmp    80105a97 <alltraps>
...
8010618b:	6a 42                	push   $0x42
  jmp alltraps
8010618d:	e9 05 f9 ff ff       	jmp    80105a97 <alltraps>
...
80106194:	6a 43                	push   $0x43
  jmp alltraps
80106196:	e9 fc f8 ff ff       	jmp    80105a97 <alltraps>
...
8010619d:	6a 44                	push   $0x44
  jmp alltraps
8010619f:	e9 f3 f8 ff ff       	jmp    80105a97 <alltraps>
...
801061a6:	6a 45                	push   $0x45
  jmp alltraps
801061a8:	e9 ea f8 ff ff       	jmp    80105a97 <alltraps>
...
801061af:	6a 46                	push   $0x46
  jmp alltraps
801061b1:	e9 e1 f8 ff ff       	jmp    80105a97 <alltraps>
...
801061b8:	6a 47                	push   $0x47
  jmp alltraps
801061ba:	e9 d8 f8 ff ff       	jmp    80105a97 <alltraps>
...
801061c1:	6a 48                	push   $0x48
  jmp alltraps
801061c3:	e9 cf f8 ff ff       	jmp    80105a97 <alltraps>
...
801061ca:	6a 49                	push   $0x49
  jmp alltraps
801061cc:	e9 c6 f8 ff ff       	jmp    80105a97 <alltraps>
...
801061d3:	6a 4a                	push   $0x4a
  jmp alltraps
801061d5:	e9 bd f8 ff ff       	jmp    80105a97 <alltraps>
...
801061dc:	6a 4b                	push   $0x4b
  jmp alltraps
801061de:	e9 b4 f8 ff ff       	jmp    80105a97 <alltraps>
...
801061e5:	6a 4c                	push   $0x4c
  jmp alltraps
801061e7:	e9 ab f8 ff ff       	jmp    80105a97 <alltraps>
...
801061ee:	6a 4d                	push   $0x4d
  jmp alltraps
801061f0:	e9 a2 f8 ff ff       	jmp    80105a97 <alltraps>
...
801061f7:	6a 4e                	push   $0x4e
  jmp alltraps
801061f9:	e9 99 f8 ff ff       	jmp    80105a97 <alltraps>
...
80106200:	6a 4f                	push   $0x4f
  jmp alltraps
80106202:	e9 90 f8 ff ff       	jmp    80105a97 <alltraps>
...
80106209:	6a 50                	push   $0x50
  jmp alltraps
8010620b:	e9 87 f8 ff ff       	jmp    80105a97 <alltraps>
...
80106212:	6a 51                	push   $0x51
  jmp alltraps
80106214:	e9 7e f8 ff ff       	jmp    80105a97 <alltraps>
...
8010621b:	6a 52                	push   $0x52
  jmp alltraps
8010621d:	e9 75 f8 ff ff       	jmp    80105a97 <alltraps>
...
80106224:	6a 53                	push   $0x53
  jmp alltraps
80106226:	e9 6c f8 ff ff       	jmp    80105a97 <alltraps>
...
8010622d:	6a 54                	push   $0x54
  jmp alltraps
8010622f:	e9 63 f8 ff ff       	jmp    80105a97 <alltraps>
...
80106236:	6a 55                	push   $0x55
  jmp alltraps
80106238:	e9 5a f8 ff ff       	jmp    80105a97 <alltraps>
...
8010623f:	6a 56                	push   $0x56
  jmp alltraps
80106241:	e9 51 f8 ff ff       	jmp    80105a97 <alltraps>
...
80106248:	6a 57                	push   $0x57
  jmp alltraps
8010624a:	e9 48 f8 ff ff       	jmp    80105a97 <alltraps>
...
80106251:	6a 58                	push   $0x58
  jmp alltraps
80106253:	e9 3f f8 ff ff       	jmp    80105a97 <alltraps>
...
8010625a:	6a 59                	push   $0x59
  jmp alltraps
8010625c:	e9 36 f8 ff ff       	jmp    80105a97 <alltraps>
...
80106263:	6a 5a                	push   $0x5a
  jmp alltraps
80106265:	e9 2d f8 ff ff       	jmp    80105a97 <alltraps>
...
8010626c:	6a 5b                	push   $0x5b
  jmp alltraps
8010626e:	e9 24 f8 ff ff       	jmp    80105a97 <alltraps>
...
80106275:	6a 5c                	push   $0x5c
  jmp alltraps
80106277:	e9 1b f8 ff ff       	jmp    80105a97 <alltraps>
...
8010627e:	6a 5d                	push   $0x5d
  jmp alltraps
80106280:	e9 12 f8 ff ff       	jmp    80105a97 <alltraps>
...
80106287:	6a 5e                	push   $0x5e
  jmp alltraps
80106289:	e9 09 f8 ff ff       	jmp    80105a97 <alltraps>
...
80106290:	6a 5f                	push   $0x5f
  jmp alltraps
80106292:	e9 00 f8 ff ff       	jmp    80105a97 <alltraps>
...
80106299:	6a 60                	push   $0x60
  jmp alltraps
8010629b:	e9 f7 f7 ff ff       	jmp    80105a97 <alltraps>
...
801062a2:	6a 61                	push   $0x61
  jmp alltraps
801062a4:	e9 ee f7 ff ff       	jmp    80105a97 <alltraps>
...
801062ab:	6a 62                	push   $0x62
  jmp alltraps
801062ad:	e9 e5 f7 ff ff       	jmp    80105a97 <alltraps>
...
801062b4:	6a 63                	push   $0x63
  jmp alltraps
801062b6:	e9 dc f7 ff ff       	jmp    80105a97 <alltraps>
...
801062bd:	6a 64                	push   $0x64
  jmp alltraps
801062bf:	e9 d3 f7 ff ff       	jmp    80105a97 <alltraps>
...
801062c6:	6a 65                	push   $0x65
  jmp alltraps
801062c8:	e9 ca f7 ff ff       	jmp    80105a97 <alltraps>
...
801062cf:	6a 66                	push   $0x66
  jmp alltraps
801062d1:	e9 c1 f7 ff ff       	jmp    80105a97 <alltraps>
...
801062d8:	6a 67                	push   $0x67
  jmp alltraps
801062da:	e9 b8 f7 ff ff       	jmp    80105a97 <alltraps>
...
801062e1:	6a 68                	push   $0x68
  jmp alltraps
801062e3:	e9 af f7 ff ff       	jmp    80105a97 <alltraps>
...
801062ea:	6a 69                	push   $0x69
  jmp alltraps
801062ec:	e9 a6 f7 ff ff       	jmp    80105a97 <alltraps>
...
801062f3:	6a 6a                	push   $0x6a
  jmp alltraps
801062f5:	e9 9d f7 ff ff       	jmp    80105a97 <alltraps>
...
801062fc:	6a 6b                	push   $0x6b
  jmp alltraps
801062fe:	e9 94 f7 ff ff       	jmp    80105a97 <alltraps>
...
80106305:	6a 6c                	push   $0x6c
  jmp alltraps
80106307:	e9 8b f7 ff ff       	jmp    80105a97 <alltraps>
...
8010630e:	6a 6d                	push   $0x6d
  jmp alltraps
80106310:	e9 82 f7 ff ff       	jmp    80105a97 <alltraps>
...
80106317:	6a 6e                	push   $0x6e
  jmp alltraps
80106319:	e9 79 f7 ff ff       	jmp    80105a97 <alltraps>
...
80106320:	6a 6f                	push   $0x6f
  jmp alltraps
80106322:	e9 70 f7 ff ff       	jmp    80105a97 <alltraps>
...
80106329:	6a 70                	push   $0x70
  jmp alltraps
8010632b:	e9 67 f7 ff ff       	jmp    80105a97 <alltraps>
...
80106332:	6a 71                	push   $0x71
  jmp alltraps
80106334:	e9 5e f7 ff ff       	jmp    80105a97 <alltraps>
...
8010633b:	6a 72                	push   $0x72
  jmp alltraps
8010633d:	e9 55 f7 ff ff       	jmp    80105a97 <alltraps>
...
80106344:	6a 73                	push   $0x73
  jmp alltraps
80106346:	e9 4c f7 ff ff       	jmp    80105a97 <alltraps>
...
8010634d:	6a 74                	push   $0x74
  jmp alltraps
8010634f:	e9 43 f7 ff ff       	jmp    80105a97 <alltraps>
...
80106356:	6a 75                	push   $0x75
  jmp alltraps
80106358:	e9 3a f7 ff ff       	jmp    80105a97 <alltraps>
...
8010635f:	6a 76                	push   $0x76
  jmp alltraps
80106361:	e9 31 f7 ff ff       	jmp    80105a97 <alltraps>
...
80106368:	6a 77                	push   $0x77
  jmp alltraps
8010636a:	e9 28 f7 ff ff       	jmp    80105a97 <alltraps>
...
80106371:	6a 78                	push   $0x78
  jmp alltraps
80106373:	e9 1f f7 ff ff       	jmp    80105a97 <alltraps>
...
8010637a:	6a 79                	push   $0x79
  jmp alltraps
8010637c:	e9 16 f7 ff ff       	jmp    80105a97 <alltraps>
...
80106383:	6a 7a                	push   $0x7a
  jmp alltraps
80106385:	e9 0d f7 ff ff       	jmp    80105a97 <alltraps>
...
8010638c:	6a 7b                	push   $0x7b
  jmp alltraps
8010638e:	e9 04 f7 ff ff       	jmp    80105a97 <alltraps>
...
80106395:	6a 7c                	push   $0x7c
  jmp alltraps
80106397:	e9 fb f6 ff ff       	jmp    80105a97 <alltraps>
...
8010639e:	6a 7d                	push   $0x7d
  jmp alltraps
801063a0:	e9 f2 f6 ff ff       	jmp    80105a97 <alltraps>
...
801063a7:	6a 7e                	push   $0x7e
  jmp alltraps
801063a9:	e9 e9 f6 ff ff       	jmp    80105a97 <alltraps>
...
801063b0:	6a 7f                	push   $0x7f
  jmp alltraps
801063b2:	e9 e0 f6 ff ff       	jmp    80105a97 <alltraps>
...
801063b9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801063be:	e9 d4 f6 ff ff       	jmp    80105a97 <alltraps>
...
801063c5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801063ca:	e9 c8 f6 ff ff       	jmp    80105a97 <alltraps>
...
801063d1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801063d6:	e9 bc f6 ff ff       	jmp    80105a97 <alltraps>
...
801063dd:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801063e2:	e9 b0 f6 ff ff       	jmp    80105a97 <alltraps>
...
801063e9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801063ee:	e9 a4 f6 ff ff       	jmp    80105a97 <alltraps>
...
801063f5:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801063fa:	e9 98 f6 ff ff       	jmp    80105a97 <alltraps>
...
80106401:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106406:	e9 8c f6 ff ff       	jmp    80105a97 <alltraps>
...
8010640d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106412:	e9 80 f6 ff ff       	jmp    80105a97 <alltraps>
...
80106419:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010641e:	e9 74 f6 ff ff       	jmp    80105a97 <alltraps>
...
80106425:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010642a:	e9 68 f6 ff ff       	jmp    80105a97 <alltraps>
...
80106431:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106436:	e9 5c f6 ff ff       	jmp    80105a97 <alltraps>
...
8010643d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106442:	e9 50 f6 ff ff       	jmp    80105a97 <alltraps>
...
80106449:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010644e:	e9 44 f6 ff ff       	jmp    80105a97 <alltraps>
...
80106455:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010645a:	e9 38 f6 ff ff       	jmp    80105a97 <alltraps>
...
80106461:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106466:	e9 2c f6 ff ff       	jmp    80105a97 <alltraps>
...
8010646d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106472:	e9 20 f6 ff ff       	jmp    80105a97 <alltraps>
...
80106479:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010647e:	e9 14 f6 ff ff       	jmp    80105a97 <alltraps>
...
80106485:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010648a:	e9 08 f6 ff ff       	jmp    80105a97 <alltraps>
...
80106491:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106496:	e9 fc f5 ff ff       	jmp    80105a97 <alltraps>
...
8010649d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801064a2:	e9 f0 f5 ff ff       	jmp    80105a97 <alltraps>
...
801064a9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801064ae:	e9 e4 f5 ff ff       	jmp    80105a97 <alltraps>
...
801064b5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801064ba:	e9 d8 f5 ff ff       	jmp    80105a97 <alltraps>
...
801064c1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801064c6:	e9 cc f5 ff ff       	jmp    80105a97 <alltraps>
...
801064cd:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801064d2:	e9 c0 f5 ff ff       	jmp    80105a97 <alltraps>
...
801064d9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801064de:	e9 b4 f5 ff ff       	jmp    80105a97 <alltraps>
...
801064e5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801064ea:	e9 a8 f5 ff ff       	jmp    80105a97 <alltraps>
...
801064f1:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801064f6:	e9 9c f5 ff ff       	jmp    80105a97 <alltraps>
...
801064fd:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106502:	e9 90 f5 ff ff       	jmp    80105a97 <alltraps>
...
80106509:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010650e:	e9 84 f5 ff ff       	jmp    80105a97 <alltraps>
...
80106515:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010651a:	e9 78 f5 ff ff       	jmp    80105a97 <alltraps>
...
80106521:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106526:	e9 6c f5 ff ff       	jmp    80105a97 <alltraps>
...
8010652d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106532:	e9 60 f5 ff ff       	jmp    80105a97 <alltraps>
...
80106539:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010653e:	e9 54 f5 ff ff       	jmp    80105a97 <alltraps>
...
80106545:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010654a:	e9 48 f5 ff ff       	jmp    80105a97 <alltraps>
...
80106551:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106556:	e9 3c f5 ff ff       	jmp    80105a97 <alltraps>
...
8010655d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106562:	e9 30 f5 ff ff       	jmp    80105a97 <alltraps>
...
80106569:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010656e:	e9 24 f5 ff ff       	jmp    80105a97 <alltraps>
...
80106575:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010657a:	e9 18 f5 ff ff       	jmp    80105a97 <alltraps>
...
80106581:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106586:	e9 0c f5 ff ff       	jmp    80105a97 <alltraps>
...
8010658d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106592:	e9 00 f5 ff ff       	jmp    80105a97 <alltraps>
...
80106599:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010659e:	e9 f4 f4 ff ff       	jmp    80105a97 <alltraps>
...
801065a5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801065aa:	e9 e8 f4 ff ff       	jmp    80105a97 <alltraps>
...
801065b1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801065b6:	e9 dc f4 ff ff       	jmp    80105a97 <alltraps>
...
801065bd:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801065c2:	e9 d0 f4 ff ff       	jmp    80105a97 <alltraps>
...
801065c9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801065ce:	e9 c4 f4 ff ff       	jmp    80105a97 <alltraps>
...
801065d5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801065da:	e9 b8 f4 ff ff       	jmp    80105a97 <alltraps>
...
801065e1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801065e6:	e9 ac f4 ff ff       	jmp    80105a97 <alltraps>
...
801065ed:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801065f2:	e9 a0 f4 ff ff       	jmp    80105a97 <alltraps>
...
801065f9:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801065fe:	e9 94 f4 ff ff       	jmp    80105a97 <alltraps>
...
80106605:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010660a:	e9 88 f4 ff ff       	jmp    80105a97 <alltraps>
...
80106611:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106616:	e9 7c f4 ff ff       	jmp    80105a97 <alltraps>
...
8010661d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106622:	e9 70 f4 ff ff       	jmp    80105a97 <alltraps>
...
80106629:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010662e:	e9 64 f4 ff ff       	jmp    80105a97 <alltraps>
...
80106635:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010663a:	e9 58 f4 ff ff       	jmp    80105a97 <alltraps>
...
80106641:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106646:	e9 4c f4 ff ff       	jmp    80105a97 <alltraps>
...
8010664d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106652:	e9 40 f4 ff ff       	jmp    80105a97 <alltraps>
...
80106659:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010665e:	e9 34 f4 ff ff       	jmp    80105a97 <alltraps>
...
80106665:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010666a:	e9 28 f4 ff ff       	jmp    80105a97 <alltraps>
...
80106671:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106676:	e9 1c f4 ff ff       	jmp    80105a97 <alltraps>
...
8010667d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106682:	e9 10 f4 ff ff       	jmp    80105a97 <alltraps>
...
80106689:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010668e:	e9 04 f4 ff ff       	jmp    80105a97 <alltraps>
...
80106695:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010669a:	e9 f8 f3 ff ff       	jmp    80105a97 <alltraps>
...
801066a1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801066a6:	e9 ec f3 ff ff       	jmp    80105a97 <alltraps>
...
801066ad:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801066b2:	e9 e0 f3 ff ff       	jmp    80105a97 <alltraps>
...
801066b9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801066be:	e9 d4 f3 ff ff       	jmp    80105a97 <alltraps>
...
801066c5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801066ca:	e9 c8 f3 ff ff       	jmp    80105a97 <alltraps>
...
801066d1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801066d6:	e9 bc f3 ff ff       	jmp    80105a97 <alltraps>
...
801066dd:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801066e2:	e9 b0 f3 ff ff       	jmp    80105a97 <alltraps>
...
801066e9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801066ee:	e9 a4 f3 ff ff       	jmp    80105a97 <alltraps>
...
801066f5:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801066fa:	e9 98 f3 ff ff       	jmp    80105a97 <alltraps>
...
80106701:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106706:	e9 8c f3 ff ff       	jmp    80105a97 <alltraps>
...
8010670d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106712:	e9 80 f3 ff ff       	jmp    80105a97 <alltraps>
...
80106719:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010671e:	e9 74 f3 ff ff       	jmp    80105a97 <alltraps>
...
80106725:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010672a:	e9 68 f3 ff ff       	jmp    80105a97 <alltraps>
...
80106731:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106736:	e9 5c f3 ff ff       	jmp    80105a97 <alltraps>
...
8010673d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106742:	e9 50 f3 ff ff       	jmp    80105a97 <alltraps>
...
80106749:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010674e:	e9 44 f3 ff ff       	jmp    80105a97 <alltraps>
...
80106755:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010675a:	e9 38 f3 ff ff       	jmp    80105a97 <alltraps>
...
80106761:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106766:	e9 2c f3 ff ff       	jmp    80105a97 <alltraps>
...
8010676d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106772:	e9 20 f3 ff ff       	jmp    80105a97 <alltraps>
...
80106779:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010677e:	e9 14 f3 ff ff       	jmp    80105a97 <alltraps>
...
80106785:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010678a:	e9 08 f3 ff ff       	jmp    80105a97 <alltraps>
...
80106791:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106796:	e9 fc f2 ff ff       	jmp    80105a97 <alltraps>
...
8010679d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801067a2:	e9 f0 f2 ff ff       	jmp    80105a97 <alltraps>
...
801067a9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801067ae:	e9 e4 f2 ff ff       	jmp    80105a97 <alltraps>
...
801067b5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801067ba:	e9 d8 f2 ff ff       	jmp    80105a97 <alltraps>
...
801067c1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801067c6:	e9 cc f2 ff ff       	jmp    80105a97 <alltraps>
...
801067cd:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801067d2:	e9 c0 f2 ff ff       	jmp    80105a97 <alltraps>
...
801067d9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801067de:	e9 b4 f2 ff ff       	jmp    80105a97 <alltraps>
...
801067e5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801067ea:	e9 a8 f2 ff ff       	jmp    80105a97 <alltraps>
...
801067f1:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801067f6:	e9 9c f2 ff ff       	jmp    80105a97 <alltraps>
...
801067fd:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106802:	e9 90 f2 ff ff       	jmp    80105a97 <alltraps>
...
80106809:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010680e:	e9 84 f2 ff ff       	jmp    80105a97 <alltraps>
...
80106815:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010681a:	e9 78 f2 ff ff       	jmp    80105a97 <alltraps>
...
80106821:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106826:	e9 6c f2 ff ff       	jmp    80105a97 <alltraps>
...
8010682d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106832:	e9 60 f2 ff ff       	jmp    80105a97 <alltraps>
...
80106839:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010683e:	e9 54 f2 ff ff       	jmp    80105a97 <alltraps>
...
80106845:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010684a:	e9 48 f2 ff ff       	jmp    80105a97 <alltraps>
...
80106851:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106856:	e9 3c f2 ff ff       	jmp    80105a97 <alltraps>
...
8010685d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106862:	e9 30 f2 ff ff       	jmp    80105a97 <alltraps>
...
80106869:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010686e:	e9 24 f2 ff ff       	jmp    80105a97 <alltraps>
...
80106875:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010687a:	e9 18 f2 ff ff       	jmp    80105a97 <alltraps>
...
80106881:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106886:	e9 0c f2 ff ff       	jmp    80105a97 <alltraps>
...
8010688d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106892:	e9 00 f2 ff ff       	jmp    80105a97 <alltraps>
...
80106899:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010689e:	e9 f4 f1 ff ff       	jmp    80105a97 <alltraps>
...
801068a5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801068aa:	e9 e8 f1 ff ff       	jmp    80105a97 <alltraps>
...
801068b1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801068b6:	e9 dc f1 ff ff       	jmp    80105a97 <alltraps>
...
801068bd:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801068c2:	e9 d0 f1 ff ff       	jmp    80105a97 <alltraps>
...
801068c9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801068ce:	e9 c4 f1 ff ff       	jmp    80105a97 <alltraps>
...
801068d5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801068da:	e9 b8 f1 ff ff       	jmp    80105a97 <alltraps>
...
801068e1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801068e6:	e9 ac f1 ff ff       	jmp    80105a97 <alltraps>
...
801068ed:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801068f2:	e9 a0 f1 ff ff       	jmp    80105a97 <alltraps>
...
801068f9:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801068fe:	e9 94 f1 ff ff       	jmp    80105a97 <alltraps>
...
80106905:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010690a:	e9 88 f1 ff ff       	jmp    80105a97 <alltraps>
...
80106911:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106916:	e9 7c f1 ff ff       	jmp    80105a97 <alltraps>
...
8010691d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106922:	e9 70 f1 ff ff       	jmp    80105a97 <alltraps>
...
80106929:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010692e:	e9 64 f1 ff ff       	jmp    80105a97 <alltraps>
...
80106935:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010693a:	e9 58 f1 ff ff       	jmp    80105a97 <alltraps>
...
80106941:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106946:	e9 4c f1 ff ff       	jmp    80105a97 <alltraps>
...
8010694d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106952:	e9 40 f1 ff ff       	jmp    80105a97 <alltraps>
...
80106959:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010695e:	e9 34 f1 ff ff       	jmp    80105a97 <alltraps>
...
80106965:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010696a:	e9 28 f1 ff ff       	jmp    80105a97 <alltraps>
...
80106971:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106976:	e9 1c f1 ff ff       	jmp    80105a97 <alltraps>
...
8010697d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106982:	e9 10 f1 ff ff       	jmp    80105a97 <alltraps>
...
80106989:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010698e:	e9 04 f1 ff ff       	jmp    80105a97 <alltraps>
...
80106995:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010699a:	e9 f8 f0 ff ff       	jmp    80105a97 <alltraps>
...
801069a1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801069a6:	e9 ec f0 ff ff       	jmp    80105a97 <alltraps>
...
801069ad:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801069b2:	e9 e0 f0 ff ff       	jmp    80105a97 <alltraps>
...
801069c5:	89 d6                	mov    %edx,%esi
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
801069c7:	c1 ea 16             	shr    $0x16,%edx
{
801069ca:	53                   	push   %ebx
  pde = &pgdir[PDX(va)];
801069cb:	8d 3c 90             	lea    (%eax,%edx,4),%edi
{
801069ce:	83 ec 0c             	sub    $0xc,%esp
  if(*pde & PTE_P){
801069d1:	8b 1f                	mov    (%edi),%ebx
801069d3:	f6 c3 01             	test   $0x1,%bl
801069d6:	74 28                	je     80106a00 <walkpgdir+0x40>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
801069d8:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
801069de:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
...
801069e6:	8d 65 f4             	lea    -0xc(%ebp),%esp
  return &pgtab[PTX(va)];
801069e9:	c1 e8 0a             	shr    $0xa,%eax
801069ec:	25 fc 0f 00 00       	and    $0xffc,%eax
801069f1:	01 d8                	add    %ebx,%eax
}
801069f3:	5b                   	pop    %ebx
801069f4:	5e                   	pop    %esi
801069f5:	5f                   	pop    %edi
...
80106a04:	e8 97 bb ff ff       	call   801025a0 <kalloc>
...
80106a1a:	e8 61 dd ff ff       	call   80104780 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106a44:	89 c7                	mov    %eax,%edi
  char *a, *last;
  pte_t *pte;

  a = (char*)PGROUNDDOWN((uint)va);
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106a46:	8d 44 0a ff          	lea    -0x1(%edx,%ecx,1),%eax
{
80106a4a:	56                   	push   %esi
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106a4b:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  a = (char*)PGROUNDDOWN((uint)va);
80106a50:	89 d6                	mov    %edx,%esi
{
80106a52:	53                   	push   %ebx
  a = (char*)PGROUNDDOWN((uint)va);
80106a53:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
{
80106a59:	83 ec 1c             	sub    $0x1c,%esp
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106a5c:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106a5f:	8b 45 08             	mov    0x8(%ebp),%eax
80106a62:	29 f0                	sub    %esi,%eax
80106a64:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106a67:	eb 1f                	jmp    80106a88 <mappages+0x48>
...
80106a73:	75 45                	jne    80106aba <mappages+0x7a>
      panic("remap");
    *pte = pa | perm | PTE_P;
80106a75:	0b 5d 0c             	or     0xc(%ebp),%ebx
80106a78:	83 cb 01             	or     $0x1,%ebx
80106a7b:	89 18                	mov    %ebx,(%eax)
    if(a == last)
80106a7d:	3b 75 e0             	cmp    -0x20(%ebp),%esi
80106a80:	74 2e                	je     80106ab0 <mappages+0x70>
      break;
    a += PGSIZE;
80106a82:	81 c6 00 10 00 00    	add    $0x1000,%esi
  for(;;){
80106a88:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80106a8b:	b9 01 00 00 00       	mov    $0x1,%ecx
80106a90:	89 f2                	mov    %esi,%edx
80106a92:	8d 1c 06             	lea    (%esi,%eax,1),%ebx
80106a95:	89 f8                	mov    %edi,%eax
80106a97:	e8 24 ff ff ff       	call   801069c0 <walkpgdir>
80106a9c:	85 c0                	test   %eax,%eax
80106a9e:	75 d0                	jne    80106a70 <mappages+0x30>
    pa += PGSIZE;
  }
  return 0;
}
...
80106abd:	68 6c 7c 10 80       	push   $0x80107c6c
...
80106ad8:	89 d3                	mov    %edx,%ebx
  ...
  a = PGROUNDUP(newsz);
80106ada:	8d 91 ff 0f 00 00    	lea    0xfff(%ecx),%edx
80106ae0:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80106ae6:	83 ec 1c             	sub    $0x1c,%esp
80106ae9:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80106aec:	39 da                	cmp    %ebx,%edx
80106aee:	73 5b                	jae    80106b4b <deallocuvm.part.0+0x7b>
80106af0:	89 5d e4             	mov    %ebx,-0x1c(%ebp)
80106af3:	89 d7                	mov    %edx,%edi
80106af5:	eb 14                	jmp    80106b0b <deallocuvm.part.0+0x3b>
80106af7:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80106afe:	66 90                	xchg   %ax,%ax
80106b00:	81 c7 00 10 00 00    	add    $0x1000,%edi
80106b06:	39 7d e4             	cmp    %edi,-0x1c(%ebp)
80106b09:	76 40                	jbe    80106b4b <deallocuvm.part.0+0x7b>
    pte = walkpgdir(pgdir, (char*)a, 0);
80106b0b:	31 c9                	xor    %ecx,%ecx
80106b0d:	89 fa                	mov    %edi,%edx
80106b0f:	89 f0                	mov    %esi,%eax
80106b11:	e8 aa fe ff ff       	call   801069c0 <walkpgdir>
80106b16:	89 c3                	mov    %eax,%ebx
    if(!pte)
80106b18:	85 c0                	test   %eax,%eax
80106b1a:	74 44                	je     80106b60 <deallocuvm.part.0+0x90>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
    else if((*pte & PTE_P) != 0){
80106b1c:	8b 00                	mov    (%eax),%eax
80106b1e:	a8 01                	test   $0x1,%al
80106b20:	74 de                	je     80106b00 <deallocuvm.part.0+0x30>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
80106b22:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106b27:	74 47                	je     80106b70 <deallocuvm.part.0+0xa0>
        panic("kfree");
      char *v = P2V(pa);
      kfree(v);
80106b29:	83 ec 0c             	sub    $0xc,%esp
      char *v = P2V(pa);
80106b2c:	05 00 00 00 80       	add    $0x80000000,%eax
80106b31:	81 c7 00 10 00 00    	add    $0x1000,%edi
      kfree(v);
80106b37:	50                   	push   %eax
80106b38:	e8 a3 b8 ff ff       	call   801023e0 <kfree>
      *pte = 0;
80106b3d:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
80106b43:	83 c4 10             	add    $0x10,%esp
  for(; a  < oldsz; a += PGSIZE){
80106b46:	39 7d e4             	cmp    %edi,-0x1c(%ebp)
80106b49:	77 c0                	ja     80106b0b <deallocuvm.part.0+0x3b>
    }
  }
  return newsz;
}
...
80106b62:	81 e2 00 00 c0 ff    	and    $0xffc00000,%edx
80106b68:	8d ba 00 00 40 00    	lea    0x400000(%edx),%edi
80106b6e:	eb 96                	jmp    80106b06 <deallocuvm.part.0+0x36>
        panic("kfree");
80106b70:	83 ec 0c             	sub    $0xc,%esp
80106b73:	68 46 75 10 80       	push   $0x80107546
80106b78:	e8 03 98 ff ff       	call   80100380 <panic>
...
80106b83:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106b86:	e8 d5 cc ff ff       	call   80103860 <cpuid>
  pd[0] = size-1;
...
80106c10:	a1 a4 57 11 80       	mov    0x801157a4,%eax
...
80106c44:	0f 84 c2 00 00 00    	je     80106d0c <switchuvm+0xec>
  pushcli();
80106c4a:	e8 71 d9 ff ff       	call   801045c0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106c4f:	e8 9c cb ff ff       	call   801037f0 <mycpu>
80106c54:	89 c3                	mov    %eax,%ebx
80106c56:	e8 95 cb ff ff       	call   801037f0 <mycpu>
80106c5b:	89 c7                	mov    %eax,%edi
80106c5d:	e8 8e cb ff ff       	call   801037f0 <mycpu>
80106c62:	83 c7 08             	add    $0x8,%edi
80106c65:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106c68:	e8 83 cb ff ff       	call   801037f0 <mycpu>
...
80106d4b:	77 4b                	ja     80106d98 <inituvm+0x68>
  mem = kalloc();
80106d4d:	e8 4e b8 ff ff       	call   801025a0 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106d5f:	e8 1c da ff ff       	call   80104780 <memset>
...
80106d78:	e8 c3 fc ff ff       	call   80106a40 <mappages>
  memmove(mem, init, sz);
...
80106d92:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106d93:	e9 88 da ff ff       	jmp    80104820 <memmove>
    panic("inituvm: more than a page");
80106d98:	83 ec 0c             	sub    $0xc,%esp
80106d9b:	68 b1 7c 10 80       	push   $0x80107cb1
...
80106dc4:	0f 85 8d 00 00 00    	jne    80106e57 <loaduvm+0xa7>
...
80106ddb:	75 11                	jne    80106dee <loaduvm+0x3e>
80106ddd:	eb 61                	jmp    80106e40 <loaduvm+0x90>
80106ddf:	90                   	nop
80106de0:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
80106de6:	89 f0                	mov    %esi,%eax
80106de8:	29 d8                	sub    %ebx,%eax
80106dea:	39 c6                	cmp    %eax,%esi
80106dec:	76 52                	jbe    80106e40 <loaduvm+0x90>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80106dee:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106df1:	8b 45 08             	mov    0x8(%ebp),%eax
80106df4:	31 c9                	xor    %ecx,%ecx
80106df6:	29 da                	sub    %ebx,%edx
80106df8:	e8 c3 fb ff ff       	call   801069c0 <walkpgdir>
80106dfd:	85 c0                	test   %eax,%eax
80106dff:	74 49                	je     80106e4a <loaduvm+0x9a>
    pa = PTE_ADDR(*pte);
80106e01:	8b 00                	mov    (%eax),%eax
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106e03:	8b 4d e0             	mov    -0x20(%ebp),%ecx
    if(sz - i < PGSIZE)
80106e06:	bf 00 10 00 00       	mov    $0x1000,%edi
    pa = PTE_ADDR(*pte);
80106e0b:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(sz - i < PGSIZE)
80106e10:	81 fb ff 0f 00 00    	cmp    $0xfff,%ebx
80106e16:	0f 46 fb             	cmovbe %ebx,%edi
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106e19:	29 d9                	sub    %ebx,%ecx
80106e1b:	05 00 00 00 80       	add    $0x80000000,%eax
80106e20:	57                   	push   %edi
80106e21:	51                   	push   %ecx
80106e22:	50                   	push   %eax
80106e23:	ff 75 10             	pushl  0x10(%ebp)
80106e26:	e8 d5 ab ff ff       	call   80101a00 <readi>
80106e2b:	83 c4 10             	add    $0x10,%esp
80106e2e:	39 f8                	cmp    %edi,%eax
80106e30:	74 ae                	je     80106de0 <loaduvm+0x30>
}
...
80106ee9:	76 48                	jbe    80106f33 <allocuvm+0xc3>
    mem = kalloc();
80106eeb:	e8 b0 b6 ff ff       	call   801025a0 <kalloc>
...
80106ef9:	68 e9 7c 10 80       	push   $0x80107ce9
...
80106f15:	e8 b6 fb ff ff       	call   80106ad0 <deallocuvm.part.0>
      return 0;
...
80106f5b:	68 01 7d 10 80       	push   $0x80107d01
...
80106f77:	e8 54 fb ff ff       	call   80106ad0 <deallocuvm.part.0>
      kfree(mem);
80106f7c:	83 ec 0c             	sub    $0xc,%esp
80106f7f:	53                   	push   %ebx
80106f80:	e8 5b b4 ff ff       	call   801023e0 <kfree>
      return 0;
...
80106feb:	e8 e0 fa ff ff       	call   80106ad0 <deallocuvm.part.0>
...
8010701e:	e8 bd b3 ff ff       	call   801023e0 <kfree>
...
80107033:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80107034:	e9 a7 b3 ff ff       	jmp    801023e0 <kfree>
    panic("freevm: no pgdir");
80107039:	83 ec 0c             	sub    $0xc,%esp
8010703c:	68 1d 7d 10 80       	push   $0x80107d1d
...
80107055:	e8 46 b5 ff ff       	call   801025a0 <kalloc>
...
801070db:	a3 a4 57 11 80       	mov    %eax,0x801157a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010710f:	68 2e 7d 10 80       	push   $0x80107d2e
...
80107133:	0f 84 a0 00 00 00    	je     801071d9 <copyuvm+0xb9>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80107139:	8b 4d 0c             	mov    0xc(%ebp),%ecx
8010713c:	85 c9                	test   %ecx,%ecx
8010713e:	0f 84 95 00 00 00    	je     801071d9 <copyuvm+0xb9>
80107144:	31 f6                	xor    %esi,%esi
80107146:	eb 4e                	jmp    80107196 <copyuvm+0x76>
...
80107163:	e8 b8 d6 ff ff       	call   80104820 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
80107168:	58                   	pop    %eax
80107169:	5a                   	pop    %edx
8010716a:	53                   	push   %ebx
8010716b:	8b 55 e4             	mov    -0x1c(%ebp),%edx
8010716e:	8b 45 e0             	mov    -0x20(%ebp),%eax
80107171:	b9 00 10 00 00       	mov    $0x1000,%ecx
80107176:	81 c2 00 00 00 80    	add    $0x80000000,%edx
8010717c:	52                   	push   %edx
8010717d:	89 f2                	mov    %esi,%edx
8010717f:	e8 bc f8 ff ff       	call   80106a40 <mappages>
80107184:	83 c4 10             	add    $0x10,%esp
80107187:	85 c0                	test   %eax,%eax
80107189:	78 39                	js     801071c4 <copyuvm+0xa4>
  for(i = 0; i < sz; i += PGSIZE){
8010718b:	81 c6 00 10 00 00    	add    $0x1000,%esi
80107191:	39 75 0c             	cmp    %esi,0xc(%ebp)
80107194:	76 43                	jbe    801071d9 <copyuvm+0xb9>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80107196:	8b 45 08             	mov    0x8(%ebp),%eax
80107199:	31 c9                	xor    %ecx,%ecx
8010719b:	89 f2                	mov    %esi,%edx
8010719d:	e8 1e f8 ff ff       	call   801069c0 <walkpgdir>
801071a2:	85 c0                	test   %eax,%eax
801071a4:	74 3e                	je     801071e4 <copyuvm+0xc4>
    if(!(*pte & PTE_P))
801071a6:	8b 18                	mov    (%eax),%ebx
801071a8:	f6 c3 01             	test   $0x1,%bl
801071ab:	74 44                	je     801071f1 <copyuvm+0xd1>
    pa = PTE_ADDR(*pte);
801071ad:	89 df                	mov    %ebx,%edi
    flags = PTE_FLAGS(*pte);
801071af:	81 e3 ff 0f 00 00    	and    $0xfff,%ebx
    pa = PTE_ADDR(*pte);
801071b5:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
801071bb:	e8 e0 b3 ff ff       	call   801025a0 <kalloc>
801071c0:	85 c0                	test   %eax,%eax
801071c2:	75 8c                	jne    80107150 <copyuvm+0x30>
      goto bad;
  }
  return d;
...
801071c7:	ff 75 e0             	pushl  -0x20(%ebp)
801071ca:	e8 01 fe ff ff       	call   80106fd0 <freevm>
  return 0;
...
801071e7:	68 38 7d 10 80       	push   $0x80107d38
801071ec:	e8 8f 91 ff ff       	call   80100380 <panic>
      panic("copyuvm: page not present");
801071f1:	83 ec 0c             	sub    $0xc,%esp
801071f4:	68 52 7d 10 80       	push   $0x80107d52
801071f9:	e8 82 91 ff ff       	call   80100380 <panic>
...
8010720e:	e8 ad f7 ff ff       	call   801069c0 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80107218:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  if((*pte & PTE_U) == 0)
8010721d:	83 e2 05             	and    $0x5,%edx
  return (char*)P2V(PTE_ADDR(*pte));
80107220:	05 00 00 00 80       	add    $0x80000000,%eax
80107225:	83 fa 05             	cmp    $0x5,%edx
80107228:	ba 00 00 00 00       	mov    $0x0,%edx
8010722d:	0f 45 c2             	cmovne %edx,%eax
}
80107230:	c3                   	ret    
...
80107251:	75 38                	jne    8010728b <copyout+0x4b>
80107253:	eb 6b                	jmp    801072c0 <copyout+0x80>
...
8010725b:	89 fb                	mov    %edi,%ebx
8010725d:	29 d3                	sub    %edx,%ebx
8010725f:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if(n > len)
80107265:	39 f3                	cmp    %esi,%ebx
80107267:	0f 47 de             	cmova  %esi,%ebx
      n = len;
    memmove(pa0 + (va - va0), buf, n);
8010726a:	29 fa                	sub    %edi,%edx
8010726c:	83 ec 04             	sub    $0x4,%esp
8010726f:	01 c2                	add    %eax,%edx
80107271:	53                   	push   %ebx
80107272:	ff 75 10             	pushl  0x10(%ebp)
80107275:	52                   	push   %edx
80107276:	e8 a5 d5 ff ff       	call   80104820 <memmove>
    len -= n;
    buf += n;
8010727b:	01 5d 10             	add    %ebx,0x10(%ebp)
    va = va0 + PGSIZE;
8010727e:	8d 97 00 10 00 00    	lea    0x1000(%edi),%edx
  while(len > 0){
80107284:	83 c4 10             	add    $0x10,%esp
80107287:	29 de                	sub    %ebx,%esi
80107289:	74 35                	je     801072c0 <copyout+0x80>
    va0 = (uint)PGROUNDDOWN(va);
8010728b:	89 d7                	mov    %edx,%edi
    pa0 = uva2ka(pgdir, (char*)va0);
8010728d:	83 ec 08             	sub    $0x8,%esp
    va0 = (uint)PGROUNDDOWN(va);
80107290:	89 55 0c             	mov    %edx,0xc(%ebp)
80107293:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    pa0 = uva2ka(pgdir, (char*)va0);
80107299:	57                   	push   %edi
8010729a:	ff 75 08             	pushl  0x8(%ebp)
8010729d:	e8 5e ff ff ff       	call   80107200 <uva2ka>
    if(pa0 == 0)
801072a2:	83 c4 10             	add    $0x10,%esp
801072a5:	85 c0                	test   %eax,%eax
801072a7:	75 af                	jne    80107258 <copyout+0x18>
  }
  return 0;
}
