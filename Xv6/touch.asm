...
main(int argc, char *argv[])
{
  ...
  2e:	e8 ae 02 00 00       	call   2e1 <open>
    close(fd);
  33:	89 04 24             	mov    %eax,(%esp)
  36:	e8 8e 02 00 00       	call   2c9 <close>
  for (int i = 0; i < argc; i++)
  ...
  exit();
  42:	e8 5a 02 00 00       	call   2a1 <exit>
  47:	66 90                	xchg   %ax,%ax
  49:	66 90                	xchg   %ax,%ax
  4b:	66 90                	xchg   %ax,%ax
  4d:	66 90                	xchg   %ax,%ax
 ...
 396:	89 d3                	mov    %edx,%ebx
{
 ...
 41e:	56                   	push   %esi
 41f:	57                   	push   %edi
 420:	e8 9c fe ff ff       	call   2c1 <write>
...
printf(int fd, char *fmt, ...)
{
 ...
 499:	e8 23 fe ff ff       	call   2c1 <write>
 ...
 50e:	e8 ae fd ff ff       	call   2c1 <write>
  for(i = 0; fmt[i]; i++){
 ...
 5fb:	57                   	push   %edi
 5fc:	53                   	push   %ebx
 5fd:	e8 bf fc ff ff       	call   2c1 <write>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 3d 70 0a 00 00    	mov    0xa70,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71b:	e8 09 fc ff ff       	call   329 <sbrk>
  if(p == (char*)-1)
 ...
 732:	e8 e9 fe ff ff       	call   620 <free>
  return freep;
 737:	8b 15 70 0a 00 00    	mov    0xa70,%edx
