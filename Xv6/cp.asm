 ...
 6c6:	73 10                	jae    6d8 <free+0x38>
{
 ...
 6f1:	5b                   	pop    %ebx
  freep = p;
 6f2:	a3 20 0b 00 00       	mov    %eax,0xb20
}
 6f7:	5e                   	pop    %esi
 6f8:	5f                   	pop    %edi
 6f9:	5d                   	pop    %ebp
 ...
 717:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 71a:	a3 20 0b 00 00       	mov    %eax,0xb20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 3d 20 0b 00 00    	mov    0xb20,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 789:	8b 3d 20 0b 00 00    	mov    0xb20,%edi
 ...
 7b2:	e8 e9 fe ff ff       	call   6a0 <free>
  return freep;
 7b7:	8b 15 20 0b 00 00    	mov    0xb20,%edx
 ...
 7ff:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 800:	c7 05 20 0b 00 00 24 	movl   $0xb24,0xb20
 807:	0b 00 00 
    base.s.size = 0;
 80a:	bf 24 0b 00 00       	mov    $0xb24,%edi
    base.s.ptr = freep = prevp = &base;
 80f:	c7 05 24 0b 00 00 24 	movl   $0xb24,0xb24
 816:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 819:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 81b:	c7 05 28 0b 00 00 00 	movl   $0x0,0xb28
 822:	00 00 00 
    if(p->s.size >= nunits){
