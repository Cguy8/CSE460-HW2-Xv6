...
main(void)
{
   ...
   e:	83 ec 04             	sub    $0x4,%esp
	...
	uid = getuid();
  11:	e8 cd 03 00 00       	call   3e3 <getuid>
  ...
  26:	58                   	pop    %eax
  27:	5a                   	pop    %edx
  28:	68 3c 08 00 00       	push   $0x83c
  2d:	6a 02                	push   $0x2
  2f:	e8 8c 04 00 00       	call   4c0 <printf>
	setuid(100);
  34:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  3b:	e8 bb 03 00 00       	call   3fb <setuid>
	uid = getuid();
  40:	e8 9e 03 00 00       	call   3e3 <getuid>
	printf(2, "Current UID is: %d\n", uid);
  45:	83 c4 0c             	add    $0xc,%esp
  48:	50                   	push   %eax
  49:	68 28 08 00 00       	push   $0x828
  4e:	6a 02                	push   $0x2
  50:	e8 6b 04 00 00       	call   4c0 <printf>

	gid = getgid();
  55:	e8 91 03 00 00       	call   3eb <getgid>
	printf(2, "Current GID is: %d\n", gid);
  5a:	83 c4 0c             	add    $0xc,%esp
  5d:	50                   	push   %eax
  5e:	68 50 08 00 00       	push   $0x850
  63:	6a 02                	push   $0x2
  65:	e8 56 04 00 00       	call   4c0 <printf>
	printf(2, "Setting GID to 100\n");
  6a:	59                   	pop    %ecx
  6b:	58                   	pop    %eax
  6c:	68 64 08 00 00       	push   $0x864
  71:	6a 02                	push   $0x2
  73:	e8 48 04 00 00       	call   4c0 <printf>
	setgid(100);
  78:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  7f:	e8 7f 03 00 00       	call   403 <setgid>
	gid = getgid();
  84:	e8 62 03 00 00       	call   3eb <getgid>
	printf(2, "Current GID is: %d\n", gid);
  89:	83 c4 0c             	add    $0xc,%esp
  8c:	50                   	push   %eax
  8d:	68 50 08 00 00       	push   $0x850
  92:	6a 02                	push   $0x2
  94:	e8 27 04 00 00       	call   4c0 <printf>

	ppid = getppid();
  99:	e8 55 03 00 00       	call   3f3 <getppid>
	printf(2, "My parent process is: %d\n", ppid);
  9e:	83 c4 0c             	add    $0xc,%esp
  a1:	50                   	push   %eax
  a2:	68 78 08 00 00       	push   $0x878
  a7:	6a 02                	push   $0x2
  a9:	e8 12 04 00 00       	call   4c0 <printf>
	printf(2, "Done!\n");
  ae:	58                   	pop    %eax
  af:	5a                   	pop    %edx
  b0:	68 92 08 00 00       	push   $0x892
  b5:	6a 02                	push   $0x2
...
printf(int fd, char *fmt, ...)
{
 ...
 644:	eb 1a                	jmp    660 <printf+0x1a0>
          s = "(null)";
 646:	bb 99 08 00 00       	mov    $0x899,%ebx
        while(*s != 0){
 ...
 6b6:	73 10                	jae    6c8 <free+0x38>
{
 ...
 6e1:	5b                   	pop    %ebx
  freep = p;
 6e2:	a3 48 0b 00 00       	mov    %eax,0xb48
}
 6e7:	5e                   	pop    %esi
 6e8:	5f                   	pop    %edi
 6e9:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 3d 48 0b 00 00    	mov    0xb48,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 779:	8b 3d 48 0b 00 00    	mov    0xb48,%edi
 ...
 7a2:	e8 e9 fe ff ff       	call   690 <free>
  return freep;
 7a7:	a1 48 0b 00 00       	mov    0xb48,%eax
 ...
 7ee:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7f0:	c7 05 48 0b 00 00 4c 	movl   $0xb4c,0xb48
 7f7:	0b 00 00 
    base.s.size = 0;
 7fa:	bf 4c 0b 00 00       	mov    $0xb4c,%edi
    base.s.ptr = freep = prevp = &base;
 7ff:	c7 05 4c 0b 00 00 4c 	movl   $0xb4c,0xb4c
 806:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 809:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 80b:	c7 05 50 0b 00 00 00 	movl   $0x0,0xb50
 812:	00 00 00 
    if(p->s.size >= nunits){
