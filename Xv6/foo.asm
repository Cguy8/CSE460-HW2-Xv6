  ...
  19:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  36:	e8 88 03 00 00       	call   3c3 <getpid>
  3b:	53                   	push   %ebx
  for ( k = 0; k < n; k++ ) {
  3c:	83 c6 01             	add    $0x1,%esi
      printf(1, "Parent %d creating child  %d\n", getpid(), id );
  3f:	50                   	push   %eax
  40:	68 5c 08 00 00       	push   $0x85c
  45:	6a 01                	push   $0x1
  47:	e8 94 04 00 00       	call   4e0 <printf>
      wait ();
  4c:	e8 fa 02 00 00       	call   34b <wait>
  51:	83 c4 10             	add    $0x10,%esp
  for ( k = 0; k < n; k++ ) {
  54:	39 fe                	cmp    %edi,%esi
  56:	7d 30                	jge    88 <main+0x88>
    id = fork ();
  58:	e8 de 02 00 00       	call   33b <fork>
  5d:	89 c3                	mov    %eax,%ebx
    if ( id < 0 ) {
  5f:	85 c0                	test   %eax,%eax
  61:	79 cd                	jns    30 <main+0x30>
      printf(1, "%d failed in fork!\n", getpid() );
  63:	e8 5b 03 00 00       	call   3c3 <getpid>
  ...
  88:	d9 ee                	fldz   
  8a:	dd 05 90 08 00 00    	fldl   0x890
  90:	dc c1                	fadd   %st,%st(1)
  92:	d9 05 98 08 00 00    	flds   0x898
  ...
  exit();
  a0:	e8 9e 02 00 00       	call   343 <exit>
    n = atoi ( argv[1] ); //from command line
  ...
  bf:	e9 61 ff ff ff       	jmp    25 <main+0x25>
      printf(1, "Child %d created\n",getpid() );
  c4:	e8 fa 02 00 00       	call   3c3 <getpid>
  c9:	52                   	push   %edx
  ca:	50                   	push   %eax
  cb:	68 7a 08 00 00       	push   $0x87a
  d0:	6a 01                	push   $0x1
 ...
 43c:	89 d1                	mov    %edx,%ecx
{
 ...
 469:	0f b6 92 a4 08 00 00 	movzbl 0x8a4(%edx),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 664:	eb 1a                	jmp    680 <printf+0x1a0>
          s = "(null)";
 666:	bb 9c 08 00 00       	mov    $0x89c,%ebx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 3d 5c 0b 00 00    	mov    0xb5c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
